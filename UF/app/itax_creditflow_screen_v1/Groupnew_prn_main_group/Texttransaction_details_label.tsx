...
const Texttransaction_details_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[transaction_details_label6f776?.refresh])

  if (transaction_details_label6f776?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Transaction Details")}
</Text>
  </div>
  )
}

export default Texttransaction_details_label
