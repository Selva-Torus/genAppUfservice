...
const Texttax_payers_full_name_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[tax_payers_full_name_labeld7111?.refresh])

  if (tax_payers_full_name_labeld7111?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 13`,gridRow: `45 / 55`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
  color="primary"
>
      {keyset("Tax Payer Full Name")}
</Text>
  </div>
  )
}

export default Texttax_payers_full_name_label
