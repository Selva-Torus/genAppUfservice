...
const Texttransaction_date_time_label = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[transaction_date_time_label669d7?.refresh])

  if (transaction_date_time_label669d7?.isHidden) {
    return <></>
  }
...
export default Texttransaction_date_time_label
