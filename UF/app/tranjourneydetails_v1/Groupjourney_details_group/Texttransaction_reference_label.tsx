...
const Texttransaction_reference_label = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[transaction_reference_labelb1ca9?.refresh])

  if (transaction_reference_labelb1ca9?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `13 / 25`,gridRow: `66 / 74`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
  color="primary"
>
      {keyset("Transaction Reference")}
</Text>
  </div>
  )
}

export default Texttransaction_reference_label
