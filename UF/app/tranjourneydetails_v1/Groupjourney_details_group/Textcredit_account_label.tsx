...
const Textcredit_account_label = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[credit_account_label65c7b?.refresh])

  if (credit_account_label65c7b?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `13 / 25`,gridRow: `49 / 57`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
  color="primary"
>
      {keyset("Credit Account")}
</Text>
  </div>
  )
}

export default Textcredit_account_label
