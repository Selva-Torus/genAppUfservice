...
const Textdebit_account_label = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[debit_account_label3b1b7?.refresh])

  if (debit_account_label3b1b7?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Debit Account")}
</Text>
  </div>
  )
}

export default Textdebit_account_label
