...
const TextAPI_Process_Logs = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    let orchestrationBody :any = {
      ...
      controlId:"efb523d44d98447b83036d73fbed7e00",
      isTable:false,
      accessProfile:accessProfile,
      from:"TextAPI Process Logs"
    }
  ...
  if (hide.textAPI_Process_Logsd7e00) {
    return <></>
  }
return (
...
export default TextAPI_Process_Logs