...
const TextRelease_Date = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    let orchestrationBody :any = {
      ...
      controlId:"91be3fbb350c4851a8dbedae50d7992c",
      isTable:false,
      accessProfile:accessProfile,
      from:"TextRelease Date"
    }
  ...
  if (hide.textRelease_Date7992c) {
    return <></>
  }
return (
  <div className="col-start-9 col-end-11 row-start-2 row-end-2 gap-" >
    <Text 
    >
    Release Date
    </Text> 
...
export default TextRelease_Date