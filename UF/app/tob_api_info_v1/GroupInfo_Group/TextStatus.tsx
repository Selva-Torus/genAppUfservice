...
const TextStatus = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    let orchestrationBody :any = {
      ...
      controlId:"1ad92bbefd7b401ea95e48705e76e86f",
      isTable:false,
  ...
  if (hide.textStatus6e86f) {
    return <></>
  }
return (
  <div className="col-start-5 col-end-7 row-start-2 row-end-2 gap-" >
    <Text 
    >
    Status
    </Text> 
