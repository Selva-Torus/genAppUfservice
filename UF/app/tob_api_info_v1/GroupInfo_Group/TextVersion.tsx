...
const TextVersion = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    ...
    let orchestrationBody :any = {
      ...
      controlId:"fde67d3252784ce585842e0b08a419ad",
      isTable:false,
  ...
  if (hide.textVersion419ad) {
    return <></>
  }
return (
  <div className="col-start-3 col-end-5 row-start-2 row-end-2 gap-10px" >
    <Text 
    >
    Version
    </Text> 
