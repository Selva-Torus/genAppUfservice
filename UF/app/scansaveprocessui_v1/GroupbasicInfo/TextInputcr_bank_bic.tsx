...
const TextInputcr_bank_bic = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:scanSaveProcessUi:AFVK:v1|409b134cde0449b5a031a7686df3d198|c22b200afac143a4b305b1dc87c3d26f"
    }
  ],
  ...
  const handleChange = async(e: any) => {
    if(e.target.value=="")
    {
      ...
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,scanSaveProcessUi_v1:{...pre?.scanSaveProcessUi_v1,bic_code:undefined}}));
  ...
  const handleValidate=async (e?:any) => {
     ...
     if(dynamicStateandType.type=="number"){
        ...
        if(!validate.success){
          ...
          setValidate((pre:any)=>({...pre,scanSaveProcessUi_v1:{...pre?.scanSaveProcessUi_v1,bic_code:"invalid"}}));
        }
  ...
  const handleMapperValue=async()=>{
    try{
      const orchestrationData:any = getControlOrchestrationData(
        ...
        "c22b200afac143a4b305b1dc87c3d26f"
      );
      ...
      //     controlId: "c22b200afac143a4b305b1dc87c3d26f",
      //     isTable: false,
      //     from:"TextInputcr_bank_bic",
  ...
  return (   
    <div  
      style={{gridColumn: `1 / 7`,gridRow: `26 / 41`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
      <div style={{ flex: 1, minHeight: 0 }}>
      <TextInput
        require={isRequredData}
        className="!rounded-xl"
        label={keyset("Cr Bank Bic")}
      ...
      errorMessage={error}
        validationState={validate?.scanSaveProcessUi_v1?.bic_code ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
...
export default TextInputcr_bank_bic
