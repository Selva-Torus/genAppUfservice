 ...
 /////////////
  ...
  const handleMapper=async (data?:any) => {
    ...
    if(orchestrationData?.data?.rule?.nodes?.length > 0){
      ...
      if("save" in button_group74f3eProps?.dynamicActionRule){
        setShowFlag(true)
        setStyleSate({...getGridPositionFromOrder(button_group74f3eProps?.dynamicActionRule?.save)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }
      else
      {
        setShowFlag(false)   
      ...
      if("save" in scansaveprocessui_v1?.button_group && scansaveprocessui_v1?.button_group["save"]?.itsHaveArtifact== true)
      {
        ...
        setStyleSate({...getGridPositionFromOrder(scansaveprocessui_v1?.button_group?.save?.order)||{}, gap:`12px`, height: `100%`, overflow: 'auto'})
      }else{
        setShowFlag(false)
      }
    }
          ...
          "children": [
            ...
            },
            {
              ...
              "children": [
                ...
                {
                  "id": "0ac0ff5de1474cdc93561e6622df2390.1.1.1.2.3",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "hasDataHandler",
                  ...
                  "children": [
                    {
                      "id": "0ac0ff5de1474cdc93561e6622df2390.1.1.1.2.3.1",
                      "type": "responseNode",
                      "name": "success",
                      "label": "success",
                      ...
                      "children": [
                        {
                          "id": "0ac0ff5de1474cdc93561e6622df2390.1.1.1.2.3.1.1",
                          "eventContext": "rise",
                          "value": "",
                          "type": "handlerNode",
                          "name": "copyFormData",
                    ...
                    {
                      "id": "0ac0ff5de1474cdc93561e6622df2390.1.1.1.2.3.2",
                      "type": "responseNode",
                      "name": "fail",
                      "label": "fail",
                      "sequence": "1.1.1.2.3.2",
                      "children": [
                        {
                          "id": "0ac0ff5de1474cdc93561e6622df2390.1.1.1.2.3.2.1",
                          "eventContext": "rise",
                          "value": "",
                          "type": "handlerNode",
                          "name": "infoMsg",
                          "label": "infoMsg",
                          "sequence": "1.1.1.2.3.2.1",
                          "children": [],
                          "hlr": {
                            "params": [
                              {
  ...
  // saveHandler
    ...
    }else
    {
      ...
      //infoMsg
      toast(' Validation Error Not found', 'danger',)
    }
    // hasDataHandler
    if(commonSepareteDataFromTheObject("data[0]",te_save?.data)){
    ...
    }else
    {
      ...
      // for controller
        setoverallgroup01c61((pre:any)=>({...pre,documentviewer:""}));
      // clearHandler riseListen
      // for group
  ...
  }, [scansaveprocessui_v1?.button_group?.save,button_group74f3e?.dynamicActionRule?.save,control_tab_groupbc3e2])
  ...
  return (
    <div
      ...
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=" p-1  !bg-blue-600 !text-white !py-2 !rounded-md flex items-center gap-2"
          onClick={handleClick}
          view='action'
