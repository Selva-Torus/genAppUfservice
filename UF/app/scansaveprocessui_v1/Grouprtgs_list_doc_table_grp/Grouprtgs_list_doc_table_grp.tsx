...
import Grouprtgs_lst_doc_list_table  from "../Grouprtgs_lst_doc_list_table/Grouprtgs_lst_doc_list_table";
...
const Grouprtgs_list_doc_table_grp = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "e4f61b24e76a4ad296b6e5297c78a593");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setrtgs_list_doc_table_grp8a593Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("rtgs_lst_doc_list_table")){
      setrtgs_lst_doc_list_tablee57bb({...rtgs_lst_doc_list_tablee57bb,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const rtgs_list_doc_table_grp8a593Ref = useRef<any>(null);
  const handleClearSearch = () => {
    rtgs_list_doc_table_grp8a593Ref.current?.setSearchParams();
    rtgs_list_doc_table_grp8a593Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(rtgs_list_doc_table_grp8a593) && Object.keys(rtgs_list_doc_table_grp8a593)?.length>0)
      {
        setrtgs_list_doc_table_grp8a593({})
      }
    }else 
      prevRefreshRef.current= true
  }, [rtgs_list_doc_table_grp8a593Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("rtgs_lst_doc_list_table")  &&<Grouprtgs_lst_doc_list_table  
...
export default Grouprtgs_list_doc_table_grp
