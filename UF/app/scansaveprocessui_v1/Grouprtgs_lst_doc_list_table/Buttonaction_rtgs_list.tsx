...
const Buttonaction_rtgs_list = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "c891304633c949fd928b7399787543ba"
      );
 ...
 if (action_rtgs_list543ba?.isHidden) {
    return <></>
  }
  ...
  return (
    <div>
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {action_rtgs_list543ba?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
...
export default Buttonaction_rtgs_list
