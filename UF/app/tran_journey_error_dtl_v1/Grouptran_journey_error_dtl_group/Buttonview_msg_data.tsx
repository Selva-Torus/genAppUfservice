...
const Buttonview_msg_data = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "a6d699e6cbff4e91935913fe5309b55f",
          isTable: false,
          from:"ButtonView Message Data",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "view_msg_data9b55f") {
        handleClick();
      }
    });
  },[view_msg_data9b55f?.refresh,currentToken])
 ...
 if (view_msg_data9b55f?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `3 / 7`,gridRow: `106 / 121`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='normal'
          disabled= {view_msg_data9b55f?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
...
export default Buttonview_msg_data
