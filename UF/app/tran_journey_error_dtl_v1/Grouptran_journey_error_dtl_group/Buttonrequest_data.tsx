...
const Buttonrequest_data = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "78b684120606411193c3c2e64ac9aa32",
          isTable: false,
          from:"ButtonView Request Data",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "request_data9aa32") {
        handleClick();
      }
    });
  },[request_data9aa32?.refresh,currentToken])
 ...
 if (request_data9aa32?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `8 / 12`,gridRow: `106 / 121`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          ...
          disabled= {request_data9aa32?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("View Request Data")}
        </Button>}
      </div>
...
export default Buttonrequest_data
