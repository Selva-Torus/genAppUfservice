...
import Groupfailure_queue_journey_group  from "../Groupfailure_queue_journey_group/Groupfailure_queue_journey_group";
...
const Groupfailure_queue_tab = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "9258057c84374821bdaf3edfc8469f01");
  ...
  /////////////
    ...
    if(orchestrationData?.data?.readableControls.includes("failure_queue_journey_group")){
      setfailure_queue_journey_group36aba({...failure_queue_journey_group36aba,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  return (
    ...
    >
        ...
        {allowedComponent.includes("failure_queue_journey_group")  &&<Groupfailure_queue_journey_group  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          tableData={tableData}
          setTableData={setTableData}
