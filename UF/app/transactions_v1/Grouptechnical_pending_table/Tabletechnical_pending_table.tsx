...
let defaultColumns:any = [
  {
    "id": "product_code_technical_pending",
    "nodeid": "7b7981705c4e49f78e41585489511fe0",
    "name": "Product Code",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "channel_name_technical_pending",
    "nodeid": "d38a7eea4288488cb31935b864fe182f",
    "name": "Channel",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "uuid_technical_pending",
    "nodeid": "d9e17b2e1fc84b69b039abb968fbc6bb",
    "name": "UUID",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "dr_account_technical_pending",
    "nodeid": "c197f87e030342edb593ea3ed7ebc856",
  ...
  {
    "id": "dr_amount_technical_pending",
    "nodeid": "304825dbbc8a4b098d8c2d2574d5e6cc",
    "name": "Debitor Amount",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "cr_account_technical_pending",
    "nodeid": "fdd4305f838849ecafcec1d28ed3c4aa",
  ...
  {
    "id": "cr_Amount_technical_pending",
    "nodeid": "a5607c4e96364f51abddb0ec4211bc34",
  ...
  {
    "id": "remittance_info_technical_pending",
    "nodeid": "3f12c71aa2dd4b8dbcfc8560cb678349",
  ...
  {
    "id": "status_technical_pending",
    "nodeid": "47926a6440c040439f4fafb21d6738a2",
    "name": "Status",
    "meta": {
      "sort": true
    },
 ...
 /////////////
  ...
  const GetTableDetails = async () => {
    const orchestrationData:any = getGroupOrchestrationData(
        groupData,
        "aa1e672fa7b94d048045b51e2f984f30",
      );
  ...
  const [SearchParams,setSearchParams] = useState<any>({})
    ...
    if (allCode != '') {
      let codeStates: any = {};
        ...
        codeStates['product_code_technical_pending'] = product_code_technical_pending11fe0,
        codeStates['setproduct_code_technical_pending'] = setproduct_code_technical_pending11fe0,
        codeStates['channel_name_technical_pending'] = channel_name_technical_pendinge182f,
        codeStates['setchannel_name_technical_pending'] = setchannel_name_technical_pendinge182f,
        codeStates['uuid_technical_pending'] = uuid_technical_pendingbc6bb,
        codeStates['setuuid_technical_pending'] = setuuid_technical_pendingbc6bb,
        codeStates['dr_account_technical_pending'] = dr_account_technical_pendingbc856,
        codeStates['setdr_account_technical_pending'] = setdr_account_technical_pendingbc856,
        codeStates['dr_amount_technical_pending'] = dr_amount_technical_pending5e6cc,
        codeStates['setdr_amount_technical_pending'] = setdr_amount_technical_pending5e6cc,
        codeStates['cr_account_technical_pending'] = cr_account_technical_pending3c4aa,
        codeStates['setcr_account_technical_pending'] = setcr_account_technical_pending3c4aa,
        codeStates['cr_amount_technical_pending'] = cr_amount_technical_pending1bc34,
        codeStates['setcr_amount_technical_pending'] = setcr_amount_technical_pending1bc34,
        codeStates['remittance_info_technical_pending'] = remittance_info_technical_pending78349,
        codeStates['setremittance_info_technical_pending'] = setremittance_info_technical_pending78349,
        codeStates['status_technical_pending'] = status_technical_pending738a2,
        codeStates['setstatus_technical_pending'] = setstatus_technical_pending738a2,
  ...
  const handleUpdate = (page:any, pageSize:any) =>{
    ...
    settechnical_pending_table84f30Props((pre:any)=>({...pre, selectedIds:[]}))
    let checkedData: any = selectedPaginationData
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          settechnical_pending_table84f30Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
  ...
  async function fetchData(page:any = 1, pageSize:any = 10, searchParams = {},dfKey:any,isRulePresent:any=false,isOnLoad = false,filterProps?:any,itsFromRefreshHandler:any=false){
    ...
    try {
          ...
          if(DFkeyAndRule?.isRulePresent==true)
          {
            api_paginationBody = {
              ...
              filterDetails: {
                ...
                nodeId: 'aa1e672fa7b94d048045b51e2f984f30',
                elementId: 'aa1e672fa7b94d048045b51e2f984f30'
              },
            }
          }else
          {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( technical_pending_table84f30Props?.presetValues&&Object.keys(technical_pending_table84f30Props?.presetValues).length > 0) {
          filtertedData = [technical_pending_table84f30Props?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          settechnical_pending_table84f30(api_pagination?.data?.records||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(technical_pending_table84f30Props.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [technical_pending_table84f30Props.filterProps])
  ...
  useEffect(() => {
    if (technical_pending_table84f30Props?.clearData === true) {
      settechnical_pending_table84f30([]);
      setAllDataObject([]);
      setAllData([]);
      setTableData([]);
      ...
      settechnical_pending_table84f30Props((pre:any) => ({...pre, clearData: false, selectedIds: []}));
      setPaginationData((pre:any) => ({...pre, total: 0}));
    }
  }, [technical_pending_table84f30Props?.clearData])
  useEffect(() => {
    ...
    setSelectedPaginationData([])
    setAllDataObject([])
  }, [technical_pending_table84f30Props?.refresh])


  const handlePrimaryTable = () => {
    let findData = technical_pending_table84f30Props?.selectedIds[technical_pending_table84f30Props?.selectedIds?.length-1]
    if(Array.isArray(technical_pending_table84f30) && technical_pending_table84f30.length>0)
    {
      let data = technical_pending_table84f30[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "uuid",
        value: data["uuid"],
  ...
  useEffect(() => {
    if (technical_pending_table84f30Props?.selectedIds?.length != 0) handlePrimaryTable()
    if (technical_pending_table84f30Props?.selectedIds?.length == 0){
      handleOnRowClick({},technical_pending_table84f30Props?.selectedIds)
    }
  }, [technical_pending_table84f30Props?.selectedIds])
  ...
  const handleOnRowClick=async(data?:any,ids?:any)=>{
    ...
    settechnical_pending_table84f30Props((pre:any)=>({...pre, selectedIds:[ids[ids.length-1]]}))  
    onButtonSecurityHandle(data)
    ...
    settechnical_pending_journey_groupe4f03(result||{})
  ...
  const bindPreviousAndNext=(currectIndex:any,forEvent:any,setData:string,parentTrigger:any="",currectPage:any)=>{ 
    ...
    {
      currectIndex=-1
      if(technical_pending_table84f30?.length==0)
      {
        eventBus.emit(parentTrigger, { message: "no data" });
        return
      }
      if(forEvent=="next"&&technical_pending_table84f30?.at((+currectIndex)+1))
      {
        const newIndex = (+currectIndex)+1;
        allState[setData](technical_pending_table84f30?.at(newIndex))
        eventBus.emit(parentTrigger, { index: newIndex, data: technical_pending_table84f30?.at(newIndex) ,currectPage:paginationData?.page});
        return newIndex
      }
      if(forEvent=="previous"&&((+currectIndex)-1)>=0&&technical_pending_table84f30?.at((+currectIndex)-1))
      {
        const newIndex = (+currectIndex)-1;
        allState[setData](technical_pending_table84f30?.at(newIndex))
        eventBus.emit(parentTrigger, { index: newIndex, data: technical_pending_table84f30?.at(newIndex) ,currectPage:paginationData?.page});
  ...
  if (technical_pending_table84f30?.isHidden) {
    return <></>
  }
  return(
    <div className='w-full h-full'>
          <div
            ...
            id={"aa1e672fa7b94d048045b51e2f984f30"}  onClick={(e:any) => {
          ...
          >
            <Table
              ...
              edgePadding={true}
              selectedIds={technical_pending_table84f30Props?.selectedIds}  
...
export default Tabletechnical_pending_table
