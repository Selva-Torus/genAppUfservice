...
const Buttonnew_payment_chk_reject_btn = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "new_payment_chk_reject_btn4c9a0") {
        handleClick();
      }
    });
  ...
  },[new_payment_chk_reject_btn4c9a0?.refresh])
 ...
 if (new_payment_chk_reject_btn4c9a0?.isHidden) {
    return <></>
  }
    ...
    <div>
      ...
      >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {new_payment_chk_reject_btn4c9a0?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("Reject")}
...
export default Buttonnew_payment_chk_reject_btn
