...
import PageTransactionsearchpage2 from '@/app/transactionsearch_v1/transactionsearch_v1page';
...
const Buttonsearch = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any,controlData:any}) => {
 ...
 /////////////
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      let codeStates: Record<string, any> = {};
        ...
        codeStates['transactionsearch_v1'] = transactionsearch_v1Props,
        codeStates['settransactionsearch_v1'] = settransactionsearch_v1Props,
  ...
  const handleMapper=async (data?:any) => {
    try{     
      const orchestrationData : any = getControlOrchestrationData(
        ...
        "22571c749d1a41599018e5b102214cf0"
      );
  ...
  useEffect(()=>{
    if (!search14cf0?.trigger) return;
      if(search14cf0?.trigger){
      (async()=>{
        await handleClick();
      })();
      setsearch14cf0((prev:any) => ({...prev, trigger: !prev?.trigger}));
      (async()=>{
        await handleMapper();
  ...
  const handleClick=async()=>{
    ...
    setShowProfileAsModalOpen2(true);
      ...
      settran_tab_group08b64((prev: any) => ({ ...prev, search: false }));
 ...
 if (search14cf0?.isHidden) {
    return <></>
  }

  return (
    <div
      style={{gridColumn: `14 / 17`,gridRow: `2 / 11`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
      <Modal 
      ...
      >
        ...
        {showFlag && <Button 
          ...
          disabled= {search14cf0?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("Search")}
