 ...
 /////////////
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("technical_pending_table")){
      settechnical_pending_table84f30({...technical_pending_table84f30,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("technical_pending_journey_group")){
      settechnical_pending_journey_groupe4f03({...technical_pending_journey_groupe4f03,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
