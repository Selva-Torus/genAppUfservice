...
let defaultColumns:any = [
  ...
  {
    "id": "remittance_info_return_queue",
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  const handlePrimaryTable = () => {
    ...
    {
      let data = return_queue_table267f0[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "uuid",
        value: data["uuid"],
