...
const Groupgroup = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData={}, controlData={}}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData = getGroupOrchestrationData(groupData, "1917aeed17e846bba0eec1c2417d23af");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setgroupd23afProps((pre:any)=>({...pre,isHaveRule:true}))
