...
const ButtonClear = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "92f7a7b3b7ff4ec0a0b6f2d09f5f63e8",
          isTable: false,
          from:"ButtonClear",
  ...
  },[clearf63e8?.refresh,currentToken])
 ...
 if (clearf63e8?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `15 / 18`,gridRow: `94 / 104`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          ...
          disabled= {clearf63e8?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Clear")}
