...
import Groupgrp_total_transactions  from "../Groupgrp_total_transactions/Groupgrp_total_transactions";
import Groupgrp_prn_initiated  from "../Groupgrp_prn_initiated/Groupgrp_prn_initiated";
import Groupgrp_prn_approved  from "../Groupgrp_prn_approved/Groupgrp_prn_approved";
import Groupgrp_credit_pending  from "../Groupgrp_credit_pending/Groupgrp_credit_pending";
import Groupgrp_credit_approved  from "../Groupgrp_credit_approved/Groupgrp_credit_approved";
import Groupgrp_payment_completed  from "../Groupgrp_payment_completed/Groupgrp_payment_completed";
import Groupgrp_bar_chart  from "../Groupgrp_bar_chart/Groupgrp_bar_chart";
import Groupgrp_pie_chart  from "../Groupgrp_pie_chart/Groupgrp_pie_chart";
...
const Groupoverall_dashboard = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT010:FNGK:AF:FNK:UF-UFW:CATK:I001:AFGK:ITAX:AFK:ITAX_Dashboard:AFVK:v1",componentId:"a6602cd18552475fbd65e91b18b54180",from:"GroupOverallDashboard",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("grp_total_transactions")){
      setgrp_total_transactionse00c2({...grp_total_transactionse00c2,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("grp_prn_initiated")){
      setgrp_prn_initiated2f421({...grp_prn_initiated2f421,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("grp_prn_approved")){
      setgrp_prn_approvedb95cb({...grp_prn_approvedb95cb,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("grp_credit_pending")){
      setgrp_credit_pendingfe0e2({...grp_credit_pendingfe0e2,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("grp_credit_approved")){
      setgrp_credit_approved7e3bd({...grp_credit_approved7e3bd,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("grp_payment_completed")){
      setgrp_payment_completed34dec({...grp_payment_completed34dec,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("grp_bar_chart")){
      setgrp_bar_chart02e16({...grp_bar_chart02e16,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("grp_pie_chart")){
      setgrp_pie_chart2415d({...grp_pie_chart2415d,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const overall_dashboard54180Ref = useRef<any>(null);
  const handleClearSearch = () => {
    overall_dashboard54180Ref.current?.setSearchParams();
    overall_dashboard54180Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(overall_dashboard54180) && Object.keys(overall_dashboard54180)?.length>0)
      {
        setoverall_dashboard54180({})
      }
    }else 
      prevRefreshRef.current= true
  }, [overall_dashboard54180Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("grp_total_transactions")  &&<Groupgrp_total_transactions  
        ...
        {allowedComponent.includes("grp_prn_initiated")  &&<Groupgrp_prn_initiated  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("grp_prn_approved")  &&<Groupgrp_prn_approved  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("grp_credit_pending")  &&<Groupgrp_credit_pending  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("grp_credit_approved")  &&<Groupgrp_credit_approved  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("grp_payment_completed")  &&<Groupgrp_payment_completed  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("grp_bar_chart")  &&<Groupgrp_bar_chart  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          paginationDetails={paginationDetails}
          setIsProcessing={setIsProcessing}        />}
        {allowedComponent.includes("grp_pie_chart")  &&<Groupgrp_pie_chart  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
...
export default Groupoverall_dashboard
