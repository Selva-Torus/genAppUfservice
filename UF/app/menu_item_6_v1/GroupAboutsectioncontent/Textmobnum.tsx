...
const Textmobnum = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  if (mobnum9f6f4?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `10 / 13`,gridRow: `143 / 151`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="body-3"
      color ="primary"
    >
    {isDynamic ? item?.mobnum : (aboutsectioncontent3ada4?.mobnum || "")}
    </Text>
  </div>
  )
}

export default Textmobnum
