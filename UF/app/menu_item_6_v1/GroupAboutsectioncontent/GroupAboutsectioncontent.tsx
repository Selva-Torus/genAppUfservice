...
import GroupAboutsectioncontentimg1  from "../GroupAboutsectioncontentimg1/GroupAboutsectioncontentimg1";
import GroupAboutsectioncontentheadingwrapper  from "../GroupAboutsectioncontentheadingwrapper/GroupAboutsectioncontentheadingwrapper";
import GroupAbout_section_content_Card_1  from "../GroupAbout_section_content_Card_1/GroupAbout_section_content_Card_1";
import GroupAboutsectioncontentimg2  from "../GroupAboutsectioncontentimg2/GroupAboutsectioncontentimg2";
import GroupAboutsectioncontentimg3  from "../GroupAboutsectioncontentimg3/GroupAboutsectioncontentimg3";
import GroupAboutsectioncontentCard2  from "../GroupAboutsectioncontentCard2/GroupAboutsectioncontentCard2";
import GroupAboutSectionContentCards  from "../GroupAboutSectionContentCards/GroupAboutSectionContentCards";
...
import TextAboutsectioncontentheader  from "./TextAboutsectioncontentheader";
import TextAboutsectioncontentbody  from "./TextAboutsectioncontentbody";
import ButtonLearnAboutUs  from "./ButtonLearnAboutUs";
import Textcallus  from "./Textcallus";
import Textmobnum  from "./Textmobnum";
...
const GroupAboutsectioncontent = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:New_HomeScreen:AFVK:v1",componentId:"20f039471c6749e3a6186fd0d473ada4",from:"GroupAboutsectioncontent",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentimg1")){
      setaboutsectioncontentimg1c0718({...aboutsectioncontentimg1c0718,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentheadingwrapper")){
      setaboutsectioncontentheadingwrapper82b26({...aboutsectioncontentheadingwrapper82b26,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentheader")){
      setaboutsectioncontentheaderbda1f({...aboutsectioncontentheaderbda1f,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentbody")){
      setaboutsectioncontentbody90f38({...aboutsectioncontentbody90f38,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("about_section_content_card_1")){
      setabout_section_content_card_10975b({...about_section_content_card_10975b,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentimg2")){
      setaboutsectioncontentimg26f2bf({...aboutsectioncontentimg26f2bf,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentimg3")){
      setaboutsectioncontentimg35e371({...aboutsectioncontentimg35e371,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcard2")){
      setaboutsectioncontentcard2bb8af({...aboutsectioncontentcard2bb8af,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("learnaboutus")){
      setlearnaboutus17894({...learnaboutus17894,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("callus")){
      setcallus10721({...callus10721,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("mobnum")){
      setmobnum9f6f4({...mobnum9f6f4,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcards")){
      setaboutsectioncontentcards42230({...aboutsectioncontentcards42230,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const aboutsectioncontent3ada4Ref = useRef<any>(null);
  const handleClearSearch = () => {
    aboutsectioncontent3ada4Ref.current?.setSearchParams();
    aboutsectioncontent3ada4Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(aboutsectioncontent3ada4) && Object.keys(aboutsectioncontent3ada4)?.length>0)
      {
        setaboutsectioncontent3ada4({})
      }
    }else 
      prevRefreshRef.current= true
  }, [aboutsectioncontent3ada4Props?.refresh])
  ...
  return (
    ...
    >
        {allowedComponent.includes("aboutsectioncontentimg1")  &&<GroupAboutsectioncontentimg1  
        ...
        {allowedComponent.includes("aboutsectioncontentheadingwrapper")  &&<GroupAboutsectioncontentheadingwrapper  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          encryptionFlagPageData={encryptionFlagPageData}
          paginationDetails={paginationDetails}        />}
        {allowedComponent.includes("about_section_content_card_1")  &&<GroupAbout_section_content_Card_1  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          encryptionFlagPageData={encryptionFlagPageData}
          paginationDetails={paginationDetails}        />}
        {allowedComponent.includes("aboutsectioncontentimg2")  &&<GroupAboutsectioncontentimg2  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          encryptionFlagPageData={encryptionFlagPageData}
          paginationDetails={paginationDetails}        />}
        {allowedComponent.includes("aboutsectioncontentimg3")  &&<GroupAboutsectioncontentimg3  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          encryptionFlagPageData={encryptionFlagPageData}
          paginationDetails={paginationDetails}        />}
        {allowedComponent.includes("aboutsectioncontentcard2")  &&<GroupAboutsectioncontentCard2  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          encryptionFlagPageData={encryptionFlagPageData}
          paginationDetails={paginationDetails}        />}
        {allowedComponent.includes("aboutsectioncontentcards")  &&<GroupAboutSectionContentCards  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          encryptionFlagPageData={encryptionFlagPageData}
          paginationDetails={paginationDetails}        />}
          {allowedControls.includes("aboutsectioncontentheader") ?<TextAboutsectioncontentheader   /* bda1f */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} />: <div></div>}
          {allowedControls.includes("aboutsectioncontentbody") ?<TextAboutsectioncontentbody   /* 90f38 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} />: <div></div>}
        {allowedControls.includes("learnaboutus")  ?<ButtonLearnAboutUs lockedData={lockedData} setLockedData={setLockedData} primaryTableData={primaryTableData} setPrimaryTableData={setPrimaryTableData} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData}/>: <div></div>}          
          {allowedControls.includes("callus") ?<Textcallus   /* 10721 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} />: <div></div>}
          {allowedControls.includes("mobnum") ?<Textmobnum   /* 9f6f4 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} />: <div></div>}
    </div>
 )
}

export default GroupAboutsectioncontent
