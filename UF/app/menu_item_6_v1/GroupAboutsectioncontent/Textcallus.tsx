...
const Textcallus = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  if (callus10721?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `10 / 13`,gridRow: `136 / 143`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="body-3"
      color ="primary"
    >
    {isDynamic ? item?.callus : (aboutsectioncontent3ada4?.callus || "")}
    </Text>
  </div>
  )
}
