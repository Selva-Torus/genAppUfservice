...
const TextAboutsectioncontentCardsteamhead = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcardsteamheadcc537?.refresh])

  if (aboutsectioncontentcardsteamheadcc537?.isHidden) {
    return <></>
  }
...
return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `1 / 16`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      ...
      color ="brand"
    >
    {isDynamic ? item?.aboutsectioncontentcardsteamhead : (aboutsectioncontentcardsteamcea5d?.aboutsectioncontentcardsteamhead || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCardsteamhead
