...
const TextAboutsectioncontentCardsteamsub = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcardsteamsub8c9ee?.refresh])

  if (aboutsectioncontentcardsteamsub8c9ee?.isHidden) {
    return <></>
  }
...
return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `16 / 31`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      ...
      color ="secondary"
    >
    {isDynamic ? item?.aboutsectioncontentcardsteamsub : (aboutsectioncontentcardsteamcea5d?.aboutsectioncontentcardsteamsub || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCardsteamsub
