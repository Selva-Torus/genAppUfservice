...
import GroupHersectioncontentCard1  from "../GroupHersectioncontentCard1/GroupHersectioncontentCard1";
import GroupHersectioncontentCard2  from "../GroupHersectioncontentCard2/GroupHersectioncontentCard2";
import GroupHersectioncontentCard3  from "../GroupHersectioncontentCard3/GroupHersectioncontentCard3";
...
const GroupHerSectioncontentCard = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:New_HomeScreen:AFVK:v1",componentId:"fd1029c243a4452f9f7a41ac57568df4",from:"GroupHersectioncontentcard",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("hersectioncontentcard1")){
      sethersectioncontentcard1b9c4a({...hersectioncontentcard1b9c4a,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("hersectioncontentcard2")){
      sethersectioncontentcard2cd13f({...hersectioncontentcard2cd13f,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("hersectioncontentcard3")){
      sethersectioncontentcard39a879({...hersectioncontentcard39a879,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const hersectioncontentcard68df4Ref = useRef<any>(null);
  const handleClearSearch = () => {
    hersectioncontentcard68df4Ref.current?.setSearchParams();
    hersectioncontentcard68df4Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(hersectioncontentcard68df4) && Object.keys(hersectioncontentcard68df4)?.length>0)
      {
        sethersectioncontentcard68df4({})
      }
    }else 
      prevRefreshRef.current= true
  }, [hersectioncontentcard68df4Props?.refresh])
  ...
  return (
    ...
    >
        {allowedComponent.includes("hersectioncontentcard1")  &&<GroupHersectioncontentCard1  
        ...
        {allowedComponent.includes("hersectioncontentcard2")  &&<GroupHersectioncontentCard2  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          encryptionFlagPageData={encryptionFlagPageData}
          paginationDetails={paginationDetails}        />}
        {allowedComponent.includes("hersectioncontentcard3")  &&<GroupHersectioncontentCard3  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
...
export default GroupHerSectioncontentCard
