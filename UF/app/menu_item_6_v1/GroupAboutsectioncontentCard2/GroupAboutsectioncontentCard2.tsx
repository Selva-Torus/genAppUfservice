...
import GroupAboutsectioncontentCard2iconwrapper  from "../GroupAboutsectioncontentCard2iconwrapper/GroupAboutsectioncontentCard2iconwrapper";
...
import TextAboutsectioncontentCard2head  from "./TextAboutsectioncontentCard2head";
import TextAboutsectioncontentCard2body  from "./TextAboutsectioncontentCard2body";
...
const GroupAboutsectioncontentCard2 = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false}:any)=> {
 ...
 /////////////
  ...
  const {aboutsectioncontentcard2headb2483, setaboutsectioncontentcard2headb2483}= useContext(TotalContext) as TotalContextProps;
  const {aboutsectioncontentcard2body10fb4, setaboutsectioncontentcard2body10fb4}= useContext(TotalContext) as TotalContextProps;
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:New_HomeScreen:AFVK:v1",componentId:"2a45945244dd4891aa645b67bd3bb8af",from:"GroupAboutsectioncontentcard2",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcard2iconwrapper")){
      setaboutsectioncontentcard2iconwrapper90155({...aboutsectioncontentcard2iconwrapper90155,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcard2head")){
      setaboutsectioncontentcard2headb2483({...aboutsectioncontentcard2headb2483,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcard2body")){
      setaboutsectioncontentcard2body10fb4({...aboutsectioncontentcard2body10fb4,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const aboutsectioncontentcard2bb8afRef = useRef<any>(null);
  const handleClearSearch = () => {
    aboutsectioncontentcard2bb8afRef.current?.setSearchParams();
    aboutsectioncontentcard2bb8afRef.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(aboutsectioncontentcard2bb8af) && Object.keys(aboutsectioncontentcard2bb8af)?.length>0)
      {
        setaboutsectioncontentcard2bb8af({})
      }
    }else 
      prevRefreshRef.current= true
  }, [aboutsectioncontentcard2bb8afProps?.refresh])
  ...
  return (
    ...
    >
        {allowedComponent.includes("aboutsectioncontentcard2iconwrapper")  &&<GroupAboutsectioncontentCard2iconwrapper  
          ...
          {allowedControls.includes("aboutsectioncontentcard2head") ?<TextAboutsectioncontentCard2head   /* b2483 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} />: <div></div>}
          {allowedControls.includes("aboutsectioncontentcard2body") ?<TextAboutsectioncontentCard2body   /* 10fb4 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} />: <div></div>}
    </div>
 )
}

export default GroupAboutsectioncontentCard2
