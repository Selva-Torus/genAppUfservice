...
const TextAboutsectioncontentCard2body = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcard2body10fb4?.refresh])

  if (aboutsectioncontentcard2body10fb4?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 13`,gridRow: `11 / 29`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className="text-left"
      variant ="body-2"
      color ="primary"
    >
    {isDynamic ? item?.aboutsectioncontentcard2body : (aboutsectioncontentcard2bb8af?.aboutsectioncontentcard2body || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCard2body
