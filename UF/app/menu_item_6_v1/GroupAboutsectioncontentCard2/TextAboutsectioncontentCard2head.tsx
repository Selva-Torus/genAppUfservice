...
const TextAboutsectioncontentCard2head = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcard2headb2483?.refresh])

  if (aboutsectioncontentcard2headb2483?.isHidden) {
    return <></>
  }
...
return (
  <div className="" style={{gridColumn: `3 / 8`,gridRow: `2 / 11`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      ...
      color ="primary"
    >
    {isDynamic ? item?.aboutsectioncontentcard2head : (aboutsectioncontentcard2bb8af?.aboutsectioncontentcard2head || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCard2head
