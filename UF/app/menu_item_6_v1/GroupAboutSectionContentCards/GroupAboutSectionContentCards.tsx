...
import GroupAboutsectioncontentCardsproject  from "../GroupAboutsectioncontentCardsproject/GroupAboutsectioncontentCardsproject";
import GroupAboutsectioncontentCardscllient  from "../GroupAboutsectioncontentCardscllient/GroupAboutsectioncontentCardscllient";
import GroupAboutsectioncontentCardsteam  from "../GroupAboutsectioncontentCardsteam/GroupAboutsectioncontentCardsteam";
import GroupAboutsectioncontentCardscustomer  from "../GroupAboutsectioncontentCardscustomer/GroupAboutsectioncontentCardscustomer";
...
const GroupAboutSectionContentCards = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:New_HomeScreen:AFVK:v1",componentId:"41194b91027348b3a126f6a773742230",from:"GroupAboutsectioncontentcards",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcardsproject")){
      setaboutsectioncontentcardsproject39023({...aboutsectioncontentcardsproject39023,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcardscllient")){
      setaboutsectioncontentcardscllient4f691({...aboutsectioncontentcardscllient4f691,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcardsteam")){
      setaboutsectioncontentcardsteamcea5d({...aboutsectioncontentcardsteamcea5d,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcardscustomer")){
      setaboutsectioncontentcardscustomer2cf01({...aboutsectioncontentcardscustomer2cf01,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const aboutsectioncontentcards42230Ref = useRef<any>(null);
  const handleClearSearch = () => {
    aboutsectioncontentcards42230Ref.current?.setSearchParams();
    aboutsectioncontentcards42230Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(aboutsectioncontentcards42230) && Object.keys(aboutsectioncontentcards42230)?.length>0)
      {
        setaboutsectioncontentcards42230({})
      }
    }else 
      prevRefreshRef.current= true
  }, [aboutsectioncontentcards42230Props?.refresh])
  ...
  return (
    ...
    >
        {allowedComponent.includes("aboutsectioncontentcardsproject")  &&<GroupAboutsectioncontentCardsproject  
        ...
        {allowedComponent.includes("aboutsectioncontentcardscllient")  &&<GroupAboutsectioncontentCardscllient  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          encryptionFlagPageData={encryptionFlagPageData}
          paginationDetails={paginationDetails}        />}
        {allowedComponent.includes("aboutsectioncontentcardsteam")  &&<GroupAboutsectioncontentCardsteam  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
          ...
          encryptionFlagPageData={encryptionFlagPageData}
          paginationDetails={paginationDetails}        />}
        {allowedComponent.includes("aboutsectioncontentcardscustomer")  &&<GroupAboutsectioncontentCardscustomer  
          lockedData={lockedData} 
          setLockedData={setLockedData} 
          primaryTableData={primaryTableData}
          setPrimaryTableData={setPrimaryTableData}
...
export default GroupAboutSectionContentCards
