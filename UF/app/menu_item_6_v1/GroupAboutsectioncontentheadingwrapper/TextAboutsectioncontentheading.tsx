...
const TextAboutsectioncontentheading = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentheadingce067?.refresh])

  if (aboutsectioncontentheadingce067?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 13`,gridRow: `1 / 9`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="subheader-3"
      color ="brand"
    >
    {isDynamic ? item?.aboutsectioncontentheading : (aboutsectioncontentheadingwrapper82b26?.aboutsectioncontentheading || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentheading
