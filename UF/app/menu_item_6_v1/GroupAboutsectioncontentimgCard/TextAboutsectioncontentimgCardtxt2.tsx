...
const TextAboutsectioncontentimgCardtxt2 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentimgcardtxt2e6ca9?.refresh])

  if (aboutsectioncontentimgcardtxt2e6ca9?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `14 / 23`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className="tracking-[0.2em]"
      variant ="subheader-2"
      color ="primary"
    >
    {isDynamic ? item?.aboutsectioncontentimgcardtxt2 : (aboutsectioncontentimgcard1df84?.aboutsectioncontentimgcardtxt2 || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentimgCardtxt2
