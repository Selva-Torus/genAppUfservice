...
const TextAboutsectioncontentimgCardtxt1 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentimgcardtxt1d3325?.refresh])

  if (aboutsectioncontentimgcardtxt1d3325?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `2 / 12`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="display-1"
      color ="brand"
    >
    {isDynamic ? item?.aboutsectioncontentimgcardtxt1 : (aboutsectioncontentimgcard1df84?.aboutsectioncontentimgcardtxt1 || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentimgCardtxt1
