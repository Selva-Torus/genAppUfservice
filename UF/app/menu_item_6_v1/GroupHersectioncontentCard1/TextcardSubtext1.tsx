...
const TextcardSubtext1 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cardsubtext17f94b?.refresh])

  if (cardsubtext17f94b?.isHidden) {
    return <></>
  }
...
return (
  <div className="" style={{gridColumn: `5 / 12`,gridRow: `10 / 19`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      ...
      color ="primary"
    >
    {isDynamic ? item?.cardsubtext1 : (hersectioncontentcard1b9c4a?.cardsubtext1 || "")}
    </Text>
  </div>
  )
}

export default TextcardSubtext1
