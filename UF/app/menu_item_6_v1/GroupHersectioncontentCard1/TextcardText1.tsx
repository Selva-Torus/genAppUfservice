...
const TextcardText1 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cardtext15e070?.refresh])

  if (cardtext15e070?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `5 / 12`,gridRow: `3 / 10`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className="text-start"
      variant ="header-1"
      color ="primary"
    >
    {isDynamic ? item?.cardtext1 : (hersectioncontentcard1b9c4a?.cardtext1 || "")}
    </Text>
  </div>
  )
}

export default TextcardText1
