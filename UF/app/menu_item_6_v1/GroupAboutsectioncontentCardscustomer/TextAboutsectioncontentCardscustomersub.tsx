...
const TextAboutsectioncontentCardscustomersub = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcardscustomersub0e559?.refresh])

  if (aboutsectioncontentcardscustomersub0e559?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `15 / 29`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="body-3"
      color ="secondary"
    >
    {isDynamic ? item?.aboutsectioncontentcardscustomersub : (aboutsectioncontentcardscustomer2cf01?.aboutsectioncontentcardscustomersub || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCardscustomersub
