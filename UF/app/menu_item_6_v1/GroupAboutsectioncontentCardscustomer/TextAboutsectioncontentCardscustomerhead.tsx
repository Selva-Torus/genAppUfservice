...
const TextAboutsectioncontentCardscustomerhead = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcardscustomerhead56ea2?.refresh])

  if (aboutsectioncontentcardscustomerhead56ea2?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `1 / 15`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="display-2"
      color ="brand"
    >
    {isDynamic ? item?.aboutsectioncontentcardscustomerhead : (aboutsectioncontentcardscustomer2cf01?.aboutsectioncontentcardscustomerhead || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCardscustomerhead
