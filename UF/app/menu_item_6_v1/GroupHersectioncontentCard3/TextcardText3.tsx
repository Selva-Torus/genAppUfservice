...
const TextcardText3 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cardtext3d6a42?.refresh])

  if (cardtext3d6a42?.isHidden) {
    return <></>
  }
...
return (
  <div className="" style={{gridColumn: `5 / 12`,gridRow: `3 / 10`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      ...
      color ="primary"
    >
    {isDynamic ? item?.cardtext3 : (hersectioncontentcard39a879?.cardtext3 || "")}
    </Text>
  </div>
  )
}

export default TextcardText3
