...
const IconcardIcon3 = ({encryptionFlagCompData}:any) => {
...
return (
  <div 
    ...
    <Icon 
      className=""
      size={45}
      data="MdAssuredWorkload"
    />
  </div>
  )
}

export default IconcardIcon3
