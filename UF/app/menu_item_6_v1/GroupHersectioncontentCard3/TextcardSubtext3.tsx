...
const TextcardSubtext3 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cardsubtext39c9b7?.refresh])

  if (cardsubtext39c9b7?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `5 / 12`,gridRow: `10 / 19`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="body-3"
      color ="primary"
    >
    {isDynamic ? item?.cardsubtext3 : (hersectioncontentcard39a879?.cardsubtext3 || "")}
    </Text>
  </div>
  )
}

export default TextcardSubtext3
