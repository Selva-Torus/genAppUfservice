...
const TextAboutsectioncontentCard1head = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcard1headf9516?.refresh])

  if (aboutsectioncontentcard1headf9516?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 8`,gridRow: `2 / 11`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className="text-left"
      variant ="header-1"
      color ="primary"
    >
    {isDynamic ? item?.aboutsectioncontentcard1head : (about_section_content_card_10975b?.aboutsectioncontentcard1head || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCard1head
