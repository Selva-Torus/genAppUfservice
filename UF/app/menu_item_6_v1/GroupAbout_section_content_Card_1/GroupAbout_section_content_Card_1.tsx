...
import GroupAboutsectioncontentCard1iconwrapper  from "../GroupAboutsectioncontentCard1iconwrapper/GroupAboutsectioncontentCard1iconwrapper";
...
import TextAboutsectioncontentCard1head  from "./TextAboutsectioncontentCard1head";
import TextAboutsectioncontentCard1body  from "./TextAboutsectioncontentCard1body";
...
const GroupAbout_section_content_Card_1 = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false}:any)=> {
 ...
 /////////////
  ...
  const {aboutsectioncontentcard1headf9516, setaboutsectioncontentcard1headf9516}= useContext(TotalContext) as TotalContextProps;
  const {aboutsectioncontentcard1bodyf0b55, setaboutsectioncontentcard1bodyf0b55}= useContext(TotalContext) as TotalContextProps;
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:New_HomeScreen:AFVK:v1",componentId:"d1ec8c7c7ead4d88bc527dee6440975b",from:"GroupAboutSectionContentCard1",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcard1iconwrapper")){
      setaboutsectioncontentcard1iconwrapper885d6({...aboutsectioncontentcard1iconwrapper885d6,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcard1head")){
      setaboutsectioncontentcard1headf9516({...aboutsectioncontentcard1headf9516,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcard1body")){
      setaboutsectioncontentcard1bodyf0b55({...aboutsectioncontentcard1bodyf0b55,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const about_section_content_card_10975bRef = useRef<any>(null);
  const handleClearSearch = () => {
    about_section_content_card_10975bRef.current?.setSearchParams();
    about_section_content_card_10975bRef.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(about_section_content_card_10975b) && Object.keys(about_section_content_card_10975b)?.length>0)
      {
        setabout_section_content_card_10975b({})
      }
    }else 
      prevRefreshRef.current= true
  }, [about_section_content_card_10975bProps?.refresh])
  ...
  return (
    ...
    >
        {allowedComponent.includes("aboutsectioncontentcard1iconwrapper")  &&<GroupAboutsectioncontentCard1iconwrapper  
          ...
          {allowedControls.includes("aboutsectioncontentcard1head") ?<TextAboutsectioncontentCard1head   /* f9516 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} />: <div></div>}
          {allowedControls.includes("aboutsectioncontentcard1body") ?<TextAboutsectioncontentCard1body   /* f0b55 */ isDynamic={false } index={idx} item={item} checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} />: <div></div>}
    </div>
 )
}

export default GroupAbout_section_content_Card_1
