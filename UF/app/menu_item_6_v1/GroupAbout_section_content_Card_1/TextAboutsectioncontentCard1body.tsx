...
const TextAboutsectioncontentCard1body = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcard1bodyf0b55?.refresh])

  if (aboutsectioncontentcard1bodyf0b55?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 13`,gridRow: `11 / 26`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className="text-left"
      variant ="body-2"
      color ="primary"
    >
    {isDynamic ? item?.aboutsectioncontentcard1body : (about_section_content_card_10975b?.aboutsectioncontentcard1body || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCard1body
