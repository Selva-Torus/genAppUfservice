...
const TextHersectionheading = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[hersectionheadingf316a?.refresh])

  if (hersectionheadingf316a?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 11`,gridRow: `35 / 68`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className="text-center"
      variant ="display-3"
      color ="primary"
    >
    {isDynamic ? item?.hersectionheading : (herosectioncontent0b52c?.hersectionheading || "")}
    </Text>
  </div>
  )
}

export default TextHersectionheading
