...
const ButtonGetStartedToday = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "515b827a16174d9089bb10e6ada048fa",
          isTable: false,
          from:"ButtonGet Started Today",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "getstartedtoday048fa") {
        handleClick();
      }
    });
  },[getstartedtoday048fa?.refresh])
 ...
 if (getstartedtoday048fa?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `3 / 7`,gridRow: `119 / 139`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='raised'
          size='l'           
          disabled= {getstartedtoday048fa?.isDisabled ? true : false}
          pin='round-round'
        >
              {keyset("Get Started Today")}
        </Button>
      </div>
...
export default ButtonGetStartedToday
