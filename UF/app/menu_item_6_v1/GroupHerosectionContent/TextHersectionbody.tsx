...
const TextHersectionbody = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[hersectionbodyf3ff1?.refresh])

  if (hersectionbodyf3ff1?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `3 / 11`,gridRow: `73 / 112`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className="text-center"
      variant ="body-2"
      color ="primary"
    >
    {isDynamic ? item?.hersectionbody : (herosectioncontent0b52c?.hersectionbody || "")}
    </Text>
  </div>
  )
}

export default TextHersectionbody
