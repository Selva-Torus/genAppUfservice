...
const ButtonAwardWinningAgency = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          componentId: "0971eb6db00949e6ab37b41fc3f0b52c",
          controlId: "f85a0a3e5f804c398360a0babd8f5a9b",
          isTable: false,
          from:"ButtonAward Winning Agency",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "awardwinningagencyf5a9b") {
        handleClick();
      }
    });
  },[awardwinningagencyf5a9b?.refresh])
  ...
  const handleClick=async()=>{
    if(herosectioncontent0b52cProps?.validation==true && herosectioncontent0b52cProps?.required==true || herosectioncontent0b52cProps?.required==true)
    {
 ...
 if (awardwinningagencyf5a9b?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `5 / 9`,gridRow: `13 / 29`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='outlined'
          size='m'           
          disabled= {awardwinningagencyf5a9b?.isDisabled ? true : false}
          pin='circle-circle'
          startContent={
            <span className="h-full flex justify-center items-center" >
                <div className="bg-transparent flex justify-center items-center" >
                  <Icon size={20} data="MdOutlineStar" className="bg-transparent flex justify-center items-center" />
                </div>
            </span>
          }   
        >
              {keyset("Award Winning Agency")}
        </Button>
      </div>
...
export default ButtonAwardWinningAgency
