...
const ButtonViewOurWork = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "ae842e61cbf648feba14df85b097b0db",
          isTable: false,
          from:"ButtonView Our Work",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "viewourwork7b0db") {
        handleClick();
      }
    });
  },[viewourwork7b0db?.refresh])
 ...
 if (viewourwork7b0db?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `8 / 11`,gridRow: `119 / 136`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='outlined'
          size='l'           
          disabled= {viewourwork7b0db?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("View Our Work")}
        </Button>
      </div>
...
export default ButtonViewOurWork
