...
import IconAboutsectioncontentCard1icon  from "./IconAboutsectioncontentCard1icon";
...
const GroupAboutsectioncontentCard1iconwrapper = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false}:any)=> {
 ...
 /////////////
  ...
  const {aboutsectioncontentcard1icon75f2a, setaboutsectioncontentcard1icon75f2a}= useContext(TotalContext) as TotalContextProps;
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:New_HomeScreen:AFVK:v1",componentId:"0c6b6584-dbae-4f1a-ba86-8d4fb10885d6",from:"GroupAboutsectioncontentcard1iconwrapper",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcard1icon")){
      setaboutsectioncontentcard1icon75f2a({...aboutsectioncontentcard1icon75f2a,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const aboutsectioncontentcard1iconwrapper885d6Ref = useRef<any>(null);
  const handleClearSearch = () => {
    aboutsectioncontentcard1iconwrapper885d6Ref.current?.setSearchParams();
    aboutsectioncontentcard1iconwrapper885d6Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(aboutsectioncontentcard1iconwrapper885d6) && Object.keys(aboutsectioncontentcard1iconwrapper885d6)?.length>0)
      {
        setaboutsectioncontentcard1iconwrapper885d6({})
      }
    }else 
      prevRefreshRef.current= true
  }, [aboutsectioncontentcard1iconwrapper885d6Props?.refresh])
  ...
  return (
    ...
    >
        {allowedControls.includes("aboutsectioncontentcard1icon")?<IconAboutsectioncontentCard1icon /* 75f2a */ encryptionFlagCompData={encryptionFlagCompData}  />: <div></div>}
    </div>
 )
}

export default GroupAboutsectioncontentCard1iconwrapper
