...
const IconAboutsectioncontentCard1icon = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:New_HomeScreen:AFVK:v1",  componentId:"0c6b6584-dbae-4f1a-ba86-8d4fb10885d6",controlId:"1f94abd9-83b5-4938-bffd-15be1b775f2a",isTable:false,accessProfile:accessProfile,from:"IconAbout_section_content_Card_1_icon"},{
      headers: {
  ...
  if (aboutsectioncontentcard1icon75f2a?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `1 / 13`,gridRow: `1 / 28`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={57}
...
export default IconAboutsectioncontentCard1icon
