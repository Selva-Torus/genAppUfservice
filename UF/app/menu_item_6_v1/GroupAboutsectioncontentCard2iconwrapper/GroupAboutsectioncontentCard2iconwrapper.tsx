...
import IconAboutsectioncontentCard2icon  from "./IconAboutsectioncontentCard2icon";
...
const GroupAboutsectioncontentCard2iconwrapper = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false}:any)=> {
 ...
 /////////////
  ...
  const {aboutsectioncontentcard2icon86506, setaboutsectioncontentcard2icon86506}= useContext(TotalContext) as TotalContextProps;
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:New_HomeScreen:AFVK:v1",componentId:"2fe53f3e3f3f4e4f8d0f841603f90155",from:"GroupAboutsectioncontentcard2iconwrapper",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentcard2icon")){
      setaboutsectioncontentcard2icon86506({...aboutsectioncontentcard2icon86506,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const aboutsectioncontentcard2iconwrapper90155Ref = useRef<any>(null);
  const handleClearSearch = () => {
    aboutsectioncontentcard2iconwrapper90155Ref.current?.setSearchParams();
    aboutsectioncontentcard2iconwrapper90155Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(aboutsectioncontentcard2iconwrapper90155) && Object.keys(aboutsectioncontentcard2iconwrapper90155)?.length>0)
      {
        setaboutsectioncontentcard2iconwrapper90155({})
      }
    }else 
      prevRefreshRef.current= true
  }, [aboutsectioncontentcard2iconwrapper90155Props?.refresh])
  ...
  return (
    ...
    >
        {allowedControls.includes("aboutsectioncontentcard2icon")?<IconAboutsectioncontentCard2icon /* 86506 */ encryptionFlagCompData={encryptionFlagCompData}  />: <div></div>}
    </div>
 )
}

export default GroupAboutsectioncontentCard2iconwrapper
