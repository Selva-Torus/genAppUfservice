...
const IconAboutsectioncontentCard2icon = ({encryptionFlagCompData}:any) => {
  ...
  if (aboutsectioncontentcard2icon86506?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `1 / 13`,gridRow: `1 / 27`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={57}
      data="MdManageAccounts"
    />
  </div>
  )
}

export default IconAboutsectioncontentCard2icon
