...
import GroupAboutsectioncontentimgCard  from "../GroupAboutsectioncontentimgCard/GroupAboutsectioncontentimgCard";
...
const GroupAboutsectioncontentimg1 = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:New_HomeScreen:AFVK:v1",componentId:"6e55b24d93e04a2fbea62f867a3c0718",from:"GroupAboutsectioncontentimg1",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("aboutsectioncontentimgcard")){
      setaboutsectioncontentimgcard1df84({...aboutsectioncontentimgcard1df84,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const aboutsectioncontentimg1c0718Ref = useRef<any>(null);
  const handleClearSearch = () => {
    aboutsectioncontentimg1c0718Ref.current?.setSearchParams();
    aboutsectioncontentimg1c0718Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(aboutsectioncontentimg1c0718) && Object.keys(aboutsectioncontentimg1c0718)?.length>0)
      {
        setaboutsectioncontentimg1c0718({})
      }
    }else 
      prevRefreshRef.current= true
  }, [aboutsectioncontentimg1c0718Props?.refresh])
  ...
  return (
    <div 
      style={{          
        ...
        overflow: 'auto',
        backgroundColor:'',
        backgroundImage:'url("	https://bootstrapmade.com/content/demo/Landio/assets/img/about/about-14.webp")',
        backgroundPosition: '',
    ...
    >
        {allowedComponent.includes("aboutsectioncontentimgcard")  &&<GroupAboutsectioncontentimgCard  
...
export default GroupAboutsectioncontentimg1
