...
const TextAboutsectioncontentCardsprojecthead = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcardsprojectheadef54b?.refresh])

  if (aboutsectioncontentcardsprojectheadef54b?.isHidden) {
    return <></>
  }
...
return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `1 / 16`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      ...
      color ="brand"
    >
    {isDynamic ? item?.aboutsectioncontentcardsprojecthead : (aboutsectioncontentcardsproject39023?.aboutsectioncontentcardsprojecthead || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCardsprojecthead
