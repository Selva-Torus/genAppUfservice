...
const TextAboutsectioncontentCardsprojectsub = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcardsprojectsubefc2a?.refresh])

  if (aboutsectioncontentcardsprojectsubefc2a?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `17 / 30`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="body-3"
      color ="secondary"
    >
    {isDynamic ? item?.aboutsectioncontentcardsprojectsub : (aboutsectioncontentcardsproject39023?.aboutsectioncontentcardsprojectsub || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCardsprojectsub
