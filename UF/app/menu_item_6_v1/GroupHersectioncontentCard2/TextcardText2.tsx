...
const TextcardText2 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cardtext23d68e?.refresh])

  if (cardtext23d68e?.isHidden) {
    return <></>
  }
...
return (
  <div className="" style={{gridColumn: `5 / 12`,gridRow: `3 / 10`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      ...
      color ="primary"
    >
    {isDynamic ? item?.cardtext2 : (hersectioncontentcard2cd13f?.cardtext2 || "")}
    </Text>
  </div>
  )
}

export default TextcardText2
