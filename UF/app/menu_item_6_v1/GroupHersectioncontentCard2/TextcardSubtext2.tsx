...
const TextcardSubtext2 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[cardsubtext23c206?.refresh])

  if (cardsubtext23c206?.isHidden) {
    return <></>
  }
...
return (
  <div className="" style={{gridColumn: `5 / 12`,gridRow: `10 / 19`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      ...
      color ="primary"
    >
    {isDynamic ? item?.cardsubtext2 : (hersectioncontentcard2cd13f?.cardsubtext2 || "")}
    </Text>
  </div>
  )
}

export default TextcardSubtext2
