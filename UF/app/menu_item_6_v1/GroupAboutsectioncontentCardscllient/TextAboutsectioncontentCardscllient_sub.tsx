...
const TextAboutsectioncontentCardscllient_sub = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcardscllient_sube3c0b?.refresh])

  if (aboutsectioncontentcardscllient_sube3c0b?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `16 / 31`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="body-3"
      color ="secondary"
    >
    {isDynamic ? item?.aboutsectioncontentcardscllient_sub : (aboutsectioncontentcardscllient4f691?.aboutsectioncontentcardscllient_sub || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCardscllient_sub
