...
const TextAboutsectioncontentCardscllienthead = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[aboutsectioncontentcardscllientheadbf743?.refresh])

  if (aboutsectioncontentcardscllientheadbf743?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `2 / 12`,gridRow: `1 / 16`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="display-2"
      color ="brand"
    >
    {isDynamic ? item?.aboutsectioncontentcardscllienthead : (aboutsectioncontentcardscllient4f691?.aboutsectioncontentcardscllienthead || "")}
    </Text>
  </div>
  )
}

export default TextAboutsectioncontentCardscllienthead
