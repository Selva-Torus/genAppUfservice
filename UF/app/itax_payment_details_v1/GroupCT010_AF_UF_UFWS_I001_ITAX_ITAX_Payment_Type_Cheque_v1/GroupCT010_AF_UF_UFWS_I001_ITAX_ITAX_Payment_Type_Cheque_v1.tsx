...
import Grouppayment_type_cheque_group  from "../Grouppayment_type_cheque_group/Grouppayment_type_cheque_group";
...
const GroupCT010_AF_UF_UFWS_I001_ITAX_ITAX_Payment_Type_Cheque_v1 = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT010:FNGK:AF:FNK:UF-UFW:CATK:I001:AFGK:ITAX:AFK:ITAX_Payment_Details:AFVK:v1",componentId:"437977e1f3d44507807810c112a9ea86",from:"GroupCt010AfUfUfwsI001ItaxItaxPaymentTypeChequeV1",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("payment_type_cheque_group")){
      setpayment_type_cheque_group239dd({...payment_type_cheque_group239dd,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const ct010_af_uf_ufws_i001_itax_itax_payment_type_cheque_v19ea86Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct010_af_uf_ufws_i001_itax_itax_payment_type_cheque_v19ea86Ref.current?.setSearchParams();
    ct010_af_uf_ufws_i001_itax_itax_payment_type_cheque_v19ea86Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct010_af_uf_ufws_i001_itax_itax_payment_type_cheque_v19ea86) && Object.keys(ct010_af_uf_ufws_i001_itax_itax_payment_type_cheque_v19ea86)?.length>0)
      {
        setct010_af_uf_ufws_i001_itax_itax_payment_type_cheque_v19ea86({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct010_af_uf_ufws_i001_itax_itax_payment_type_cheque_v19ea86Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("payment_type_cheque_group")  &&<Grouppayment_type_cheque_group  
...
export default GroupCT010_AF_UF_UFWS_I001_ITAX_ITAX_Payment_Type_Cheque_v1
