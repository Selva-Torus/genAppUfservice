...
const Textprn_details = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[prn_details7320a?.refresh])

  if (prn_details7320a?.isHidden) {
    return <></>
  }
...
export default Textprn_details
