...
const Textavailable_bal_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[available_bal_label08076?.refresh])

  if (available_bal_label08076?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Available Balance")}
</Text>
  </div>
  )
}

export default Textavailable_bal_label
