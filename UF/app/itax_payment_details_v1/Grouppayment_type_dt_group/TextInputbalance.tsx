...
const TextInputbalance = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT010:FNGK:AF:FNK:UF-UFW:CATK:I001:AFGK:ITAX:AFK:ITAX_Payment_Details:AFVK:v1|9f8b1c13bbde4e59b630d88d4acedf52|ce5f2fae255a4913b33453697d4b280e"
    }
  ],
  "schemaData": {
    "type": "number"
  ...
  const handleChange = async(e: any) => {
    ...
    setpayment_type_dt_groupedf52((prev: any) => ({ ...prev, balance: +e.target.value }));
    }
    else{
    setpayment_type_dt_groupedf52((prev: any) => ({ ...prev, balance: e.target.value }));
    }
    ...
    try{
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "ce5f2fae255a4913b33453697d4b280e",
          isTable: false,
  ...
  if(dfd_itax_source_tran_dfd_v1Props?.setSearchFilters && dfd_itax_source_tran_dfd_v1Props?.data)
  {
    if(Array.isArray(dfd_itax_source_tran_dfd_v1Props.data) && dfd_itax_source_tran_dfd_v1Props.data.length > 0){
      setpayment_type_dt_groupedf52((pre:any)=>({...pre,balance:dfd_itax_source_tran_dfd_v1Props.data[0]?.balance}));
    }
  }
  },[dfd_itax_source_tran_dfd_v1Props?.setSearchFilters])
  if (balanceb280e?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={payment_type_dt_groupedf52?.balance||""}
        numberFormat={dynamicStateandType.type === "number" ? "" : "none"}
         disabled= {balanceb280e?.isDisabled ? true : false}
        pin='brick-brick'     
