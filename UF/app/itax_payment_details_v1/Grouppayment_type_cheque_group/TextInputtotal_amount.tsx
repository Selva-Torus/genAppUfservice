...
const TextInputtotal_amount = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT010:FNGK:AF:FNK:UF-UFW:CATK:I001:AFGK:ITAX:AFK:ITAX_Payment_Details:AFVK:v1|6b1dff68ee4848a7a60e2092f2b239dd|2fad881c0d88466cb655b1cc09446433"
    }
  ],
  "schemaData": {
    "type": "number"
  ...
  const handleChange = async(e: any) => {
    ...
    setpayment_type_cheque_group239dd((prev: any) => ({ ...prev, total_amount: +e.target.value }));
    }
    else{
    setpayment_type_cheque_group239dd((prev: any) => ({ ...prev, total_amount: e.target.value }));
    }
    ...
    try{
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "2fad881c0d88466cb655b1cc09446433",
          isTable: false,
  ...
  if(dfd_itax_source_tran_dfd_v1Props?.setSearchFilters && dfd_itax_source_tran_dfd_v1Props?.data)
  {
    if(Array.isArray(dfd_itax_source_tran_dfd_v1Props.data) && dfd_itax_source_tran_dfd_v1Props.data.length > 0){
      setpayment_type_cheque_group239dd((pre:any)=>({...pre,total_amount:dfd_itax_source_tran_dfd_v1Props.data[0]?.total_amount}));
    }
  }
  },[dfd_itax_source_tran_dfd_v1Props?.setSearchFilters])
  if (total_amount46433?.isHidden) {
    return <></>
  }
  return (   
    <div  
      ...
      <TextInput
        ...
        value={payment_type_cheque_group239dd?.total_amount||""}
        numberFormat={dynamicStateandType.type === "number" ? "" : "none"}
         disabled= {total_amount46433?.isDisabled ? true : false}
        pin='brick-brick'     
