...
const Textdebit_account_no_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[debit_account_no_label86b10?.refresh])

  if (debit_account_no_label86b10?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 13`,gridRow: `2 / 12`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
  color="primary"
>
      {keyset("Debit Account No")}
</Text>
  </div>
  )
}

export default Textdebit_account_no_label
