...
import Grouppayment_type_dt_group  from "../Grouppayment_type_dt_group/Grouppayment_type_dt_group";
...
const GroupCT010_AF_UF_UFWS_I001_ITAX_ITAX_Payment_Type_DirectTransfer_v1 = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT010:FNGK:AF:FNK:UF-UFW:CATK:I001:AFGK:ITAX:AFK:ITAX_Payment_Details:AFVK:v1",componentId:"ff8c020eb0e24c558e426564d80dd0c7",from:"GroupCt010AfUfUfwsI001ItaxItaxPaymentTypeDirecttransferV1",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("payment_type_dt_group")){
      setpayment_type_dt_groupedf52({...payment_type_dt_groupedf52,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const ct010_af_uf_ufws_i001_itax_itax_payment_type_directtransfer_v1dd0c7Ref = useRef<any>(null);
  const handleClearSearch = () => {
    ct010_af_uf_ufws_i001_itax_itax_payment_type_directtransfer_v1dd0c7Ref.current?.setSearchParams();
    ct010_af_uf_ufws_i001_itax_itax_payment_type_directtransfer_v1dd0c7Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(ct010_af_uf_ufws_i001_itax_itax_payment_type_directtransfer_v1dd0c7) && Object.keys(ct010_af_uf_ufws_i001_itax_itax_payment_type_directtransfer_v1dd0c7)?.length>0)
      {
        setct010_af_uf_ufws_i001_itax_itax_payment_type_directtransfer_v1dd0c7({})
      }
    }else 
      prevRefreshRef.current= true
  }, [ct010_af_uf_ufws_i001_itax_itax_payment_type_directtransfer_v1dd0c7Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("payment_type_dt_group")  &&<Grouppayment_type_dt_group  
...
export default GroupCT010_AF_UF_UFWS_I001_ITAX_ITAX_Payment_Type_DirectTransfer_v1
