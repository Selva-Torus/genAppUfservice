...
const ButtonButtonReject = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "df628526f17548008916bd5de018b1d9",
          isTable: false,
          from:"ButtonButtonReject",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "buttonreject8b1d9") {
        buttonRef.current?.click();
      }
    });
  },[buttonreject8b1d9?.refresh])
 ...
 if (buttonreject8b1d9?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `5 / 7`,gridRow: `23 / 33`, gap:``, height: `100%`, overflow: 'auto'}} >
        <TorusButton 
          ref={buttonRef}
          className="w-full "
          onClick={handleClick}
          view='action'
          size='s'           
          disabled= {buttonreject8b1d9?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("ButtonReject")}
        </TorusButton>
...
export default ButtonButtonReject
