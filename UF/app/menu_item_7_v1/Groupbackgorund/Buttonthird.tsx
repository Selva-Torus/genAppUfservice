...
const Buttonthird = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          componentId: "a1762804fecf4c11a9bf912a71be9308",
          controlId: "19f42680d6c94bb6872148bc1ae76d18",
          isTable: false,
          from:"ButtonBook a Demo",
  ...
  const handleClick=async()=>{
    if(backgorunde9308Props?.validation==true && backgorunde9308Props?.required==true || backgorunde9308Props?.required==true)
    {
 ...
 if (third76d18?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `1 / 3`,gridRow: `92 / 109`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='action'
          size='xl'           
          disabled= {third76d18?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("Book a Demo")}
        </Button>
