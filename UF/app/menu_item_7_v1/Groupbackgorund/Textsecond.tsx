...
const Textsecond = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  if (secondd89c4?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 6`,gridRow: `60 / 89`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="header-1"
      color ="primary"
    >
    Automate recurring debits with zero paperwork, full compliance, and seamless integration. 
    </Text>
  </div>
  )
}
