...
const Iconicon1 = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:Veracious:AFVK:v1",  componentId:"612784f75f094475b337e4efaad0bc8a",controlId:"a1e14e8de10344e1b1c314310ae90895",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (icon190895?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `1 / 3`,gridRow: `111 / 134`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={50}
      ...
      headerText="Pull Data Scheduling &amp; Execution "
    />
  </div>
  )
}
