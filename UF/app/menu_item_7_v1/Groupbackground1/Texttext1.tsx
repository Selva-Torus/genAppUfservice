...
const Texttext1 = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  if (text16d8c2?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 3`,gridRow: `141 / 179`,gap:``, height: `100%`, overflow: 'auto'}} >
    <Text 
      className=""
      variant ="subheader-3"
      color ="primary"
