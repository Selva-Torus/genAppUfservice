...
const Iconicon4 = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:Veracious:AFVK:v1",  componentId:"612784f75f094475b337e4efaad0bc8a",controlId:"8daaea14961d4cb689720182ba6c9c0e",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (icon4c9c0e?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `10 / 12`,gridRow: `113 / 136`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={50}
      ...
      headerText="Error &amp; Exception Handling "
    />
  </div>
  )
}

export default Iconicon4
