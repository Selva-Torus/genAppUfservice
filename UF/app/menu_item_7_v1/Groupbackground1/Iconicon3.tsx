...
const Iconicon3 = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:Veracious:AFVK:v1",  componentId:"612784f75f094475b337e4efaad0bc8a",controlId:"b17f80055919417ba925548ba2279355",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (icon379355?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `7 / 9`,gridRow: `113 / 136`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={50}
      ...
      headerText="Core Banking Integration"
    />
  </div>
  )
}

export default Iconicon3
