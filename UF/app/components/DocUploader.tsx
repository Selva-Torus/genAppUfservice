...
const DocDropzone = React.forwardRef<HTMLInputElement, InputProps>(
  (
          ...
          {imageUrl && !disabled && (
            ...
            >
              <div className="flex h-5 w-5 items-center justify-center rounded-md border border-solid border-white/70 bg-black transition-all duration-300 hover:h-6 hover:w-6">
                <IoClose className="text-white/70" width={16} height={16} />
              </div>
            </div>
          )}
        </div>
...
DocDropzone.displayName = 'SingleImageDropzone';
