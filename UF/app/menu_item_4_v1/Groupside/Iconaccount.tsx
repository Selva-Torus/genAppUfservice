...
const Iconaccount = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:Dashboard3:AFVK:v1",  componentId:"f5b36dda2fd54aba9ca30b404275fa55",controlId:"4ddd59075e5b45119030b37fe3b895d0",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (account895d0?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `3 / 11`,gridRow: `62 / 78`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={45}
      data="MdAccountCircle"
    />
  </div>
  )
}
