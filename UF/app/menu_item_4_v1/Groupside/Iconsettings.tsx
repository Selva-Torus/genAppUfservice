...
const Iconsettings = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:Dashboard3:AFVK:v1",  componentId:"f5b36dda2fd54aba9ca30b404275fa55",controlId:"dfea72e17ce94a7d8fc056520cf67c80",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (settings67c80?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `3 / 11`,gridRow: `139 / 155`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={45}
      data="MdSettingsSuggest"
    />
  </div>
  )
}
