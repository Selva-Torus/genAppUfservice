...
const Iconnotification = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:Dashboard3:AFVK:v1",  componentId:"f5b36dda2fd54aba9ca30b404275fa55",controlId:"186c793fb0a24382b850cd60c5b7a80c",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (notification7a80c?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `3 / 11`,gridRow: `175 / 191`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={45}
      data="MdNotifications"
    />
  </div>
  )
}
