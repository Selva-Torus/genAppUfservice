...
const Iconhelp = ({encryptionFlagCompData}:any) => {
  ...
  const handleCode=async () => {
    let code:any;
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:Dashboard3:AFVK:v1",  componentId:"f5b36dda2fd54aba9ca30b404275fa55",controlId:"8fbcfd9ce90e4a45ab56d0eb1451a4ca",isTable:false,accessProfile:accessProfile,from:"Icon"},{
      headers: {
  ...
  if (help1a4ca?.isHidden) {
    return <></>
  }

return (
  <div 
    style={{gridColumn: `3 / 11`,gridRow: `98 / 114`, gap:``, height: `100%`, overflow: 'auto'
 }} >
    <Icon 
      className=""
      size={45}
