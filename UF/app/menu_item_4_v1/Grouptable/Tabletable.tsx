...
let defaultColumns = [
  {
    "id": "",
    "nodeid": "057db3707545401c8a1cb08c0dcd6911",
    "name": "ID",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "",
    "nodeid": "53e02463e0804209be13598c3461de70",
    "name": "Employee",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "",
    "nodeid": "5b0772ed244d41a3aa8d0a046b8704c1",
    "name": "Additional",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "",
    "nodeid": "fdcfb6e4ceb04e89bfe7da3875b63354",
    "name": "Status",
    "meta": {
      "sort": true
    },
...
const Tabletable = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref }: any)=>{
 ...
 /////////////
  ...
  const GetTableDetails = async () => {
    const orchestrationData = await AxiosService.post(
      '/UF/Orchestration',
      {
        ...
        componentId: '5a19e11c21e44cacbc28b907e3145205',
        isTable: true,
        from :"TableAdd Employee",
  ...
  const handleUpdate = (page:any, pageSize:any) =>{
    ...
    settable45205Props((pre:any)=>({...pre, selectedIds:[]}))
    let checkedData: any = selectedPaginationData
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          settable45205Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
    ...
    try {
      ...
      if (isRulePresent==false) {
        ...
        const api_paginationBody: api_paginationDto = {
          ...
          count: parseInt(pageSize),
          filterDetails: {
            ufKey:'CK:CT003:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:oprmatrix:AFK:Dashboard3:AFVK:v1:UO', 
            nodeId: '5a19e11c21e44cacbc28b907e3145205',
            elementId: '5a19e11c21e44cacbc28b907e3145205'
          },
          searchFilter: searchParams
        }
        if(encryptionFlagCont) {
      ...
      if (uf_paginationDataFilter.data.length >= 0&&Array.isArray(uf_paginationDataFilter.data)) {
        ...
        settable45205(uf_paginationDataFilter.data||[])
...
////////////////////////
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(table45205Props.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [table45205Props.filterProps])
  ...
  const handlePrimaryTable = () => {
    let findData = table45205Props?.selectedIds[table45205Props?.selectedIds?.length-1]
    if(Array.isArray(table45205) && table45205.length>0)
    {
      let data = table45205[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "",
        value: data[""],
  ...
  useEffect(() => {
    if (table45205Props?.selectedIds?.length != 0) handlePrimaryTable()
  }, [table45205Props?.selectedIds])
  ...
  return(
    <div className="col-start-1 col-end-13 gap-">
            ...
            <Table
              ...
              edgePadding={true}
              selectedIds={table45205Props?.selectedIds}  
