...
export default function LineChartsline({ encryptionFlagCompData }: any) {  
  ...
  const handleMapperDetails=async()=>{
    try{
      ...
      '/UF/Orchestration',
      {
        ...
        controlId: "fff6557e7159476a967e84778451d22d",
        isTable: false,
    ...
    setData()
    setoutside board012f9((pre:any)=>({...pre,line:[0]?.line}))
  }
    if(Array.isArray()){
      return
    }
...
useEffect(() => {
  ...
  if (line1d22d?.isHidden) {
    return <></>
  }

  return (
    <div 
  style={{gridColumn: `8 / 13`,gridRow: `345 / 499`, gap:``, height: `100%`, overflow: 'auto'}} >
