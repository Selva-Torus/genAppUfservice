...
const Groupreq_data_group = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  const {req_jsonviewer8d071, setreq_jsonviewer8d071}= useContext(TotalContext) as TotalContextProps;
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("req_jsonviewer")){
      setreq_jsonviewer8d071({...req_jsonviewer8d071,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
        ...
        codeStates['req_jsonviewer'] = req_jsonviewer8d071,
        codeStates['setreq_jsonviewer'] = setreq_jsonviewer8d071,
  ...
  return (
    ...
    >
        {allowedControls.includes("req_jsonviewer")?<JsonViewerreq_jsonviewer /* 8d071 */ encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData}  />: <div></div>}
    </div>
 )
}
