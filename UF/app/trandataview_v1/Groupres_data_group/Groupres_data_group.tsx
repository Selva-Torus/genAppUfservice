...
const Groupres_data_group = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "1ce544d17ea34d5f8d5551f99c99d75a");
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("res_jsonviewer")){
      setres_jsonviewerdd261({...res_jsonviewerdd261,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
        ...
        codeStates['res_jsonviewer'] = res_jsonviewerdd261,
        codeStates['setres_jsonviewer'] = setres_jsonviewerdd261,
  ...
  return (
    ...
    >
        {allowedControls.includes("res_jsonviewer")?<JsonViewerres_jsonviewer /* dd261 */ encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData}  />: <div></div>}
    </div>
 )
}
