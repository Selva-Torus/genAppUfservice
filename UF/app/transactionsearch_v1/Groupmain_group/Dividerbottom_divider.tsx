...
const Dividerbottom_divider = ({encryptionFlagCompData,isDynamic,item,index,setIsProcessing,controlData}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[bottom_dividerb9220?.refresh])

  if (bottom_dividerb9220?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 25`,gridRow: `71 / 77`, gap:``, height: `100%`}} >
<Divider
  className=""
...
export default Dividerbottom_divider
