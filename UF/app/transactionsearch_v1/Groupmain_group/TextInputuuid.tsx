...
const TextInputuuid = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      "sourceKey": [
        "CK:CT005:FNGK:AF:FNK:DF-DFD:CATK:GSS:AFGK:RTGS:AFK:transaction:AFVK:v1|c2a320f6a30140a487ed20c46f1763dd|properties.uuid"
      ],
      "targetKey": "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:transactionSearch:AFVK:v1|526f0e58d5454270aca67c481a99066f|145647b72a0f4d5baea6bcf29cb29c9f"
    }
  ],
  ...
  return (   
    <div  
      style={{gridColumn: `1 / 9`,gridRow: `53 / 71`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
