...
const Buttongggg = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "a1c2fd15d10944768de75695855071dc",
          isTable: false,
          from:"Button",
  ...
  },[gggg071dc?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    if(groupbffe9Props?.validation==true && groupbffe9Props?.required==true || groupbffe9Props?.required==true)
    {
 ...
 if (gggg071dc?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `3 / 5`,gridRow: `70 / 80`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='action'
          disabled= {gggg071dc?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("")}
