...
const Buttonapprove = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
  ...
  let actionLockData : any = {"lockMode":"Single","name":"","ttl":30000}
 ...
 /////////////
  ...
  async function handleSave0de7_1_1_1(){
    try{
      ...
      let tagetKey:string="CK:CT005:FNGK:AF:FNK:PF-PFD:CATK:V001:AFGK:VGPH001:AFK:CDC_Checker_Flow:AFVK:v1|43e06cf79f2948a981fb19214b4ca20a"
  ...
  "children": [
    {
      ...
      let sourceIdNewPath : string = "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:V001:AFGK:VGPH001:AFK:CDC_Checker_Action_Screen:AFVK:v1"+"|"+"2eff021532cd4b80834bce1263346bbe"+"|"+eventProperty.id;
