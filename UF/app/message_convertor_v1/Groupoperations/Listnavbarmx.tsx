...
const Listnavbarmx = ({checkToAdd,setCheckToAdd,encryptionFlagCompData}:any) => {
  ...
  //////////////
    ...
    let items=dfd_mongo_navbarv2_v1Props.map((title:any) =>( {
        "title": title?.value,
...
},[navbarmx67b58?.refresh])

if (navbarmx67b58?.isHidden) {
  return <></>;
}

return (
  <div 
    style={{gridColumn: `1 / 3`,gridRow: `107 / 173`, gap:``, height: `100%`, overflow: 'auto'}} >
    <List 
      className=""
      sortable={false}
      filterable={false}
      ...
      headerPosition='top'
      headerText="MX Message Types"
    />
  </div>
  )
}

export default Listnavbarmx
