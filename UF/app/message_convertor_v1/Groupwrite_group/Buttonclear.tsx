...
const Buttonclear = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "e59580e365994b1d867b272309fb264e",
          isTable: false,
          from:"ButtonClear",
  ...
  const handleClick=async()=>{
    ...
    // for group
    Object.keys(operations58572).map((keys:any)=>{         
      operations58572[keys]="";
    })
    setoperations58572({...operations58572});
      await delay(1000);
 ...
 if (clearb264e?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `10 / 13`,gridRow: `1 / 12`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          ...
          size='s'           
          disabled= {clearb264e?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("Clear")}
        </Button>
