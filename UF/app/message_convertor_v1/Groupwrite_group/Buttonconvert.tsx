...
const Buttonconvert = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
  ...
  let code:any = "if (\"insertedData\" in response && \"upId\" in response) {\r\n\r\n  // First key\r\n  const key1 = \"fadcafac31e240c48ae46c28e2afbb56\";\r\n\r\n  // New key you want to support\r\n  const key2 = \"c7ee672c025f48d69e18987a942a5135\";\r\n\r\n  // Detect which key exists inside insertedData\r\n  const targetValue =\r\n    response.insertedData[key1] ||\r\n    response.insertedData[key2] ||\r\n    \"\";\r\n\r\n  setoperations((prev) => ({\r\n    ...prev,\r\n    target: targetValue,\r\n   //upId: response?.upId,\r\n  }));\r\n\r\n  setwrite_group((prev) => ({\r\n    ...prev,\r\n    target: targetValue,\r\n    source:operations?.source,\r\n    //upId: response?.upId,\r\n  }));\r\n}";
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "4783034907844206b361bbd6a0f70e2d",
          isTable: false,
          from:"ButtonValidate/Convert",
  ...
  async function handleSave0e2d_1_1_1(){
    try{
      ...
      let primaryKey:any;
      let tagetKey:any="CK:CT261:FNGK:AF:FNK:PF-PFD:CATK:AG001:AFGK:A001:AFK:Validate_Flow:AFVK:v1|0ce897b54d614087b358f8b36c07608b"
      let uf_getPFDetails:any={
        key: "CK:CT261:FNGK:AF:FNK:PF-PFD:CATK:AG001:AFGK:A001:AFK:Validate_Flow:AFVK:v1|0ce897b54d614087b358f8b36c07608b"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty = {
  "id": "4783034907844206b361bbd6a0f70e2d",
  "type": "button",
  "name": "convert",
  "sequence": 1,
  "children": [
    {
      "id": "4783034907844206b361bbd6a0f70e2d.1.1",
      "type": "eventNode",
      "name": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "4783034907844206b361bbd6a0f70e2d.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "4783034907844206b361bbd6a0f70e2d.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "copyFormData",
              ...
              "children": [
                {
                  "id": "4783034907844206b361bbd6a0f70e2d.1.1.1.1.1",
                  "eventContext": "rise",
                  "value": "",
                  "type": "handlerNode",
                  "name": "infoMsg",
                  ...
                  "children": [
                    {
                      "id": "4783034907844206b361bbd6a0f70e2d.1.1.1.1.1.1",
                      ...
                      "children": [
                        {
                          "id": "54f9d158801644ad9a2051ee28c55231|868c42f23de04d5b869efdd68daf1fd7.1.1.1.1.1.1.1",
                          "value": "",
                          "type": "screen",
                    ...
                    {
                      "id": "4783034907844206b361bbd6a0f70e2d.1.1.1.1.1.2",
                      "eventContext": "riseListen",
                      "value": "",
                      "type": "handlerNode",
                      "name": "disableElement",
                      ...
                      "children": [
                        {
                          "id": "54f9d158801644ad9a2051ee28c55231|4783034907844206b361bbd6a0f70e2d.1.1.1.1.1.2.1",
                          "value": "",
                          "type": "screen",
                          "name": "VMC_Operations_v1.v1|write_group|convert",
                          "label": "write_group|Validate/Convert",
                          "key": "CK:CT261:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:VMC_Operations_v1:AFVK:v1|write_group|convert",
                          "elementType": "button",
                    ...
                    "params": [
                      {
                        ...
                        "_type": "string",
                        "selectionList": [],
                        "value": "Message conversion completed successfully",
                        "enabled": true
                      },
                      {
                        "name": "type",
          ...
          "targetKey": [
            "CK:CT261:FNGK:AF:FNK:PF-PFD:CATK:AG001:AFGK:A001:AFK:Validate_Flow:AFVK:v1|0ce897b54d614087b358f8b36c07608b"
          ]
        },
        {
          "id": "4783034907844206b361bbd6a0f70e2d.1.1.2",
          "eventContext": "riseListen",
          "value": "",
          "type": "handlerNode",
          "name": "disableElement",
          ...
          "children": [
            {
              "id": "54f9d158801644ad9a2051ee28c55231|cfc3f0a3502449c98120d1cc270b02a6.1.1.2.1",
              "type": "screen",
              "name": "VMC_Operations_v1.v1|write_group|load",
              "label": "write_group|Load",
              "key": "CK:CT261:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:VMC_Operations_v1:AFVK:v1|write_group|load",
              "elementType": "button",
              "sequence": "1.1.2.1",
              "children": []
            }
  ...
  // saveHandler
    ...
    if(te_save?.data?.insertedData){
      ...
      setwrite_group55231({...write_group55231,...temp});
    ...
    if(te_save?.data?.result){
      ...
      setwrite_group55231(temp);
      savedData.current=te_save?.data?.insertedData
    }
    if(te_save?.data?.data){
      setwrite_group55231(te_save?.data?.data);
      savedData.current=te_save?.data?.data
    }
    toast('Message conversion completed successfully', 'success');
    setwritef1fd7((prev: any) => ({ ...prev, isDisabled: false }));
    setconvert70e2d((prev: any) => ({ ...prev, isDisabled: true }));
    }
    catch(err:any)
    {
      savedData.current = {};
 ...
 if (convert70e2d?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `4 / 7`,gridRow: `1 / 12`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='action'
          size='s'           
          disabled= {convert70e2d?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("Validate/Convert")}
        </Button>
      </div>
