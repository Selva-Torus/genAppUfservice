...
const Buttonapprove = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "e38dc9a001114aa0a26f0b31623242e3",
          isTable: false,
          from:"ButtonApproved",
  ...
  },[approve242e3?.refresh,currentToken])
  ...
  async function handleSave42e3_1_1_1(){
  ...
  "id": "e38dc9a001114aa0a26f0b31623242e3",
  "type": "button",
  "name": "approve",
  "label": "approve",
  "sequence": 1,
  "children": [
    {
      "id": "e38dc9a001114aa0a26f0b31623242e3.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "e38dc9a001114aa0a26f0b31623242e3.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "e38dc9a001114aa0a26f0b31623242e3.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "e38dc9a001114aa0a26f0b31623242e3.1.1.1.1.1",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "PRN Approved Successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
  ...
  // saveHandler
    ...
    //infoMsg
    toast('PRN Approved Successfully', 'success');
    // refreshElement
    //riseListen
    // for group
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {approve242e3?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Approved")}
