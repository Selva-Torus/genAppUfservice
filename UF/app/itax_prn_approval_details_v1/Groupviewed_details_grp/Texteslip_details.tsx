...
const Texteslip_details = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[eslip_details567e2?.refresh])

  if (eslip_details567e2?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 9`,gridRow: `12 / 22`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
  color="primary"
>
      {keyset("eSlip Details")}
</Text>
  </div>
  )
}

export default Texteslip_details
