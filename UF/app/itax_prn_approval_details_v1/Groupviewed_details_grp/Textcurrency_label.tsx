...
const Textcurrency_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[currency_label786a3?.refresh])

  if (currency_label786a3?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `9 / 17`,gridRow: `46 / 56`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-2"
