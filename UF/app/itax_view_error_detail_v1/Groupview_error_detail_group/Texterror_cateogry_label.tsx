...
const Texterror_cateogry_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[error_cateogry_label0e2f6?.refresh])

  if (error_cateogry_label0e2f6?.isHidden) {
    return <></>
  }
...
<Text
  ...
  color="primary"
>
      {keyset("Error Category")}
</Text>
  </div>
  )
}

export default Texterror_cateogry_label
