...
const Buttoncancel = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "c340d9d37ded471d802151f7a3a4b018",
          isTable: false,
          from:"ButtonCancel",
  ...
  const handleClick=async()=>{
    ...
    let filterProps:any =  [];
    let filterData = await getFilterProps(filterProps,vmc_viewmsg_info0ee89);
    setvmc_error_screen_v1Props([...filterData ]);
     routes.push(getRouteScreenDetails('CK:CT261:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:VMC_Error_Screen:AFVK:v1', 'vmc_error_screen_v1'));
      await delay(1000);
 ...
 if (cancel4b018?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `8 / 10`,gridRow: `139 / 149`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          ...
          view='action'
          size='s'           
          disabled= {cancel4b018?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("Cancel")}
        </Button>
