...
const Buttoncancel = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "2ded9183bd414781a56af9f43f168e13",
          isTable: false,
          from:"ButtonCancel",
  ...
  },[cancel68e13?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    ...
    // for group
    Object.keys(checker_approval_main_groupff981).map((keys:any)=>{         
      checker_approval_main_groupff981[keys]="";
    })
    setchecker_approval_main_groupff981({...checker_approval_main_groupff981});
    setValidate({});
    setValidateRefetch({
      value:false,
      init:0
 ...
 if (cancel68e13?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `18 / 21`,gridRow: `64 / 77`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='normal'
          disabled= {cancel68e13?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Cancel")}
