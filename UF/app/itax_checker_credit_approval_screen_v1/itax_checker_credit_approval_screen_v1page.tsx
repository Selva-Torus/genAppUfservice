...
import Groupchecker_approval_main_group  from "./Groupchecker_approval_main_group/Groupchecker_approval_main_group";


export default function PageItaxCheckerCreditApprovalScreenV1() {
  ...
  const [checkchecker_approval_main_group,setCheckchecker_approval_main_group,]=useState<boolean>(false);
  ...
  async function securityCheck(): Promise<void> {
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT010:FNGK:AF:FNK:UF-UFW:CATK:I001:AFGK:ITAX:AFK:ITAX_Checker_Credit_Approval_Screen:AFVK:v1",accessProfile:[user],from:"pageItaxCheckerCreditApprovalScreenV1"},{
      headers: {
  ...
  "events": {}
        ...
        try{
          ...
          allowedGroup.map((nodes:AllowedGroupNode)=>{
            if(nodes?.groupName == 'checker_approval_main_group' && (nodes?.security== 'AA' || nodes?.security == 'ATO' || nodes?.security == 'RA'))
            {
              setCheckchecker_approval_main_group(true)
            }
          })
          }
           }catch(err:any)
    ...
    <>
     ...
     style={{
      ...
      {isProcessing && (
        ...
        {checkchecker_approval_main_group && initialLoad &&<Groupchecker_approval_main_group
