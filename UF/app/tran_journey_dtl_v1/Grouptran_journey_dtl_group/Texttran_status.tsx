...
const Texttran_status = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[tran_status9b4c1?.refresh])

  if (tran_status9b4c1?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `13 / 24`,gridRow: `25 / 35`, gap:``, height: `100%`}} >
<Text
  contentAlign={"center"}
  className=""
  variant="subheader-3"
...
export default Texttran_status
