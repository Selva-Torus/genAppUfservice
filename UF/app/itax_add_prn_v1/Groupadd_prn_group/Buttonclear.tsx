...
const Buttonclear = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "2327dc0522ad4222b021b2e31daa7662",
          isTable: false,
          from:"ButtonClear",
  ...
  },[cleara7662?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    ...
    //riseListen
    // for group
    setadd_prn_group1a4d8Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
 ...
 if (cleara7662?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `17 / 21`,gridRow: `28 / 38`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className="   !rounded"
          onClick={handleClick}
          view='normal'
          disabled= {cleara7662?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Clear")}
