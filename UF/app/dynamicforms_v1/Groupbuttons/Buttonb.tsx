...
const Buttonb = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          componentId: "5110ad7d874543e59288ef4a54360ce5",
          controlId: "462102a8ba024b5f8f285c979c26efab",
          isTable: false,
          from:"Buttonb",
  ...
  const handleClick=async()=>{
    if(buttons60ce5Props?.validation==true && buttons60ce5Props?.required==true || buttons60ce5Props?.required==true)
    {
    ...
    <div
      ...
      >
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {b6efab?.isDisabled ? true : false}
          pin='circle-circle'
          contentAlign={"center"}
        >
          {keyset("b")}
