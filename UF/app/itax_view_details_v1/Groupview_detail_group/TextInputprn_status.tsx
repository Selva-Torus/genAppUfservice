...
const TextInputprn_status = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT010:FNGK:AF:FNK:UF-UFW:CATK:I001:AFGK:ITAX:AFK:ITAX_View_Details:AFVK:v1|cf8c6e9383ea49e7be4639ad0e373f21|4f9a4686d2f643deb4c4005410c83532"
    }
  ],
  "schemaData": {
    "type": "string"
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,ITAX_View_Details_v1:{...pre?.ITAX_View_Details_v1,trs_status:undefined}}));
    if(dynamicStateandType.type=="number"){
    setview_detail_group73f21((prev: any) => ({ ...prev, trs_status: +e.target.value }));
    }
    else{
    setview_detail_group73f21((prev: any) => ({ ...prev, trs_status: e.target.value }));
    }
    ...
    let code:string=allCode;
     if (code != '') {
      ...
      codeStates['view_detail_group']  = {...view_detail_group73f21,trs_status:newInputValue},
      codeStates['setview_detail_group'] = setview_detail_group73f21,
      codeStates['prn_no_datails_table']  = {...prn_no_datails_tablefc106,trs_status:newInputValue},
  ...
  if(dfd_itax_source_tran_dfd_v1Props?.setSearchFilters && dfd_itax_source_tran_dfd_v1Props?.data)
  {
    if(Array.isArray(dfd_itax_source_tran_dfd_v1Props.data) && dfd_itax_source_tran_dfd_v1Props.data.length > 0){
      setview_detail_group73f21((pre:any)=>({...pre,trs_status:dfd_itax_source_tran_dfd_v1Props.data[0]?.trs_status}));
    }
  }
  ...
  return (   
    <div  
      ...
      <TextInput
        ...
        value={view_detail_group73f21?.trs_status||""}
        ...
        contentAlign={"left"}
      errorMessage={error}
        validationState={validate?.ITAX_View_Details_v1?.trs_status ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
