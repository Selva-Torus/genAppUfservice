...
const Textpin_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[pin_label660ea?.refresh])

  if (pin_label660ea?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `9 / 17`,gridRow: `23 / 33`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-2"
