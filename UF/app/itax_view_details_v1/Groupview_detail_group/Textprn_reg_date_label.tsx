...
const Textprn_reg_date_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[prn_reg_date_labelf0c46?.refresh])

  if (prn_reg_date_labelf0c46?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `17 / 25`,gridRow: `46 / 56`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-2"
  color="primary"
>
      {keyset("PRN Registration Date")}
</Text>
  </div>
  )
}

export default Textprn_reg_date_label
