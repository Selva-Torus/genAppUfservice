...
const RadioButtonradio1 = ({setCheckToAdd,encryptionFlagCompData}:any) => {
 ...
 /////////////
  ...
  try{
    let orchestrationBody :any = {
        ...
        controlId: "a77663d036dc464db75079c72172a158",
        isTable: false,
        from:"RadioButtonradio1",
  ...
  const options: RadioButtonOption[] = [
    {value: 'radio1' ,content:'radio1'},
    {value: 'radio12' ,content:'radio12'},
  ];
  
  const handleUpdate=(e:any)=>{
    setformdaeb3((prev: any) => ({ ...prev, radio1: e}))
  }
  ...
  if (radio12a158?.isHidden) {
    return <></>
  }

  return (
    <div 
  style={{gridColumn: `5 / 7`,gridRow: `1 / 2`,marginTop: `auto`, gap:`10px`}} >
      <div>{keyset("radio1")}</div>
      <RadioButton 
      className=""
        value={formdaeb3?.radio1||""}
        disabled= {radio12a158?.isDisabled ? true : false}
...
export default RadioButtonradio1