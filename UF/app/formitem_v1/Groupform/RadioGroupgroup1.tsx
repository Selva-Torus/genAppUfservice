...
const RadioGroupgroup1 = ({encryptionFlagCompData}:any) => {
 ...
 /////////////
  ...
  const options: RadioGroupOption[] = [
      {value: 'group1' ,content:'group1'},
      {value: 'group12' ,content:'group12'},
  ];

    useEffect(()=>{
      setformdaeb3((pre:any)=>({...pre,group1:""}));
    },[group1a5574?.refresh])

    const handleChange= async(e:any)=>{
    setformdaeb3((prev: any) => ({ ...prev, group1: e.target.value }));
      setConfirmMsg(true);
  ...
  if (group1a5574?.isHidden) {
    return <></>
  }

return (
  <div 
  style={{gridColumn: `7 / 9`,gridRow: `1 / 2`,marginTop: `auto`, gap:`10px`}} >
      ...
      <RadioGroup
      className=""
        value={formdaeb3?.group1 || ""}    
        disabled= {group1a5574?.isDisabled ? true : false}
...
export default RadioGroupgroup1