...
import Grouptable2  from "../Grouptable2/Grouptable2";
...
const GroupTabc = ({lockedData={},setLockedData,primaryTableData={}, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false}:any)=> {
 ...
 /////////////
  ...
  const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CT309:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:newTab:AFVK:v1",componentId:"92d13e6b6e7342498a81f2597ec14e24",from:"GroupTabc",accessProfile:accessProfile},{
    headers: {
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("table2")){
      settable2c0657({...table2c0657,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const tabc14e24Ref = useRef<any>(null);
  const handleClearSearch = () => {
    tabc14e24Ref.current?.setSearchParams();
    tabc14e24Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(tabc14e24) && Object.keys(tabc14e24)?.length>0)
      {
        settabc14e24({})
      }
    }else 
      prevRefreshRef.current= true
  }, [tabc14e24Props?.refresh])
  ...
  return (
    ...
    >
        {allowedComponent.includes("table2")  &&<Grouptable2  
