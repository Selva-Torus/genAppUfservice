...
import Grouprtgs_list_doc_table_grp  from "../Grouprtgs_list_doc_table_grp/Grouprtgs_list_doc_table_grp";
...
const Groupdocumnt_list = ({lockedData={},setLockedData,primaryTableData={},tableData=[],setTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagPageData, nodeData, setNodeData,paginationDetails,isFormOpen=false,setIsProcessing, groupData: groupDataProp={}, controlData: controlDataProp={}}:any)=> {
 ...
 /////////////
  ...
  let orchestrationData:any = getGroupOrchestrationData(currentGroupData, "8f5e874cddef46b992a9a7f801f03a06");
  ...
  if(orchestrationData?.data?.rule?.nodes?.length > 0){
    ...
    setdocumnt_list03a06Props((pre:any)=>({...pre,isHaveRule:true}))
  ...
  /////////////
    if(orchestrationData?.data?.readableControls.includes("rtgs_list_doc_table_grp")){
      setrtgs_list_doc_table_grp8a593({...rtgs_list_doc_table_grp8a593,isDisabled:true});
    }
  //////////////
    if (code != '') {
      let codeStates: any = {};
  ...
  const documnt_list03a06Ref = useRef<any>(null);
  const handleClearSearch = () => {
    documnt_list03a06Ref.current?.setSearchParams();
    documnt_list03a06Ref.current?.handleSearch({});
  };
  ...
  useEffect(() => {    
    ...
    if (prevRefreshRef.current) {
      if(!Array.isArray(documnt_list03a06) && Object.keys(documnt_list03a06)?.length>0)
      {
        setdocumnt_list03a06({})
      }
    }else 
      prevRefreshRef.current= true
  }, [documnt_list03a06Props?.refresh,token])
  ...
  return (
    ...
    >
        {allowedComponent.includes("rtgs_list_doc_table_grp")  &&<Grouprtgs_list_doc_table_grp  
...
export default Groupdocumnt_list
