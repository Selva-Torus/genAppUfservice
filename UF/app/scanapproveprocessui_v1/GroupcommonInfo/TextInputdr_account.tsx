...
const TextInputdr_account = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:scanApproveProcessUi:AFVK:v1|f2dd7aceaf454c72bdb1327c439f4607|2bd22037690e4c038e1c310720e27abb"
    }
  ],
  ...
  const handleChange = async(e: any) => {
    if(e.target.value=="")
    {
      ...
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,scanApproveProcessUi_v1:{...pre?.scanApproveProcessUi_v1,dr_account:undefined}}));
  ...
  const handleValidate=async (e?:any) => {
     ...
     if(dynamicStateandType.type=="number"){
        ...
        if(!validate.success){
          ...
          setValidate((pre:any)=>({...pre,scanApproveProcessUi_v1:{...pre?.scanApproveProcessUi_v1,dr_account:"invalid"}}));
        }
  ...
  return (   
    <div  
      style={{gridColumn: `1 / 7`,gridRow: `10 / 28`, gap:``, height: `100%`, overflow: 'auto', display: 'flex', flexDirection: 'column'}} >
      ...
      errorMessage={error}
        validationState={validate?.scanApproveProcessUi_v1?.dr_account ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
