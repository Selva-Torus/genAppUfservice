...
let defaultColumns:any = [
  {
    "id": "tran_id",
    "nodeid": "054e0436a14f4d77a67713a1335b50e3",
    "name": "Tran ID",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "dr_acnt_no",
    "nodeid": "0d5e10b8c276485384fd4c7305b4ba0e",
    "name": "Dr Account No",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "cr_acnt_no",
    "nodeid": "930730a21c014b18973961f227ebfce7",
    "name": "Cr Account No",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "amnt",
    "nodeid": "affa65cae2fb4331a23871a39543f6e2",
    "name": "Amount",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "cr_bank_code",
    "nodeid": "76a99d9dd1e44d49b4f77086755e3623",
    "name": "Cr Bank Code",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "created_by",
    "nodeid": "12fc626d26124835a3571d3099cd32da",
    "name": "Created By",
    "meta": {
      "sort": true
    },
  ...
  {
    "id": "created_date",
    "nodeid": "b0b8ebe1b3ca4fb7a76a5c3862ee821e",
    "name": "Created Date",
    "meta": {
      "sort": true
    },
...
const Tablertgs_list_table = ({ headerButtonsRenders=()=>{return<></>},headerPosition="",headerText="",lockedData,setLockedData,tableData, setTableData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch, setRefetch,setData,encryptionFlagCompData,paginationDetails,open, setOpen, ref, ButtonGoRuleData, setButtonGoRuleData,setIsProcessing,groupData,controlData}: any)=>{
 ...
 /////////////
  ...
  const {tran_idb50e3, settran_idb50e3}= useContext(TotalContext) as TotalContextProps  
  const {dr_acnt_no4ba0e, setdr_acnt_no4ba0e}= useContext(TotalContext) as TotalContextProps  
  const {cr_acnt_nobfce7, setcr_acnt_nobfce7}= useContext(TotalContext) as TotalContextProps  
  const {amnt3f6e2, setamnt3f6e2}= useContext(TotalContext) as TotalContextProps  
  const {cr_bank_codee3623, setcr_bank_codee3623}= useContext(TotalContext) as TotalContextProps  
  const {created_byd32da, setcreated_byd32da}= useContext(TotalContext) as TotalContextProps  
  const {created_datee821e, setcreated_datee821e}= useContext(TotalContext) as TotalContextProps  
  ...
  const GetTableDetails = async () => {
    const orchestrationData:any = getGroupOrchestrationData(
        groupData,
        "38ff05d8ffd64d0d8767f1834437b8d6",
      );
  ...
  const [SearchParams,setSearchParams] = useState<any>({})
    ...
    if (allCode != '') {
      let codeStates: any = {};
        ...
        codeStates['tran_id'] = tran_idb50e3,
        codeStates['settran_id'] = settran_idb50e3,
        codeStates['dr_acnt_no'] = dr_acnt_no4ba0e,
        codeStates['setdr_acnt_no'] = setdr_acnt_no4ba0e,
        codeStates['cr_acnt_no'] = cr_acnt_nobfce7,
        codeStates['setcr_acnt_no'] = setcr_acnt_nobfce7,
        codeStates['amnt'] = amnt3f6e2,
        codeStates['setamnt'] = setamnt3f6e2,
        codeStates['cr_bank_code'] = cr_bank_codee3623,
        codeStates['setcr_bank_code'] = setcr_bank_codee3623,
        codeStates['created_by'] = created_byd32da,
        codeStates['setcreated_by'] = setcreated_byd32da,
        codeStates['created_date'] = created_datee821e,
        codeStates['setcreated_date'] = setcreated_datee821e,
  ...
  const handleUpdate = (page:any, pageSize:any) =>{
    ...
    setrtgs_list_table7b8d6Props((pre:any)=>({...pre, selectedIds:[]}))
    let checkedData: any = selectedPaginationData
    if (checkedData.length) {
      for (let i = 0; i < checkedData.length; i++) {
        if (checkedData[i].page == page) {
          setrtgs_list_table7b8d6Props((pre:any)=>({...pre, selectedIds:checkedData[i].data}))
        }
      }
    }
  ...
  async function fetchData(page:any = 1, pageSize:any = 10, searchParams = {},dfKey:any,isRulePresent:any=false,isOnLoad = false,filterProps?:any,itsFromRefreshHandler:any=false){
    ...
    try {
          ...
          if(DFkeyAndRule?.isRulePresent==true)
          {
            api_paginationBody = {
              ...
              filterDetails: {
                ...
                nodeId: '38ff05d8ffd64d0d8767f1834437b8d6',
                elementId: '38ff05d8ffd64d0d8767f1834437b8d6'
              },
            }
          }else
          {
      ...
      // CopyFromData (Parent table): use presetValues if present, else use pagination-filtered data
        ...
        if ( rtgs_list_table7b8d6Props?.presetValues&&Object.keys(rtgs_list_table7b8d6Props?.presetValues).length > 0) {
          filtertedData = [rtgs_list_table7b8d6Props?.presetValues];
        }else {
          filtertedData = structuredClone(uf_paginationDataFilter.data)||[]
          setrtgs_list_table7b8d6(api_pagination?.data?.records||[])
        }
...
const colurIndicator = (keyValue:any=[], comingValue:any,ColourIndicatorType:any) => {
  ...
  useEffect(() => {
    if (prevRefreshRef.current) {
      UpdatedDataHandle(rtgs_list_table7b8d6Props.filterProps)
    }else 
      prevRefreshRef.current= true
  }, [rtgs_list_table7b8d6Props.filterProps])
  ...
  useEffect(() => {
    if (rtgs_list_table7b8d6Props?.clearData === true) {
      setrtgs_list_table7b8d6([]);
      setAllDataObject([]);
      setAllData([]);
      setTableData([]);
      ...
      setrtgs_list_table7b8d6Props((pre:any) => ({...pre, clearData: false, selectedIds: []}));
      setPaginationData((pre:any) => ({...pre, total: 0}));
    }
  }, [rtgs_list_table7b8d6Props?.clearData])
  useEffect(() => {
    ...
    setSelectedPaginationData([])
    setAllDataObject([])
  }, [rtgs_list_table7b8d6Props?.refresh])


  const handlePrimaryTable = () => {
    let findData = rtgs_list_table7b8d6Props?.selectedIds[rtgs_list_table7b8d6Props?.selectedIds?.length-1]
    if(Array.isArray(rtgs_list_table7b8d6) && rtgs_list_table7b8d6.length>0)
    {
      let data = rtgs_list_table7b8d6[findData]
      setPrimaryTableData({
        ...primaryTableData,
        primaryKey: "",
        value: data[""],
  ...
  useEffect(() => {
    if (rtgs_list_table7b8d6Props?.selectedIds?.length != 0) handlePrimaryTable()
    if (rtgs_list_table7b8d6Props?.selectedIds?.length == 0){
      handleOnRowClick({},rtgs_list_table7b8d6Props?.selectedIds)
    }
  }, [rtgs_list_table7b8d6Props?.selectedIds])
  ...
  const bindPreviousAndNext=(currectIndex:any,forEvent:any,setData:string,parentTrigger:any="",currectPage:any)=>{ 
    ...
    {
      currectIndex=-1
      if(rtgs_list_table7b8d6?.length==0)
      {
        eventBus.emit(parentTrigger, { message: "no data" });
        return
      }
      if(forEvent=="next"&&rtgs_list_table7b8d6?.at((+currectIndex)+1))
      {
        const newIndex = (+currectIndex)+1;
        allState[setData](rtgs_list_table7b8d6?.at(newIndex))
        eventBus.emit(parentTrigger, { index: newIndex, data: rtgs_list_table7b8d6?.at(newIndex) ,currectPage:paginationData?.page});
        return newIndex
      }
      if(forEvent=="previous"&&((+currectIndex)-1)>=0&&rtgs_list_table7b8d6?.at((+currectIndex)-1))
      {
        const newIndex = (+currectIndex)-1;
        allState[setData](rtgs_list_table7b8d6?.at(newIndex))
        eventBus.emit(parentTrigger, { index: newIndex, data: rtgs_list_table7b8d6?.at(newIndex) ,currectPage:paginationData?.page});
  ...
  if (rtgs_list_table7b8d6?.isHidden) {
    return <></>
  }
  return(
    <div className='w-full h-full'>
          <div
            ...
            id={"38ff05d8ffd64d0d8767f1834437b8d6"}  onClick={(e:any) => {
          ...
          >
            <Table
              ...
              edgePadding={true}
              selectedIds={rtgs_list_table7b8d6Props?.selectedIds}  
...
export default Tablertgs_list_table
