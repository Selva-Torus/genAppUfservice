 ...
 /////////////
  ...
  /////////////
    ...
    if(orchestrationData?.data?.readableControls.includes("dr_cust_ac_balance")){
      setdr_cust_ac_balance3be3f({...dr_cust_ac_balance3be3f,isDisabled:true});
    }
    if(orchestrationData?.data?.readableControls.includes("dr_cust_ac_sanc_lmt")){
      setdr_cust_ac_sanc_lmt955a9({...dr_cust_ac_sanc_lmt955a9,isDisabled:true});
    }
  ...
  return (
    ...
    >
        ...
        {allowedControls.includes("dr_cust_ac_balance") ?<TextInputdr_cust_ac_balance   /* 3be3f */ checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
        {allowedControls.includes("dr_cust_ac_sanc_lmt") ?<TextInputdr_cust_ac_sanc_lmt   /* 955a9 */ checkToAdd={checkToAdd} setCheckToAdd={setCheckToAdd} refetch={refetch} setRefetch={setRefetch} encryptionFlagCompData={encryptionFlagCompData} setIsProcessing={setIsProcessing} controlData={controlData} />: <div></div>}
