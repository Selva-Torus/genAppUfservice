...
const TextInputadditional_ref = ({checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing,controlData}:any) => {  
  ...
  "mapper": [
    {
      ...
      "targetKey": "CK:CT005:FNGK:AF:FNK:UF-UFW:CATK:GSS:AFGK:RTGS:AFK:scanApproveProcessUi:AFVK:v1|18c17fb7694d4c3a944cddb2c4ed2894|28554e1639da4e139f594b56061f63a3"
    }
  ],
  ...
  const handleChange = async(e: any) => {
      let validate:any;    
      setError('');
      setValidate((pre:any)=>({...pre,scanApproveProcessUi_v1:{...pre?.scanApproveProcessUi_v1,additional_reference:undefined}}));
  ...
  return (   
    <div  
      ...
      errorMessage={error}
        validationState={validate?.scanApproveProcessUi_v1?.additional_reference ? "invalid" : undefined}
      />
      </div>
    </div> 
  )
