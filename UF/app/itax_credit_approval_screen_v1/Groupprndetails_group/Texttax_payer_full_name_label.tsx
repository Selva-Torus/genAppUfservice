...
const Texttax_payer_full_name_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[tax_payer_full_name_label0ed9c?.refresh])

  if (tax_payer_full_name_label0ed9c?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 13`,gridRow: `49 / 59`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
...
export default Texttax_payer_full_name_label
