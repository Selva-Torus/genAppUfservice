...
const Texttax_payer_pin_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[tax_payer_pin_label532eb?.refresh])

  if (tax_payer_pin_label532eb?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 13`,gridRow: `37 / 47`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="subheader-3"
  color="primary"
>
      {keyset("Tax Payer Pin")}
</Text>
  </div>
  )
}

export default Texttax_payer_pin_label
