...
const Textprndetails_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[prndetails_label38a32?.refresh])

  if (prndetails_label38a32?.isHidden) {
    return <></>
  }
...
export default Textprndetails_label
