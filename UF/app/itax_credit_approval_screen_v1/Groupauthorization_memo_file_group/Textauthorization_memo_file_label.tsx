...
const Textauthorization_memo_file_label = ({encryptionFlagCompData,isDynamic,item,index}:any) => {
  ...
  useEffect(()=>{
    handleMapperValue()
  },[authorization_memo_file_label01fe5?.refresh])

  if (authorization_memo_file_label01fe5?.isHidden) {
    return <></>
  }

return (
  <div className="" style={{gridColumn: `1 / 12`,gridRow: `1 / 11`, gap:``, height: `100%`}} >
<Text
  contentAlign={"left"}
  className=""
  variant="header-1"
  color="primary"
>
      {keyset("Authorization Memo File")}
</Text>
  </div>
  )
}

export default Textauthorization_memo_file_label
