...
const Buttonreject = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
  ...
  const {credit_process_table8f5a5, setcredit_process_table8f5a5}= useContext(TotalContext) as TotalContextProps;
  const {credit_process_table8f5a5Props, setcredit_process_table8f5a5Props}= useContext(TotalContext) as TotalContextProps;
  //////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "be8d9f77dd1b4a6482b65b0b57f5bd6a",
          isTable: false,
          from:"ButtonReject",
  ...
  },[reject5bd6a?.refresh,currentToken])
  ...
  async function handleSavebd6a_1_1_1(){
    ...
    try{
      let mainData:any=structuredClone(documentviewer_group0a3fb);
      ...
      //eventEmitter
      if(documentviewer_group0a3fb?.upId === "" && (!lockedData?.data || Object.keys(lockedData?.data)?.length == 0)){
         throw 'Please give proper data';
      }
      let eventProperty :any = {
  "id": "be8d9f77dd1b4a6482b65b0b57f5bd6a",
  "type": "button",
  "name": "reject",
  "label": "reject",
  "sequence": 1,
  "children": [
    {
      "id": "be8d9f77dd1b4a6482b65b0b57f5bd6a.1.1",
      "type": "eventNode",
      "name": "onClick",
      "label": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "be8d9f77dd1b4a6482b65b0b57f5bd6a.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "eventEmitter",
          ...
          "children": [
            {
              "id": "be8d9f77dd1b4a6482b65b0b57f5bd6a.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
              ...
              "children": [
                {
                  "id": "be8d9f77dd1b4a6482b65b0b57f5bd6a.1.1.1.1.1",
                  ...
                  "children": [
                    {
                      "id": "eda9c0f4ccfa4354930fddf45338f5a5.1.1.1.1.1.1",
                      "value": "",
                      "type": "screen",
                      "name": "ITAX_KEDTB_Main_Screen_V2.v1|credit_process_table",
                      "label": "ITAX_KEDTB_Main_Screen_V2.v1|credit_process_table",
                      "key": "CK:CT010:FNGK:AF:FNK:UF-UFW:CATK:I001:AFGK:ITAX:AFK:ITAX_KEDTB_Main_Screen_V2:AFVK:v1|credit_process_table",
                      "elementType": "group",
                      "groupType": "table",
                ...
                "params": [
                  {
                    "name": "message",
                    "_type": "text",
                    "value": "Credit Application Rejected",
                    "enabled": true
                  },
                  {
                    "name": "type",
            ...
            "params": [
              {
                "name": "status",
                "_type": "text",
                "value": "Credit_Application_Rejected",
                "enabled": true
              },
              {
                "name": "needClearValue",
      ...
      sourceId+= "|"+"6b54888d3233443d80bc3f86b430a3fb";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath : string = "CK:CT010:FNGK:AF:FNK:UF-UFW:CATK:I001:AFGK:ITAX:AFK:ITAX_Credit_Approval_Screen:AFVK:v1"+"|"+"6b54888d3233443d80bc3f86b430a3fb"+"|"+eventProperty.id;
      ...
      te_eventEmitterBody = {
        ...
        upId : documentviewer_group0a3fb?.upId? [documentviewer_group0a3fb?.upId ] : lockedData.processIds,
  ...
  // saveHandler
    ...
    let reworkedObject:any=nullFilter(documentviewer_group0a3fb);
    let reworkKeys:any[]=[];
      if(typeof reworkedObject === 'object' && reworkedObject !== null) {
      Object.keys(reworkedObject).map((item: any) => {
        if (
          typeof documentviewer_group0a3fb[item] === 'object' && 
          Array.isArray(documentviewer_group0a3fb[item]) && 
          documentviewer_group0a3fb[item].length > 0 && 
          typeof documentviewer_group0a3fb[item][0] !== "string"
        ) {
          const hasUrlProperty = documentviewer_group0a3fb[item][0]?.url !== undefined;
          const hasFileProperty = documentviewer_group0a3fb[item][0]?.file !== undefined;
          const hasSelectedFlag = Object.keys(documentviewer_group0a3fb[item][0]).includes('_isSelected_');
      ...
      Object.keys(documentviewer_group0a3fb).map((item: any) => {
        if (
          typeof documentviewer_group0a3fb[item] === 'object' && 
          Array.isArray(documentviewer_group0a3fb[item]) && 
          documentviewer_group0a3fb[item].length > 0 && 
      ...
      if(reworkKeys.length)
      {
        for(let i=0;i<reworkKeys.length;i++){
          let fileBody:any = documentviewer_group0a3fb[reworkKeys[i]].map((item:any) => item?.file)
      ...
      Object.keys(reworkedObject).map((item:any)=>{
        if(typeof documentviewer_group0a3fb[item]=='object')
        {
          if( documentviewer_group0a3fb[item].length>0 &&Object.keys(documentviewer_group0a3fb[item][0]).includes('_isSelected_'))
          {
      ...
      if ("childTables" in documentviewer_group0a3fb) {
        te_saveBody.childTables = documentviewer_group0a3fb.childTables
      }  

      if (uf_getPFDetails.key != undefined) {
        let formData:any={};
        let ifoResponse:any[]=[];
        if(Array.isArray(documentviewer_group0a3fb))
        {
          formData=lockedData?.data || documentviewer_group0a3fb || {};
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"6b54888d3233443d80bc3f86b430a3fb",
              controlId:"be8d9f77dd1b4a6482b65b0b57f5bd6a"
            };
            if (encryptionFlagCont) {
    ...
    //eventEmitter
    if (documentviewer_group0a3fbProps.ssKey !== '' && documentviewer_group0a3fbProps.ssKey !== undefined) {
    te_eventEmitterBody["ssKey"] = documentviewer_group0a3fbProps.ssKey;          
    }
    ...
    //infoMsg
    toast('Credit Application Rejected', 'success');
    // refreshElement
    //riseListen
    // for group
    setcredit_process_table8f5a5Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
 ...
 if (reject5bd6a?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `17 / 21`,gridRow: `1 / 11`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='action'
          disabled= {reject5bd6a?.isDisabled ? true : false}
          pin='brick-round'
          contentAlign={"center"}
        >
          {keyset("Reject")}
