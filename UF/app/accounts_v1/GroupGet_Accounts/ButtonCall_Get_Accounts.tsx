...
const ButtonCall_Get_Accounts = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "84e30ebd0abd48698b7d8be0d4a51bce",
          isTable: false,
          from:"ButtonExecute",
  ...
  useEffect(()=>{
    ...
    eventBus.on("triggerButton", (id:any) => {
      if (id === "call_get_accounts51bce") {
        buttonRef.current?.click();
      }
    });
  },[call_get_accounts51bce?.refresh])
  ...
  async function handleSave1bce_1_1_1(){
    try{
      let mainData:any=structuredClone(get_accounts1a859);
      ...
      let primaryKey:any;
      let tagetKey:any="CK:CT242:FNGK:AF:FNK:PF-PFD:CATK:TPPTEST001:AFGK:TPPTEST002:AFK:Get_Accounts_Consent_Event_Consents_Consents:AFVK:v2|5a72f7d18c3b4432a506756ec0f839e6"
      let uf_getPFDetails:any={
        key: "CK:CT242:FNGK:AF:FNK:PF-PFD:CATK:TPPTEST001:AFGK:TPPTEST002:AFK:Get_Accounts_Consent_Event_Consents_Consents:AFVK:v2|5a72f7d18c3b4432a506756ec0f839e6"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty = {
  "id": "84e30ebd0abd48698b7d8be0d4a51bce",
  "type": "button",
  "name": "Call_Get_Accounts",
  "sequence": 1,
  "children": [
    {
      "id": "84e30ebd0abd48698b7d8be0d4a51bce.1.1",
      "type": "eventNode",
      "name": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "84e30ebd0abd48698b7d8be0d4a51bce.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "84e30ebd0abd48698b7d8be0d4a51bce.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
                ...
                "params": [
                  {
                    ...
                    "_type": "string",
                    "selectionList": [],
                    "value": "Process Executed Successfully",
                    "enabled": true
                  },
                  {
                    "name": "type",
          ...
          "targetKey": [
            "CK:CT242:FNGK:AF:FNK:PF-PFD:CATK:TPPTEST001:AFGK:TPPTEST002:AFK:Get_Accounts_Consent_Event_Consents_Consents:AFVK:v2|5a72f7d18c3b4432a506756ec0f839e6"
          ]
        }
      ]
    }
      ...
      let sourceId:string = "CK:CT242:FNGK:AF:FNK:UF-UFW:CATK:TPPTEST001:AFGK:TPPTEST002:AFK:VOB_Get_Accounts_Consents:AFVK:v1";
      sourceId+= "|"+"e63637758360439db9014a076931a859";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath="CK:CT242:FNGK:AF:FNK:UF-UFW:CATK:TPPTEST001:AFGK:TPPTEST002:AFK:VOB_Get_Accounts_Consents:AFVK:v1"+"|"+"e63637758360439db9014a076931a859"+"|"+eventProperty.id
  ...
  // saveHandler
    ...
    let reworkedObject:any=nullFilter(get_accounts1a859);
    let reworkKeys:any=[];
      Object.keys(reworkedObject).map((item:any)=>{
        if(typeof get_accounts1a859[item]=='object' && Array.isArray( get_accounts1a859[item]) &&  get_accounts1a859[item].length && typeof get_accounts1a859[item][0] !="string" ){
          if( get_accounts1a859[item].length>0 && !Object.keys(get_accounts1a859[item][0]).includes('_isSelected_'))
      ...
      if(reworkKeys.length)
      {
        for(let i=0;i<reworkKeys.length;i++){
          let fileBody:any = get_accounts1a859[reworkKeys[i]].map((item:any) => item?.file)
      ...
      Object.keys(reworkedObject).map((item:any)=>{
        if(typeof get_accounts1a859[item]=='object')
        {
          if( get_accounts1a859[item].length>0 &&Object.keys(get_accounts1a859[item][0]).includes('_isSelected_'))
          {
      ...
      if ("childTables" in get_accounts1a859) {
        te_saveBody.childTables = get_accounts1a859.childTables
      }  

      if (uf_getPFDetails.key != undefined) {
        let formData:any={};
        let ifoResponse:any=[];
        if(Array.isArray(get_accounts1a859))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"e63637758360439db9014a076931a859",
              controlId:"84e30ebd0abd48698b7d8be0d4a51bce"
            };
            if (encryptionFlagCont) {
    ...
    ///////////////////////
    toast('Process Executed Successfully', 'success');
    }
    catch(err:any)
    {
      savedData.current = {};
  ...
  const handleClick=async()=>{
    if(get_accounts1a859Props?.validation==true && get_accounts1a859Props?.required==true || get_accounts1a859Props?.required==true)
    {
 ...
 if (call_get_accounts51bce?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `4 / 10`,gridRow: `194 / 209`, gap:``, height: `100%`, overflow: 'auto'}} >
        <Button 
          ref={buttonRef}
          className="w-full !bg-[#3644ff] !text-white"
          onClick={handleClick}
          view='action'
          size='s'           
          disabled= {call_get_accounts51bce?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("Execute")}
        </Button>
...
export default ButtonCall_Get_Accounts
