...
const Buttondownload = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "c6d997d2445b418083a83c3b4b253d76",
          isTable: false,
          from:"Button",
  ...
  },[download53d76?.refresh,currentToken])
 ...
 if (download53d76?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `21 / 22`,gridRow: `2 / 7`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          ...
          onClick={handleClick}
          view='flat-info'
          disabled= {download53d76?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
