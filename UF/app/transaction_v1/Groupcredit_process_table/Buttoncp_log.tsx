...
const Buttoncp_log = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "dc79b87839964eccaff04ba94ac321e5",
          isTable: false,
          from:"ButtonLogs",
  ...
  },[cp_log321e5?.refresh,currentToken])
  ...
  return (
    <div>
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {cp_log321e5?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Logs")}
