...
const ButtonLogs_failure_queue = ({mainData,setRefetch,encryptionFlagCompData}:any) => {
    ...
    try{
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "f923ee43ee554d48a369378d6847e78b",
          isTable: false,
          from:"Buttonlogs",
 ...
 if (logs_failure_queue7e78b?.isHidden) {
    return <></>
  }
...
>
      <Button 
        ...
        onClick={handleClick}
        view='action'
        disabled= {logs_failure_queue7e78b?.isDisabled ? true : false}
        pin='brick-brick'
      >
                {keyset("logs")}
      </Button>
...
export default ButtonLogs_failure_queue
