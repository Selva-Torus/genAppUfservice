...
import PageItaxAddPrnpage2 from '@/app/itax_add_prn_v1/itax_add_prn_v1page';
...
const Buttonadd_new = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          componentId: "da620f9753734aa7b043512d117216b3",
          controlId: "9dee2acdd5b84132b3258c68f46200e9",
          isTable: false,
          from:"ButtonNew PRN",
  ...
  },[add_new200e9?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    ...
    let filterData2 = await getFilterProps(filterProps2,itax_main_tab_group216b3);
    setitax_add_prn_v1Props([...filterData2 ]);
 ...
 if (add_new200e9?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `22 / 25`,gridRow: `1 / 12`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
      <Modal 
        ...
        showOverlay = {true}
        position = {"center"}
        modalName = "itax_add_prn"
        className='w-[900px] h-[] bg-gray-50 overflow-auto'
      >
        <PageItaxAddPrnpage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          className="   !bg-[#e5003a] !rounded-xl"
          onClick={handleClick}
          view='action'
          disabled= {add_new200e9?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
          icon="MdAdd"
