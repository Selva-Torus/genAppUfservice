...
const Buttonview_all_button = ({mainData,setRefetch,encryptionFlagCompData}:any) => {
    ...
    try{
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "503aacc2d67e4fb0ae9082d8eff56968",
          isTable: false,
          from:"Buttonview",
 ...
 if (view_all_button56968?.isHidden) {
    return <></>
  }
...
>
      <Button 
        ...
        onClick={handleClick}
        view='action'
        disabled= {view_all_button56968?.isDisabled ? true : false}
        pin='brick-brick'
      >
                {keyset("view")}
      </Button>
...
export default Buttonview_all_button
