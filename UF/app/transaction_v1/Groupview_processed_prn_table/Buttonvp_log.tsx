...
import PageItaxTranJourneypage2 from '@/app/itax_tran_journey_v1/itax_tran_journey_v1page';
...
const Buttonvp_log = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
  ...
  const {itax_tran_journey_v1Props, setitax_tran_journey_v1Props}= useContext(TotalContext) as TotalContextProps;
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "6f69978b0e22420ca9fa2df11ba3f547",
          isTable: false,
          from:"ButtonLog",
  ...
  },[vp_log3f547?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    ...
    setitax_tran_journey_v1Props([...filterData2 ]);
    setShowProfileAsModalOpen2(true);
    //bindTran
    // For group or table
      settran_journey_group30215(mainData||{})
      settran_journey_group30215Props({...tran_journey_group30215Props,presetValues:mainData||{}})  
  ...
  return (
    <div>
      <Modal 
        ...
        showOverlay = {true}
        position = {"right"}
        modalName = "itax_tran_journey"
        className='w-[] h-[] bg-gray-50 overflow-auto'
      >
        <PageItaxTranJourneypage2/>
      </Modal>
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          onClick={handleClick}
          view='action'
          disabled= {vp_log3f547?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Log")}
