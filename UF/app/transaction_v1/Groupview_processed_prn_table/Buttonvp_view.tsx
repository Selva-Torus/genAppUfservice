...
const Buttonvp_view = ({ mainData,lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { mainData:any,lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "ea168ae6e8ea476e80d80d0d0e2ac3e4",
          isTable: false,
          from:"ButtonView",
  ...
  },[vp_viewac3e4?.refresh,currentToken])
    ...
    <div>
      ...
      >
        ...
        {showFlag && <Button 
          ...
          onClick={handleClick}
          view='action'
          disabled= {vp_viewac3e4?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("View")}
