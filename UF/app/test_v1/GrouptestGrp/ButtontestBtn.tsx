...
const ButtontestBtn = ({ lockedData, setLockedData, tableData, setTableData, primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { lockedData:any,setLockedData:any,tableData:any,setTableData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
  ...
  const testgrp35550Ref = useRef(testgrp35550);
  useEffect(() => {
    testgrp35550Ref.current = testgrp35550;
  }, [testgrp35550]);
  
  //group props in ref to access latest props value
  const testgrp35550PropsRef = useRef(testgrp35550Props);
  useEffect(() => {
    testgrp35550PropsRef.current = testgrp35550Props;
  }, [testgrp35550Props]);
  ...
  const handleCustomCode=async () => {
    ...
    if (code != '') {
      ...
      codeStates['testgrp35550'] = testgrp35550Props,
      codeStates['settestgrp35550'] = settestgrp35550Props,
      codeStates['testbtn'] = testbtn54460,
      codeStates['settestbtn'] = settestbtn54460,
  ...
  },[testbtn54460?.refresh,currentToken,memoryVariables])
  ...
  const handleClick=async()=>{
    try{  
      ...
      settestgrp35550((prev: any) => ({ ...prev, testbtn54460: true }));
      await handleCustomCode();
    }catch (err: any) {
      setIsProcessing(false);
      settestgrp35550((prev: any) => ({ ...prev, testbtn54460: false }));
