...
export default function PageMenuV1() {
  ...
  async function securityCheck() {
    const orchestrationData = await AxiosService.post("/UF/Orchestration",{key:"CK:CT309:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:dynamicforms:AFVK:v1",accessProfile:[user],from:"pageMenuV1"},{
      headers: {
        Authorization: `Bearer ${token}`
      }});
