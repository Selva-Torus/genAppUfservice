...
const Dropdownchannel_name = ({lockedData,setLockedData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagCompData}: any) => {
 ...
 /////////////
  ...
  useEffect(() => {
  if(payment_group1c8a5?.channel_name=="" || payment_group1c8a5?.channel_name==undefined || payment_group1c8a5?.channel_name==null ){
    setSelectedItem("");
  }
  },[payment_group1c8a5?.channel_name])
    ...
    try{
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "121e9d6b398b41e898b02366ff2d9a37",
          isTable: false,
  ...
  const handleClick=async(value?:any)=>{
    if (value.length > 0) {
      ...
      setpayment_group1c8a5((prev: any) => ({ ...prev, channel_name: value}))
         setIsRequredData(false)
    } else {
       setpayment_group1c8a5((prev: any) => ({ ...prev, channel_name: ''}))
        setIsRequredData(true)
    }
    setError('')
    setValidate((pre:any)=>({...pre,channel_name:undefined}))
  ...
  useEffect(() => {
    if(initialCount!=0)
     setpayment_group1c8a5((pre:any)=>({...pre,channel_name:""}))
    else
      setInitialCount(1)
  },[channel_named9a37?.refresh])

  if (channel_named9a37?.isHidden) {
    return <></>
  }
  ...
  return (
    <div
      ...
      <Dropdown
        ...
        static={true}
        staticProps={items}
        disabled= {channel_named9a37?.isDisabled ? true : false}
        contentAlign={"center"}
        headerPosition='top'
        headerText={
          <>
        ...
        value={payment_group1c8a5?.channel_name ?payment_group1c8a5?.channel_name: []}
...
export default Dropdownchannel_name;
