...
const ButtonSave = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "3ee248739f0f4d568798d2c4c43b6b99",
          isTable: false,
          from:"ButtonSave",
  ...
  async function handleSave6b99_1_1_1(){
    try{
      let mainData:any=structuredClone(payment_group1c8a5);
  ...
  "children": [
    {
      "id": "3ee248739f0f4d568798d2c4c43b6b99.1.1",
      "type": "eventNode",
      "name": "onClick",
      "sequence": "1.1",
      "children": [
        {
          "id": "3ee248739f0f4d568798d2c4c43b6b99.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "3ee248739f0f4d568798d2c4c43b6b99.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
          ...
          "targetKey": [
            "CK:CT005:FNGK:AF:FNK:PF-PFD:CATK:V001:AFGK:VGPH001:AFK:Payment_Initiation:AFVK:v1|1c1bde77b3d74aa5b6935ed6dabc0ff5"
          ]
        }
      ]
    }
  ...
  // saveHandler
    ...
    let reworkKeys:any=[];
      ...
      if(reworkKeys.length)
      {
        for(let i=0;i<reworkKeys.length;i++){
          let fileBody:any = payment_group1c8a5[reworkKeys[i]].map((item:any) => item?.file)
      ...
      Object.keys(reworkedObject).map((item:any)=>{
        if(typeof payment_group1c8a5[item]=='object')
        {
          if( payment_group1c8a5[item].length>0 &&Object.keys(payment_group1c8a5[item][0]).includes('_isSelected_'))
          {
      ...
      if ("childTables" in payment_group1c8a5) {
        te_saveBody.childTables = payment_group1c8a5.childTables
      }  
        ...
        if(Array.isArray(payment_group1c8a5))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"4e3a333fdb93472c97f4c7ca2461c8a5",
              controlId:"3ee248739f0f4d568798d2c4c43b6b99"
            };
            if (encryptionFlagCont) {
    ...
    catch(err:any)
    {
      ...
      if(Array.isArray(payment_group1c8a5)){
        ...
        // needClearValue
        let keys: any = {};
        payment_group1c8a5.map((item: any) => {
          keys[item] = '';
        })
        setpayment_group1c8a5(keys);
        setLockedData({...lockedData,data:{}});
      }else{
        setRefetch((pre: any) => !pre);
        // needClearValue
        let keys: any = {};
        Object.keys(payment_group1c8a5).map((item: any) => {
          keys[item] = '';
        })
        setpayment_group1c8a5(keys);
      }
  ...
  const handleClick=async()=>{
    if(payment_group1c8a5Props?.validation==true && payment_group1c8a5Props?.required==true || payment_group1c8a5Props?.required==true)
    {
 ...
 if (saveb6b99?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `21 / 23`,gridRow: `151 / 161`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          ...
          disabled= {saveb6b99?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Save")}
