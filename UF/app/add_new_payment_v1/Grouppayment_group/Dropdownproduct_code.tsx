...
const Dropdownproduct_code = ({lockedData,setLockedData,checkToAdd,setCheckToAdd,refetch,setRefetch,dropdownData,setDropdownData,encryptionFlagCompData}: any) => {
 ...
 /////////////
  ...
  useEffect(() => {
  if(payment_group1c8a5?.product_code=="" || payment_group1c8a5?.product_code==undefined || payment_group1c8a5?.product_code==null ){
    setSelectedItem("");
  }
    ...
    try{
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "f9267411c46944129296883d4a89a692",
          isTable: false,
  ...
  const handleClick=async(value?:any)=>{
    if (value.length > 0) {
      ...
      setpayment_group1c8a5((prev: any) => ({ ...prev, product_code: value}))
         setIsRequredData(false)
    } else {
       setpayment_group1c8a5((prev: any) => ({ ...prev, product_code: ''}))
  ...
  useEffect(() => {
    if(initialCount!=0)
     setpayment_group1c8a5((pre:any)=>({...pre,product_code:""}))
    else
      setInitialCount(1)
  },[product_code9a692?.refresh])

  if (product_code9a692?.isHidden) {
    return <></>
  }
  ...
  return (
    <div
      ...
      <Dropdown
        ...
        static={true}
        staticProps={items}
        disabled= {product_code9a692?.isDisabled ? true : false}
        contentAlign={"center"}
        headerPosition='top'
        headerText={
          <>
        ...
        value={payment_group1c8a5?.product_code ?payment_group1c8a5?.product_code: []}
