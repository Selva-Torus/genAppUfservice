...
const ButtonClear = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "77912e16fc0746dca38211b324cf69d6",
          isTable: false,
          from:"ButtonClear",
  ...
  },[clearf69d6?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    ...
    // for group
    Object.keys(payment_group1c8a5).map((keys:any)=>{         
      payment_group1c8a5[keys]="";
    })
    setpayment_group1c8a5({...payment_group1c8a5});
          await delay(1000);
 ...
 if (clearf69d6?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `23 / 25`,gridRow: `151 / 161`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className=""
          ...
          disabled= {clearf69d6?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Clear")}
