...
const Buttonclear = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData,setIsProcessing}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,setIsProcessing:any}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "53fe510fb7df46a3baa72ca10ad43278",
          isTable: false,
          from:"ButtonClear",
  ...
  },[clear43278?.refresh,currentToken])
  ...
  const handleClick=async()=>{
    ...
    //riseListen
    // for group
    setsearch_group9a617Props((pre:any)=>({...pre,refresh:!pre?.refresh}));
 ...
 if (clear43278?.isHidden) {
    return <></>
  }
 
  return (
    <div
      style={{gridColumn: `20 / 22`,gridRow: `30 / 40`, gap:``, height: `100%`, overflow: 'auto'}} 
      >
        {showFlag && <Button 
          ref={buttonRef}
          className="   "
          onClick={handleClick}
          view='normal'
          disabled= {clear43278?.isDisabled ? true : false}
          pin='brick-brick'
          contentAlign={"center"}
        >
          {keyset("Clear")}
