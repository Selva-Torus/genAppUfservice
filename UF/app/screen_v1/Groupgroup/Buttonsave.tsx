...
const Buttonsave = ({ lockedData,setLockedData,primaryTableData, setPrimaryTableData,checkToAdd,setCheckToAdd,refetch,setRefetch,encryptionFlagCompData}: { lockedData:any,setLockedData:any,checkToAdd:any,setCheckToAdd:any,refetch:any,setRefetch:any,primaryTableData:any,setPrimaryTableData:any,encryptionFlagCompData:any,}) => {
 ...
 /////////////
    ...
    try{     
      const orchestrationData: any = await AxiosService.post(
        '/UF/Orchestration',
        {
          ...
          controlId: "5573e7e9993d417cbe880f4cb621f20e",
          isTable: false,
          from:"Buttonsave",
  ...
  async function handleSavef20e_1_1_1(){
    try{
      let mainData:any=structuredClone(groupe162d);
      ...
      let primaryKey:any;
      let tagetKey:any="CK:TT407:FNGK:AF:FNK:PF-PFD:CATK:CGFA:AFGK:TG4CGFA:AFK:mypfcheck:AFVK:v1|9550ff79cd5b43abbea337c902095602"
      let uf_getPFDetails:any={
        key: "CK:TT407:FNGK:AF:FNK:PF-PFD:CATK:CGFA:AFGK:TG4CGFA:AFK:mypfcheck:AFVK:v1|9550ff79cd5b43abbea337c902095602"
      };
      let uf_ifo:any;
      let lockedKeysLength:number;
      let eventProperty = {
  "id": "5573e7e9993d417cbe880f4cb621f20e",
  "type": "button",
  "key": "",
  "name": "save",
  "sequence": 1,
  "children": [
    {
      "id": "5573e7e9993d417cbe880f4cb621f20e.1.1",
      "type": "eventNode",
      "name": "onClick",
      "key": "",
      "sequence": "1.1",
      "children": [
        {
          "id": "5573e7e9993d417cbe880f4cb621f20e.1.1.1",
          "eventContext": "rise",
          "value": "",
          "type": "handlerNode",
          "name": "saveHandler",
          ...
          "children": [
            {
              "id": "5573e7e9993d417cbe880f4cb621f20e.1.1.1.1",
              "eventContext": "rise",
              "value": "",
              "type": "handlerNode",
              "name": "infoMsg",
          ...
          "targetKey": [
            "CK:TT407:FNGK:AF:FNK:PF-PFD:CATK:CGFA:AFGK:TG4CGFA:AFK:mypfcheck:AFVK:v1|9550ff79cd5b43abbea337c902095602"
          ]
        }
      ]
    }
      ...
      let sourceId:string = "CK:TT407:FNGK:AF:FNK:UF-UFW:CATK:CGFA:AFGK:TG4CGFA:AFK:myUF:AFVK:v1";
      sourceId+= "|"+"606c6996414e44049eebebc39c1e162d";
      let pathIds = SourceIdFilter(eventProperty,"1.1.1");
      let sourceIdNewPath="CK:TT407:FNGK:AF:FNK:UF-UFW:CATK:CGFA:AFGK:TG4CGFA:AFK:myUF:AFVK:v1"+"|"+"606c6996414e44049eebebc39c1e162d"+"|"+eventProperty.id
  ...
  // saveHandler
    ...
    let reworkedObject:any=nullFilter(groupe162d);
      let reworkKeys:any=[];
      Object.keys(reworkedObject).map((item:any)=>{
        if(typeof groupe162d[item]=='object' && Array.isArray( groupe162d[item]) &&  groupe162d[item].length && typeof groupe162d[item][0] !="string" ){
          if( groupe162d[item].length>0 && !Object.keys(groupe162d[item][0]).includes('_isSelected_'))
      ...
      if(reworkKeys.length)
      {
        for(let i=0;i<reworkKeys.length;i++){
          let fileBody:any = groupe162d[reworkKeys[i]].map((item:any) => item?.file)
      ...
      Object.keys(reworkedObject).map((item:any)=>{
        if(typeof groupe162d[item]=='object')
        {
          if( groupe162d[item].length>0 &&Object.keys(groupe162d[item][0]).includes('_isSelected_'))
          {
      ...
      if ("childTables" in groupe162d) {
        te_saveBody.childTables = groupe162d.childTables
      }  

      if (uf_getPFDetails.key != undefined) {
        let formData:any={};
        let ifoResponse:any=[];
        if(Array.isArray(groupe162d))
        {
          ...
          for( const dataList of formData )
          {
            ...
            const uf_ifoBody:uf_ifoDto={
              formData:dataList,
              key:uf_getPFDetails.key,
              groupId:"606c6996414e44049eebebc39c1e162d",
              controlId:"5573e7e9993d417cbe880f4cb621f20e"
            };
            if (encryptionFlagCont) {
  ...
  const handleClick=async()=>{
    if(groupe162dProps?.validation==true && groupe162dProps?.required==true || groupe162dProps?.required==true)
    {
 ...
 if (save1f20e?.isHidden) {
    return <></>
  }
 
  return (
    <div 
      style={{gridColumn: `6 / 8`,gridRow: `15 / 31`, gap:``, height: `100%`, overflow: 'auto'}} >
        <TorusButton 
          ref={buttonRef}
          className="w-full "
          onClick={handleClick}
          view='action'
          size='s'           
          disabled= {save1f20e?.isDisabled ? true : false}
          pin='circle-circle'
        >
              {keyset("save")}
        </TorusButton>
