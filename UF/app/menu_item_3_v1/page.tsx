...
export default function PageMenuItem3V1() {
  ...
  const [checktestgrp2,setChecktestgrp2,]=useState<boolean>(false);
  ...
  async function securityCheck(): Promise<void> {
    const orchestrationData:any = await AxiosService.post("/UF/Orchestration",{key:"CK:CI001:FNGK:AF:FNK:UF-UFW:CATK:AG001:AFGK:A001:AFK:artifact2:AFVK:v1",accessProfile:[user],from:"pageMenuItem3V1"},{
      headers: {
  ...
  "events": {}
        ...
        try{
          ...
          allowedGroup.map((nodes:AllowedGroupNode)=>{
            if(nodes?.groupName == 'testGrp2' && (nodes?.security== 'AA' || nodes?.security == 'ATO' || nodes?.security == 'RA'))
            {
