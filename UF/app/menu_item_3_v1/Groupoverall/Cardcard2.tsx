...
useEffect(() => {
    setoverall05a6d((pre:any)=>({...pre,card2:""}));
  },[card234061?.refresh])
  ...
  if (card234061?.isHidden) {
    return <></>
  }  
  return (
    <div 
    style={{gridColumn: `3 / 5`,gridRow: `61 / 112`, gap:``, height: `100%`, overflow: 'auto'}} >
      <Card 
      style={style}
      className=""      
      size="l"
      theme="utility"
      view="filled"
      disabled= {card234061?.isDisabled ? true : false}
      onClick={handleClick}  
      >
...
{overall05a6d?.card2?overall05a6d?.card2:"0"}
      </Text>
    </div>
      </Card>
    </div>
