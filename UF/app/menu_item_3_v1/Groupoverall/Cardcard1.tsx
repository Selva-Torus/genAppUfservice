...
const Cardcard1 = ({checkToAdd,setCheckToAdd,encryptionFlagCompData}:any) => {
...
useEffect(() => {
    setoverall05a6d((pre:any)=>({...pre,card1:""}));
  },[card119379?.refresh])
  ...
  if (card119379?.isHidden) {
    return <></>
  }  
  return (
    <div 
    style={{gridColumn: `1 / 3`,gridRow: `61 / 112`, gap:``, height: `100%`, overflow: 'auto'}} >
      <Card 
      style={style}
      className=""      
      size="l"
      theme="utility"
      view="filled"
      disabled= {card119379?.isDisabled ? true : false}
      onClick={handleClick}  
      >
...
{overall05a6d?.card1?overall05a6d?.card1:"0"}
      </Text>
    </div>
      </Card>
    </div>
