...
import { ITAX_PRN_Approval_PFController } from "./ITAX_PRN_Approval_PF.controller";
...
@Module({
    imports: [TeModule],
    controllers: [ITAX_PRN_Approval_PFController],
...
export class ITAX_PRN_Approval_PFModule {}
