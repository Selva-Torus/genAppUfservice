...
@Injectable()
export class MongoDB_Most_Used_APIsService {
  ...
  private readonly ftpOutputPath: string;
    ...
    private readonly logger = new Logger(MongoDB_Most_Used_APIsService.name);

  async getMongoDB_Most_Used_APIsProcess(input:PoEvent) {  
