...
@Injectable()
export class MongoDB_TotalCallsService {
  ...
  private readonly ftpOutputPath: string;
    ...
    private readonly logger = new Logger(MongoDB_TotalCallsService.name);

  async getMongoDB_TotalCallsProcess(input:PoEvent) {  
