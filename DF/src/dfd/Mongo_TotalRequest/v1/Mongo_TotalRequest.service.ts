...
@Injectable()
export class Mongo_TotalRequestService {
  ...
  private readonly ftpOutputPath: string;
    ...
    private readonly logger = new Logger(Mongo_TotalRequestService.name);

  async getMongo_TotalRequestProcess(input:PoEvent) {  
