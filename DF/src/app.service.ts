...
export class AppService implements OnModuleInit{
  ...
  async onModuleInit() {
    ...
    const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dpbklkIjoiSGFyaXRoYSIsImNsaWVudCI6IkNUMDEwIiwidHlwZSI6ImMiLCJsb2dUeXBlIjoibW9uZ29kYiIsInNpZCI6IjNjN2ZhOTVkLTNlZmQtNGQyZC1hYzc4LThjYjdjM2QzYjA0MiIsImlhdCI6MTc3NDkzMTUzMCwiZXhwIjoxNzc0OTMyNzMwfQ.MV-rFOD3oYMoCaP1zpoxxmOlc1Yr_a0y0Zflg3RQz8s';
