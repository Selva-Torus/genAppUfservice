...
export class tob_api_process_logsService {
  ...
  async findSchema (token) {
    const data = {
      ...
      apiname:"string",
      sample:"string",
      tob_consent_requestid :"string",      tob_api_repositoryid :"string",      trs_created_date:"Date",
  ...
  async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { apiendpoint }: {apiendpoint : Date} = queryValue;
      ...
      const { sample }: {sample : Date} = queryValue;

      if(apiendpoint){ 
        query.apiendpoint = { [queryCondition['apiendpoint']]: apiendpoint };
      }
      if(requestdata){ 
      ...
      if(sample){ 
        query.sample = { [queryCondition['sample']]: sample };
      }
      const skip = (page - 1) * limit;
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.tob_api_process_logs.findMany({
        ...
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'tob_api_process_logs');
      ...
      const totalItems = await this.prismaService.tob_api_process_logs.count({
        where:Object.keys(query).length >0 ?query: undefined,
      });
    ...
    try{
      const res = await this.prismaService.tob_api_process_logs.findUnique({ 
      where: {id,},
      select: {id:true,apiendpoint:true,requestdata:true,responsedata:true,apiname:true,sample:true,tob_consent_requestid :true,tob_api_repositoryid :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    });
    return await this.decryptData(res, 'tob_api_process_logs');
  } catch (error) {
  ...
  async findAll(token : string) {
    try{
      const res = await this.prismaService.tob_api_process_logs.findMany({ 
      select: {id:true,apiendpoint:true,requestdata:true,responsedata:true,apiname:true,sample:true,          tob_consent_requestid :true,    
          tob_api_repositoryid :true,    
trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
  ...
  async findAllwithquery(token : string,whereClause : Prisma.tob_api_process_logsWhereInput) {
    try{
      whereClause = await this.encryptData(whereClause,'tob_api_process_logs','getAll')
      const res = await this.prismaService.tob_api_process_logs.findMany({ 
      where: whereClause,
      select: {id:true,apiendpoint:true,requestdata:true,responsedata:true,apiname:true,sample:true,          tob_consent_requestid :true,    
          tob_api_repositoryid :true,    
trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
  ...
  async create(createtob_api_process_logsDto: Prisma.tob_api_process_logsCreateInput,token:string) {
    try{
      const res = await this.prismaService.tob_api_process_logs.create({ 
      data: await this.encryptData(createtob_api_process_logsDto,'tob_api_process_logs','create'), 
      select:{id:true,apiendpoint:true,requestdata:true,responsedata:true,apiname:true,sample:true,tob_consent_requestid :true,tob_api_repositoryid :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    })
    return await this.decryptData(res, 'tob_api_process_logs');
  } catch (error) {
    ...
    async update(id:string,updatetob_api_process_logsDto: Prisma.tob_api_process_logsUpdateInput,token:string) {    
      try{
      const res = await this.prismaService.tob_api_process_logs.update({
      where: {id,},
      data: await this.encryptData(updatetob_api_process_logsDto,'tob_api_process_logs','update'),
      select: {id:true,apiendpoint:true,requestdata:true,responsedata:true,apiname:true,sample:true,tob_consent_requestid :true,tob_api_repositoryid :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true},
    });
    return await this.decryptData(res, 'tob_api_process_logs');
    } catch (error) {
    ...
    try{
      const res = await this.prismaService.tob_api_process_logs.delete({
      where: {id, },
      select: {id:true,apiendpoint:true,requestdata:true,responsedata:true,apiname:true,sample:true,tob_consent_requestid :true,tob_api_repositoryid :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    });
    return res;
