...
export enum tran_category_vgph_tran_error_log_main{
  Financial="Financial",
  Non_Financial="Non_Financial",
}
export enum error_cateogry_vgph_tran_error_log_main{
...
export class  Updatevgph_tran_error_log_mainDto {
        ...
        @ApiProperty({enum:tran_category_vgph_tran_error_log_main})
        @IsEnum(tran_category_vgph_tran_error_log_main)
        tran_category?: tran_category_vgph_tran_error_log_main;
        @ApiProperty()
        process_code?: string;
        @ApiProperty({enum:error_cateogry_vgph_tran_error_log_main})
        @IsEnum(error_cateogry_vgph_tran_error_log_main)
        error_cateogry?: error_cateogry_vgph_tran_error_log_main;
        @ApiProperty()
        error_code?: string;
        @ApiProperty()
        error_desc?: string;
