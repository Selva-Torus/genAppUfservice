...
export class  vgph_tran_error_log_mainEntity implements  vgph_tran_error_log_main {
    ...
    @ApiProperty({enum :tran_category_vgph_tran_error_log_main,enumName:"tran_category",type:"string"}) 
    tran_category : tran_category_vgph_tran_error_log_main;
    @ApiProperty({example:"string"})
    process_code:string;
    @ApiProperty({enum :error_cateogry_vgph_tran_error_log_main,enumName:"error_cateogry",type:"string"}) 
