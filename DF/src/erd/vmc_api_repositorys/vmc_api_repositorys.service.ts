...
@Injectable()
export class vmc_api_repositorysService {
  ...
  async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.vmc_api_repositorys.findMany({
        ...
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'vmc_api_repositorys');
      ...
      const totalItems = await this.prismaService.vmc_api_repositorys.count({
        where:Object.keys(query).length >0 ?query: undefined,
      });
  ...
  async findAll(token : string) {
    try{
      const res = await this.prismaService.vmc_api_repositorys.findMany({ 
      select: {id:true,source_msg_type:true,version:true,status:true,release_date:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
      });
      let decryptedRes: any = [];
  ...
  async findAllwithquery(token : string,whereClause : Prisma.vmc_api_repositorysWhereInput) {
    try{
      whereClause = await this.encryptData(whereClause,'vmc_api_repositorys','getAll')
      const res = await this.prismaService.vmc_api_repositorys.findMany({ 
      where: whereClause,
      select: {id:true,source_msg_type:true,version:true,status:true,release_date:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
      });
  ...
  async create(createvmc_api_repositorysDto: Prisma.vmc_api_repositorysCreateInput,token:string) {
    try{
      const res = await this.prismaService.vmc_api_repositorys.create({ 
      data: await this.encryptData(createvmc_api_repositorysDto,'vmc_api_repositorys','create'), 
      select:{id:true,source_msg_type:true,version:true,status:true,release_date:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true},
    })
    return await this.decryptData(res, 'vmc_api_repositorys');
  } catch (error) {
    ...
    async update(id:string,updatevmc_api_repositorysDto: Prisma.vmc_api_repositorysUpdateInput,token:string) {    
      try{
      const res = await this.prismaService.vmc_api_repositorys.update({
      where: {id,},
      data: await this.encryptData(updatevmc_api_repositorysDto,'vmc_api_repositorys','update'),
      select: {id:true,source_msg_type:true,version:true,status:true,release_date:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true},
    });
    return await this.decryptData(res, 'vmc_api_repositorys');
    } catch (error) {
    ...
    try{
      const res = await this.prismaService.vmc_api_repositorys.delete({
      where: {id, },
      select: {id:true,source_msg_type:true,version:true,status:true,release_date:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return res;
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.vmc_api_repositorys.findFirst({ 
