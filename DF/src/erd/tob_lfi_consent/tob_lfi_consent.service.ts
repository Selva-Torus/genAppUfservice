...
@Injectable()
export class tob_lfi_consentService {
  ...
  async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.tob_lfi_consent.findMany({
        ...
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'tob_lfi_consent');
      ...
      const totalItems = await this.prismaService.tob_lfi_consent.count({
        where:Object.keys(query).length >0 ?query: undefined,
      });
    ...
    try{
      const res = await this.prismaService.tob_lfi_consent.findUnique({ 
      where: {id,},
    ...
    return await this.decryptData(res, 'tob_lfi_consent');
  } catch (error) {
  ...
  async findAll(token : string) {
    try{
      const res = await this.prismaService.tob_lfi_consent.findMany({ 
      select: {id:true,data:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
      });
      let decryptedRes: any = [];
  ...
  async findAllwithquery(token : string,whereClause : Prisma.tob_lfi_consentWhereInput) {
    try{
      whereClause = await this.encryptData(whereClause,'tob_lfi_consent','getAll')
      const res = await this.prismaService.tob_lfi_consent.findMany({ 
      where: whereClause,
      select: {id:true,data:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
      });
  ...
  async create(createtob_lfi_consentDto: Prisma.tob_lfi_consentCreateInput,token:string) {
    try{
      const res = await this.prismaService.tob_lfi_consent.create({ 
      data: await this.encryptData(createtob_lfi_consentDto,'tob_lfi_consent','create'), 
      select:{id:true,data:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    })
    return await this.decryptData(res, 'tob_lfi_consent');
  } catch (error) {
    ...
    async update(id:string,updatetob_lfi_consentDto: Prisma.tob_lfi_consentUpdateInput,token:string) {    
      try{
      const res = await this.prismaService.tob_lfi_consent.update({
      where: {id,},
      data: await this.encryptData(updatetob_lfi_consentDto,'tob_lfi_consent','update'),
      select: {id:true,data:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true},
    });
    return await this.decryptData(res, 'tob_lfi_consent');
    } catch (error) {
    ...
    try{
      const res = await this.prismaService.tob_lfi_consent.delete({
      where: {id, },
      select: {id:true,data:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    });
    return res;
