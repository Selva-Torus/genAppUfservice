...
export class  Createvgph_destination_mainDto {
        ...
        @ApiProperty({enum:tran_category_vgph_destination_main})
        @IsEnum(tran_category_vgph_destination_main)
        tran_category: tran_category_vgph_destination_main;
        @ApiProperty()
        message_code?: string;
        @ApiProperty({enum:destination_category_vgph_destination_main})
        @IsEnum(destination_category_vgph_destination_main)
