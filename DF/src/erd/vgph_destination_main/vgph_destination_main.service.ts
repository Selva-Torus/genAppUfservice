...
@Injectable()
export class vgph_destination_mainService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphdm_id }: {vgphdm_id : number} = queryValue;
      ...
      if(vgphdm_id){ 
        query.vgphdm_id = { [queryCondition['vgphdm_id']]: vgphdm_id };
      }
      if(tenant_id){ 
      ...
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.vgph_destination_main.findMany({
          select:columns,
          where: query,          
        });
        let decryptedRes: any = [];
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'vgph_destination_main');
      ...
      const totalItems = await this.prismaService.vgph_destination_main.count({
        where: query,
      });
  ...
  async findOne(vgphdm_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_destination_main.findUnique({ 
      where: {vgphdm_id},
      select: {vgphdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,destination_category:true,destination_reference:true,destination_name:true,destination_parent_name:true,destionation_status:true,uuid:true,            vgph_destination_tran_main:{
              select:{
              vgphdtm_id:true,              tenant_id:true,              product_code:true,              direction:true,              process_type:true,              tran_category:true,              vgphdm_uuid:true,              vgphstm_uuid:true            ,
    ...
    return  await this.decryptData(res, 'vgph_destination_main');
  } catch (error) {
...
,vgphdm_id?:number) {
    try{
      ...
      if (vgphdm_id) {
        whereClause.vgphdm_id = vgphdm_id;
      }
      const res = await this.prismaService.vgph_destination_main.findMany({ 
      where: whereClause,
      select: {vgphdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,destination_category:true,destination_reference:true,destination_name:true,destination_parent_name:true,destionation_status:true,uuid:true,          vgph_destination_tran_main:{
              select:{
              vgphdtm_id:true,              tenant_id:true,              product_code:true,              direction:true,              process_type:true,              tran_category:true,              vgphdm_uuid:true,              vgphstm_uuid:true            ,
  ...
  async create(createvgph_destination_mainDto: Prisma.vgph_destination_mainCreateInput,token:string) {
    try{

      enum direction_vgph_destination_main{
        OUTBOUND="OUTBOUND",
        INBOUND="INBOUND",
      }
      enum process_type_vgph_destination_main{
        OP="OP",
        IR="IR",
        IP="IP",
        OR="OR",
      }
      enum tran_category_vgph_destination_main{
        Financial="Financial",
        Non_Financial="Non_Financial",
      }
      enum destination_category_vgph_destination_main{
        QUEUE="QUEUE",
        API="API",
        FILE="FILE",
      }
      const dataSchema:any =  v.object({
            ...
            direction :v.enum(direction_vgph_destination_main,"Invalid direction_vgph_destination_main enum")  , 
            process_type :v.enum(process_type_vgph_destination_main,"Invalid process_type_vgph_destination_main enum")  , 
            tran_category :v.enum(tran_category_vgph_destination_main,"Invalid tran_category_vgph_destination_main enum")  , 
            message_code :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
            destination_category :  v.optional(v.enum(destination_category_vgph_destination_main,"Invalid destination_category_vgph_destination_main enum")), 
        ...
        let validate : any = v.safeParse(dataSchema,createvgph_destination_mainDto);
        if (!validate.success) {
      ...
      const res = await this.prismaService.vgph_destination_main.create({ 
      data: await this.encryptData(createvgph_destination_mainDto,'vgph_destination_main','create'),
      select:{vgphdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,destination_category:true,destination_reference:true,destination_name:true,destination_parent_name:true,destionation_status:true,uuid:true,vgph_destination_tran_main:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
   ...
   */
  async createMaster(
    createvgph_destination_mainDto: Prisma.vgph_destination_mainCreateInput,
    ...
    try {
      ...
      if (role === 'CHECKER') {
        ...
        if (approvalStatus === 'APPROVED') {
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_destination_main creation approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_destination_main creation rejected',
              approval_id: approvalId,
              status: 'REJECTED'
            };
          } else {
      ...
      const encryptedData = await this.encryptData(createvgph_destination_mainDto, 'vgph_destination_main', 'create');
      ...
      if(role === 'MAKER')
      {
        ...
        const result = await this.prismaService.$queryRaw<any[]>`
          SELECT ct006_torus202610.request_change(
            p_table_name     := 'vgph_destination_main',
            p_operation_type := 'INSERT',
            p_record_id      := NULL,
            p_record_id_column := 'vgphdm_id',
        ...
        return {
          success: true,
          message: 'vgph_destination_main creation request submitted for approval',
          approval_id: approvalId,
          status: 'CREATED'
        };
      }
  ...
  async update(vgphdm_id:number, updatevgph_destination_mainDto: Prisma.vgph_destination_mainUpdateInput,token:string) {   
    try{
      ...
      const dataSchema:any =  v.object({
          ...
          direction :  v.optional(v.enum(direction_vgph_destination_main,"Invalid direction_vgph_destination_main enum")), 
          process_type :  v.optional(v.enum(process_type_vgph_destination_main,"Invalid process_type_vgph_destination_main enum")), 
          tran_category :  v.optional(v.enum(tran_category_vgph_destination_main,"Invalid tran_category_vgph_destination_main enum")), 
          message_code :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
          destination_category :  v.optional(v.enum(destination_category_vgph_destination_main,"Invalid destination_category_vgph_destination_main enum")), 
          destination_reference :  v.optional(v.pipe(v.string(),v.maxLength(32 ))), 
          destination_name :  v.optional(v.pipe(v.string(),v.maxLength(32 ))), 
      ...
      let validate : any = v.safeParse(dataSchema,updatevgph_destination_mainDto);
      if (!validate.success) {
        let errorObj: errorObj = {
          tname: 'TG',
          errGrp: 'Data',
      ...
      const res = await this.prismaService.vgph_destination_main.update({
      where: {vgphdm_id},
      data: await this.encryptData(updatevgph_destination_mainDto,'vgph_destination_main','update'),
      select: {vgphdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,destination_category:true,destination_reference:true,destination_name:true,destination_parent_name:true,destionation_status:true,uuid:true,vgph_destination_tran_main:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return await this.decryptData(res, 'vgph_destination_main');
    } catch (error) {
...
/**
  ...
  async updateMaster(
vgphdm_id:number,
    updatevgph_destination_mainDto: Prisma.vgph_destination_mainUpdateInput,
    userInfo: { role: string; username: string; remarks?: string,approvalStatus?:string },
    token:string
  ) {
    try {
      const role = userInfo.role?.toUpperCase();
      const updateMaster_id =vgphdm_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_destination_main update approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_destination_main update rejected',
              approvalId: approvalId,
              record_id: updateMaster_id,
              status: 'REJECTED'
            };
      ...
      const existingRecord = await this.prismaService.vgph_destination_main.findUnique({
        where: {vgphdm_id}
      });
      ...
      // Encrypt data if needed
      const encryptedData = await this.encryptData(updatevgph_destination_mainDto, 'vgph_destination_main', 'update');
      ...
      return {
        success: true,
        message: 'vgph_destination_main update request submitted for approval',
        approval_id: approvalId,
        record_id: updateMaster_id,
        status: 'CREATED'
      };
  ...
  async remove(vgphdm_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_destination_main.delete({
      where: {vgphdm_id },
      select: {vgphdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,destination_category:true,destination_reference:true,destination_name:true,destination_parent_name:true,destionation_status:true,uuid:true,vgph_destination_tran_main:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return res;
...
vgphdm_id:number,
    ...
    try {
      const role = userInfo.role?.toUpperCase();
      const deleteMaster_id =vgphdm_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_destination_main deletion approved and applied successfully',
            approval_id: approvalId,
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_destination_main deletion rejected',
              approval_id: approvalId,
              record_id: deleteMaster_id,
              status: 'REJECTED'
            };
      ...
      return {
        success: true,
        message: 'vgph_destination_main deletion request submitted for approval',
        approval_id: approvalId,
        record_id: deleteMaster_id,
        status: 'CREATED'
      };
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.vgph_destination_main.findFirst({ 
