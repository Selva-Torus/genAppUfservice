...
export class vgph_destination_mainService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphdm_id }: {vgphdm_id : bigint} = queryValue;
      ...
      if (Object.keys(query).length > 0) {
        ...
        this.prismaService.vgph_destination_main.findMany({
          select:columns,
          where: query,          
        }));
      ...
      this.prismaService.vgph_destination_main.count({
        where: query,
      }));
...
,vgphdm_id?:number) {
  ...
  async create(createvgph_destination_mainDto: Prisma.vgph_destination_mainCreateInput,token:string) {
    try{
      ...
      const res = await this.prismaService.withConnection(() =>
        this.prismaService.vgph_destination_main.create({
          data: encryptedData,
          select:{vgphdm_id:true,direction:true,process_type:true,tran_category:true,message_code:true,destination_category:true,destination_reference:true,destination_name:true,destination_parent_name:true,destionation_status:true,uuid:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_grp_code:true,trs_sub_org_code:true,trs_locked_by:true,trs_locked_time:true,trs_tenant_id:true,trs_app_code:true,trs_product_code:true,trs_event_process_status:true,trs_event_status:true,trs_token_id:true,trs_version:true,}          
        })
      );
  ...
  async update(vgphdm_id:number, updatevgph_destination_mainDto: Prisma.vgph_destination_mainUpdateInput,token:string) {   
    try{
      ...
      this.prismaService.vgph_destination_main.updateMany({
      where: {vgphdm_id},
      data: encryptedData
    }));
...
vgphdm_id:number,
  ...
  async remove(vgphdm_id:number,token : string) {
    ...
    await this.prismaService.withConnection(() =>
      this.prismaService.vgph_destination_main.deleteMany({
      where: {vgphdm_id}
    })); 
    // return await this.decryptData(await this.commonDecimalDatahandle(res), 'vgph_destination_main');
    let decryptedRes: any = [];
...
vgphdm_id:number,
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.withConnection(() =>
      this.prismaService.vgph_destination_main.findFirst({ 
