...
import { vgph_source_tran_stagingEntity } from './entity/vgph_source_tran_staging.entity';
import { CustomException } from 'src/customException';
@Injectable()
export class vgph_source_tran_stagingService {
  ...
  async findSchema (token) {
    const data = {
      ...
      uuid:"string",
      vgphss_uuid:"string",
      vgphss_id :"number",      prcts_id :"number",      trs_created_date:"Date",
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphsts_id }: {vgphsts_id : number} = queryValue;
      const { tenant_id }: {tenant_id : string} = queryValue;
      const { parent_vgphsts_uuid }: {parent_vgphsts_uuid : string} = queryValue;
      ...
      const { tran_date }: {tran_date :  Date} = queryValue;
      ...
      const { vgphss_uuid }: {vgphss_uuid : string} = queryValue;

      if(vgphsts_id){ 
        query.vgphsts_id = { [queryCondition['vgphsts_id']]: vgphsts_id };
      }
      if(tenant_id){ 
        query.tenant_id = { [queryCondition['tenant_id']]: tenant_id };
      }
      if(parent_vgphsts_uuid){ 
        query.parent_vgphsts_uuid = { [queryCondition['parent_vgphsts_uuid']]: parent_vgphsts_uuid };
      }
      if(product_code){ 
      ...
      if(vgphss_uuid){ 
        query.vgphss_uuid = { [queryCondition['vgphss_uuid']]: vgphss_uuid };
      }
      const skip = (page - 1) * limit;
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.vgph_source_tran_staging.findMany({
          select:columns,
          where: query,          
        });
        let decryptedRes: any = [];
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'vgph_source_tran_staging');
      ...
      const totalItems = await this.prismaService.vgph_source_tran_staging.count({
        where: query,
      });
  ...
  async findOne(vgphsts_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_source_tran_staging.findUnique({ 
      where: {vgphsts_id},
      select: {vgphsts_id:true,tenant_id:true,parent_vgphsts_uuid:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,channel_name:true,channel_reference:true,tran_date:true,tran_reference:true,tran_seq_no:true,value_date:true,settlement_date:true,dr_account:true,dr_bank_code_type:true,dr_bank_code:true,dr_name:true,dr_amount:true,dr_currency:true,cr_account:true,cr_bank_code_type:true,cr_bank_code:true,cr_name:true,cr_amount:true,cr_currency:true,remittance_info:true,product_basic:true,product_additional:true,charge_type:true,uuid:true,vgphss_uuid:true,vgphss_id :true,            vgph_destination_tran_staging:{
              select:{
              vgphdts_id:true,              tenant_id:true,              product_code:true,              direction:true,              process_type:true,              tran_category:true,              vgphds_uuid:true,              vgphsts_uuid:true            ,
          ...
          trs_sub_org_grp_code:true
            ...
            vgph_tran_dtl_staging:{
              select:{
              vgphtds_id:true,              tenant_id:true,              product_code:true,              direction:true,              process_type:true,              tran_category:true,              process_code:true,              flow_code:true,              step_code:true,              product_basic:true,              product_additional:true,              process_data:true,              vgphsts_uuid:true            ,
          trs_created_date:true,
          trs_created_by:true,
          trs_modified_date:true,
          trs_modified_by:true,
...
prcts_id :true,        trs_created_date:true,
        trs_created_by:true,
        trs_modified_date:true,
        trs_modified_by:true,
        trs_next_status:true,
    ...
    return  await this.decryptData(res, 'vgph_source_tran_staging');
  } catch (error) {
...
,vgphsts_id?:number) {
    try{
      ...
      if (vgphsts_id) {
        whereClause.vgphsts_id = vgphsts_id;
      }
      const res = await this.prismaService.vgph_source_tran_staging.findMany({ 
      where: whereClause,
      select: {vgphsts_id:true,tenant_id:true,parent_vgphsts_uuid:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,channel_name:true,channel_reference:true,tran_date:true,tran_reference:true,tran_seq_no:true,value_date:true,settlement_date:true,dr_account:true,dr_bank_code_type:true,dr_bank_code:true,dr_name:true,dr_amount:true,dr_currency:true,cr_account:true,cr_bank_code_type:true,cr_bank_code:true,cr_name:true,cr_amount:true,cr_currency:true,remittance_info:true,product_basic:true,product_additional:true,charge_type:true,uuid:true,vgphss_uuid:true,          vgphss_id :true,    
          vgph_destination_tran_staging:{
              select:{
  ...
  async create(createvgph_source_tran_stagingDto: Prisma.vgph_source_tran_stagingCreateInput,token:string) {
    try{

      enum direction_vgph_source_tran_staging{
        OUTBOUND="OUTBOUND",
        INBOUND="INBOUND",
      }
      enum process_type_vgph_source_tran_staging{
        OP="OP",
        IR="IR",
        IP="IP",
        OR="OR",
      }
      enum tran_category_vgph_source_tran_staging{
        Financial="Financial",
        Non_Financial="Non_Financial",
      }
      enum dr_bank_code_type_vgph_source_tran_staging{
        IFSC="IFSC",
        BIC="BIC",
        IBAN="IBAN",
      }
      enum cr_bank_code_type_vgph_source_tran_staging{
        IFSC="IFSC",
        BIC="BIC",
        IBAN="IBAN",
      }
      enum charge_type_vgph_source_tran_staging{
        SHA="SHA",
        OUR="OUR",
        BEN="BEN",
        SLEV="SLEV",
      ...
      const dataSchema:any =  v.object({
            ...
            parent_vgphsts_uuid :  v.optional(v.pipe(v.string(),v.maxLength(64 ))), 
            product_code :v.pipe(v.string(),v.maxLength(16 )) , 
            direction :v.enum(direction_vgph_source_tran_staging,"Invalid direction_vgph_source_tran_staging enum")  , 
            process_type :v.enum(process_type_vgph_source_tran_staging,"Invalid process_type_vgph_source_tran_staging enum")  , 
            tran_category :v.enum(tran_category_vgph_source_tran_staging,"Invalid tran_category_vgph_source_tran_staging enum")  , 
            message_code :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
            channel_name :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
            channel_reference :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
            tran_date :(v.pipe(v.string(),v.isoDate()))  , 
            tran_reference :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
            tran_seq_no :v.pipe(v.string(),v.maxLength(16 )) , 
            value_date :v.pipe(
                  v.string(),
                  v.regex(
            ...
            dr_account :  v.optional(v.pipe(v.string(),v.maxLength(32 ))), 
            dr_bank_code_type :  v.optional(v.enum(dr_bank_code_type_vgph_source_tran_staging,"Invalid dr_bank_code_type_vgph_source_tran_staging enum")), 
            dr_bank_code :  v.optional(v.pipe(v.string(),v.maxLength(32 ))), 
            dr_name :  v.optional(v.pipe(v.string(),v.maxLength(64 ))), 
            dr_amount :  v.optional(v.any()), 
            dr_currency :  v.optional(v.pipe(v.string(),v.maxLength(3 ))), 
            cr_account :  v.optional(v.pipe(v.string(),v.maxLength(32 ))), 
            cr_bank_code_type :  v.optional(v.enum(cr_bank_code_type_vgph_source_tran_staging,"Invalid cr_bank_code_type_vgph_source_tran_staging enum")), 
            cr_bank_code :  v.optional(v.pipe(v.string(),v.maxLength(32 ))), 
            cr_name :  v.optional(v.pipe(v.string(),v.maxLength(64 ))), 
            cr_amount :  v.optional(v.any()), 
            cr_currency :  v.optional(v.pipe(v.string(),v.maxLength(3 ))), 
            remittance_info :  v.optional(v.pipe(v.string(),v.maxLength(512 ))), 
            product_basic :  v.optional(v.any() ), 
            product_additional :  v.optional(v.any() ), 
            charge_type :  v.optional(v.enum(charge_type_vgph_source_tran_staging,"Invalid charge_type_vgph_source_tran_staging enum")), 
            uuid :v.pipe(v.string(),v.maxLength(64 )) , 
            vgphss_uuid :v.pipe(v.string(),v.maxLength(64 )) , 
        });
        let validate : any = v.safeParse(dataSchema,createvgph_source_tran_stagingDto);
        if (!validate.success) {
      ...
      const res = await this.prismaService.vgph_source_tran_staging.create({ 
      data: await this.encryptData(createvgph_source_tran_stagingDto,'vgph_source_tran_staging','create'),
      select:{vgphsts_id:true,tenant_id:true,parent_vgphsts_uuid:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,channel_name:true,channel_reference:true,tran_date:true,tran_reference:true,tran_seq_no:true,value_date:true,settlement_date:true,dr_account:true,dr_bank_code_type:true,dr_bank_code:true,dr_name:true,dr_amount:true,dr_currency:true,cr_account:true,cr_bank_code_type:true,cr_bank_code:true,cr_name:true,cr_amount:true,cr_currency:true,remittance_info:true,product_basic:true,product_additional:true,charge_type:true,uuid:true,vgphss_uuid:true,vgphss_id :true,vgph_destination_tran_staging:true,vgph_tran_log_staging:true,vgph_tran_dtl_staging:true,prcts_id :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
   ...
   */
  async createMaster(
    createvgph_source_tran_stagingDto: Prisma.vgph_source_tran_stagingCreateInput,
    ...
    try {
      ...
      if (role === 'CHECKER') {
        ...
        if (approvalStatus === 'APPROVED') {
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_tran_staging creation approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_tran_staging creation rejected',
              approval_id: approvalId,
              status: 'REJECTED'
            };
          } else {
      ...
      const encryptedData = await this.encryptData(createvgph_source_tran_stagingDto, 'vgph_source_tran_staging', 'create');
      ...
      if(role === 'MAKER')
      {
        ...
        const result = await this.prismaService.$queryRaw<any[]>`
          SELECT ct006_torus202610.request_change(
            p_table_name     := 'vgph_source_tran_staging',
            p_operation_type := 'INSERT',
            p_record_id      := NULL,
            p_record_id_column := 'vgphsts_id',
        ...
        return {
          success: true,
          message: 'vgph_source_tran_staging creation request submitted for approval',
          approval_id: approvalId,
          status: 'CREATED'
        };
      }
  ...
  async update(vgphsts_id:number, updatevgph_source_tran_stagingDto: Prisma.vgph_source_tran_stagingUpdateInput,token:string) {   
    try{
      ...
      const dataSchema:any =  v.object({
          ...
          direction :  v.optional(v.enum(direction_vgph_source_tran_staging,"Invalid direction_vgph_source_tran_staging enum")), 
          process_type :  v.optional(v.enum(process_type_vgph_source_tran_staging,"Invalid process_type_vgph_source_tran_staging enum")), 
          tran_category :  v.optional(v.enum(tran_category_vgph_source_tran_staging,"Invalid tran_category_vgph_source_tran_staging enum")), 
          message_code :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
          channel_name :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
          channel_reference :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
          tran_date :  v.optional((v.any())), 
          tran_reference :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
          tran_seq_no :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
          ...
          vgphss_uuid :  v.optional(v.pipe(v.string(),v.maxLength(64 ))), 
      });
      let validate : any = v.safeParse(dataSchema,updatevgph_source_tran_stagingDto);
      if (!validate.success) {
        let errorObj: errorObj = {
          tname: 'TG',
          errGrp: 'Data',
      ...
      const res = await this.prismaService.vgph_source_tran_staging.update({
      where: {vgphsts_id},
      data: await this.encryptData(updatevgph_source_tran_stagingDto,'vgph_source_tran_staging','update'),
      select: {vgphsts_id:true,tenant_id:true,parent_vgphsts_uuid:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,channel_name:true,channel_reference:true,tran_date:true,tran_reference:true,tran_seq_no:true,value_date:true,settlement_date:true,dr_account:true,dr_bank_code_type:true,dr_bank_code:true,dr_name:true,dr_amount:true,dr_currency:true,cr_account:true,cr_bank_code_type:true,cr_bank_code:true,cr_name:true,cr_amount:true,cr_currency:true,remittance_info:true,product_basic:true,product_additional:true,charge_type:true,uuid:true,vgphss_uuid:true,vgphss_id :true,vgph_destination_tran_staging:true,vgph_tran_log_staging:true,vgph_tran_dtl_staging:true,prcts_id :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return await this.decryptData(res, 'vgph_source_tran_staging');
    } catch (error) {
...
/**
  ...
  async updateMaster(
vgphsts_id:number,
    updatevgph_source_tran_stagingDto: Prisma.vgph_source_tran_stagingUpdateInput,
    userInfo: { role: string; username: string; remarks?: string,approvalStatus?:string },
    token:string
  ) {
    try {
      const role = userInfo.role?.toUpperCase();
      const updateMaster_id =vgphsts_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_source_tran_staging update approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_tran_staging update rejected',
              approvalId: approvalId,
              record_id: updateMaster_id,
              status: 'REJECTED'
            };
      ...
      const existingRecord = await this.prismaService.vgph_source_tran_staging.findUnique({
        where: {vgphsts_id}
      });
      ...
      // Encrypt data if needed
      const encryptedData = await this.encryptData(updatevgph_source_tran_stagingDto, 'vgph_source_tran_staging', 'update');
      ...
      return {
        success: true,
        message: 'vgph_source_tran_staging update request submitted for approval',
        approval_id: approvalId,
        record_id: updateMaster_id,
        status: 'CREATED'
      };
  ...
  async remove(vgphsts_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_source_tran_staging.delete({
      where: {vgphsts_id },
      select: {vgphsts_id:true,tenant_id:true,parent_vgphsts_uuid:true,product_code:true,direction:true,process_type:true,tran_category:true,message_code:true,channel_name:true,channel_reference:true,tran_date:true,tran_reference:true,tran_seq_no:true,value_date:true,settlement_date:true,dr_account:true,dr_bank_code_type:true,dr_bank_code:true,dr_name:true,dr_amount:true,dr_currency:true,cr_account:true,cr_bank_code_type:true,cr_bank_code:true,cr_name:true,cr_amount:true,cr_currency:true,remittance_info:true,product_basic:true,product_additional:true,charge_type:true,uuid:true,vgphss_uuid:true,vgphss_id :true,vgph_destination_tran_staging:true,vgph_tran_log_staging:true,vgph_tran_dtl_staging:true,prcts_id :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return res;
...
vgphsts_id:number,
    ...
    try {
      const role = userInfo.role?.toUpperCase();
      const deleteMaster_id =vgphsts_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_source_tran_staging deletion approved and applied successfully',
            approval_id: approvalId,
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_tran_staging deletion rejected',
              approval_id: approvalId,
              record_id: deleteMaster_id,
              status: 'REJECTED'
            };
      ...
      return {
        success: true,
        message: 'vgph_source_tran_staging deletion request submitted for approval',
        approval_id: approvalId,
        record_id: deleteMaster_id,
        status: 'CREATED'
      };
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.vgph_source_tran_staging.findFirst({ 
