...
export class  vgph_source_tran_stagingEntity implements  vgph_source_tran_staging {
    ...
    @ApiProperty({enum :tran_category_vgph_source_tran_staging,enumName:"tran_category",type:"string"}) 
    ...
    @ApiProperty({example:"string"})
    dr_account:string;
    @ApiProperty({enum :dr_bank_code_type_vgph_source_tran_staging,enumName:"dr_bank_code_type",type:"string"}) 
    ...
    @ApiProperty({example:"string"})
    cr_account:string;
    @ApiProperty({enum :cr_bank_code_type_vgph_source_tran_staging,enumName:"cr_bank_code_type",type:"string"}) 
    ...
    @ApiProperty({enum :charge_type_vgph_source_tran_staging,enumName:"charge_type",type:"string"}) 
