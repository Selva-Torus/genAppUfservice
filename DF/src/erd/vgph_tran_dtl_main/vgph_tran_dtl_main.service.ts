...
export class vgph_tran_dtl_mainService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphtdm_id }: {vgphtdm_id : bigint} = queryValue;
      ...
      if (Object.keys(query).length > 0) {
        ...
        this.prismaService.vgph_tran_dtl_main.findMany({
          select:columns,
          where: query,          
        }));
      ...
      this.prismaService.vgph_tran_dtl_main.count({
        where: query,
      }));
...
,vgphtdm_id?:number) {
  ...
  async create(createvgph_tran_dtl_mainDto: Prisma.vgph_tran_dtl_mainCreateInput,token:string) {
    try{
      ...
      const res = await this.prismaService.withConnection(() =>
        this.prismaService.vgph_tran_dtl_main.create({
          data: encryptedData,
          select:{vgphtdm_id:true,direction:true,process_type:true,tran_category:true,flow_code:true,step_code:true,product_basic:true,product_additional:true,process_data:true,vgphstm_uuid:true,vgphstm_id:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_grp_code:true,trs_sub_org_code:true,trs_locked_by:true,trs_locked_time:true,trs_tenant_id:true,trs_app_code:true,trs_product_code:true,trs_event_process_status:true,trs_event_status:true,trs_token_id:true,trs_version:true,trs_prev_process_code:true,trs_prev_status:true,trs_prev_process_status:true,trs_process_code:true,trs_status:true,trs_process_status:true,trs_next_process_code:true,trs_next_status:true,trs_next_process_status:true,}          
        })
      );
  ...
  async update(vgphtdm_id:number, updatevgph_tran_dtl_mainDto: Prisma.vgph_tran_dtl_mainUpdateInput,token:string) {   
    try{
      ...
      this.prismaService.vgph_tran_dtl_main.updateMany({
      where: {vgphtdm_id},
      data: encryptedData
    }));
...
vgphtdm_id:number,
  ...
  async remove(vgphtdm_id:number,token : string) {
    ...
    await this.prismaService.withConnection(() =>
      this.prismaService.vgph_tran_dtl_main.deleteMany({
      where: {vgphtdm_id}
    })); 
    // return await this.decryptData(await this.commonDecimalDatahandle(res), 'vgph_tran_dtl_main');
    let decryptedRes: any = [];
...
vgphtdm_id:number,
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.withConnection(() =>
      this.prismaService.vgph_tran_dtl_main.findFirst({ 
