...
@Injectable()
export class vgph_tran_dtl_mainService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphtdm_id }: {vgphtdm_id : number} = queryValue;
      ...
      if(vgphtdm_id){ 
        query.vgphtdm_id = { [queryCondition['vgphtdm_id']]: vgphtdm_id };
      }
      if(tenant_id){ 
      ...
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.vgph_tran_dtl_main.findMany({
          select:columns,
          where: query,          
        });
        let decryptedRes: any = [];
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'vgph_tran_dtl_main');
      ...
      const totalItems = await this.prismaService.vgph_tran_dtl_main.count({
        where: query,
      });
  ...
  async findOne(vgphtdm_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_tran_dtl_main.findUnique({ 
      where: {vgphtdm_id},
      select: {vgphtdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,process_code:true,flow_code:true,step_code:true,product_basic:true,product_additional:true,process_data:true,vgphstm_uuid:true,vgphstm_id :true,        trs_created_date:true,
        trs_created_by:true,
    ...
    return  await this.decryptData(res, 'vgph_tran_dtl_main');
  } catch (error) {
...
,vgphtdm_id?:number) {
    try{
      ...
      if (vgphtdm_id) {
        whereClause.vgphtdm_id = vgphtdm_id;
      }
      const res = await this.prismaService.vgph_tran_dtl_main.findMany({ 
      where: whereClause,
      select: {vgphtdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,process_code:true,flow_code:true,step_code:true,product_basic:true,product_additional:true,process_data:true,vgphstm_uuid:true,          vgphstm_id :true,    
  ...
  async create(createvgph_tran_dtl_mainDto: Prisma.vgph_tran_dtl_mainCreateInput,token:string) {
    try{

      enum direction_vgph_tran_dtl_main{
        OUTBOUND="OUTBOUND",
        INBOUND="INBOUND",
      }
      enum process_type_vgph_tran_dtl_main{
        OP="OP",
        IR="IR",
        IP="IP",
        OR="OR",
      }
      enum tran_category_vgph_tran_dtl_main{
        Financial="Financial",
      ...
      const dataSchema:any =  v.object({
            ...
            direction :v.enum(direction_vgph_tran_dtl_main,"Invalid direction_vgph_tran_dtl_main enum")  , 
            process_type :v.enum(process_type_vgph_tran_dtl_main,"Invalid process_type_vgph_tran_dtl_main enum")  , 
            tran_category :v.enum(tran_category_vgph_tran_dtl_main,"Invalid tran_category_vgph_tran_dtl_main enum")  , 
        ...
        let validate : any = v.safeParse(dataSchema,createvgph_tran_dtl_mainDto);
        if (!validate.success) {
      ...
      const res = await this.prismaService.vgph_tran_dtl_main.create({ 
      data: await this.encryptData(createvgph_tran_dtl_mainDto,'vgph_tran_dtl_main','create'),
      select:{vgphtdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,process_code:true,flow_code:true,step_code:true,product_basic:true,product_additional:true,process_data:true,vgphstm_uuid:true,vgphstm_id :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
   ...
   */
  async createMaster(
    createvgph_tran_dtl_mainDto: Prisma.vgph_tran_dtl_mainCreateInput,
    ...
    try {
      ...
      if (role === 'CHECKER') {
        ...
        if (approvalStatus === 'APPROVED') {
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_tran_dtl_main creation approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_tran_dtl_main creation rejected',
              approval_id: approvalId,
              status: 'REJECTED'
            };
          } else {
      ...
      const encryptedData = await this.encryptData(createvgph_tran_dtl_mainDto, 'vgph_tran_dtl_main', 'create');
      ...
      if(role === 'MAKER')
      {
        ...
        const result = await this.prismaService.$queryRaw<any[]>`
          SELECT ct006_torus202610.request_change(
            p_table_name     := 'vgph_tran_dtl_main',
            p_operation_type := 'INSERT',
            p_record_id      := NULL,
            p_record_id_column := 'vgphtdm_id',
        ...
        return {
          success: true,
          message: 'vgph_tran_dtl_main creation request submitted for approval',
          approval_id: approvalId,
          status: 'CREATED'
        };
      }
  ...
  async update(vgphtdm_id:number, updatevgph_tran_dtl_mainDto: Prisma.vgph_tran_dtl_mainUpdateInput,token:string) {   
    try{
      ...
      const dataSchema:any =  v.object({
          ...
          direction :  v.optional(v.enum(direction_vgph_tran_dtl_main,"Invalid direction_vgph_tran_dtl_main enum")), 
          process_type :  v.optional(v.enum(process_type_vgph_tran_dtl_main,"Invalid process_type_vgph_tran_dtl_main enum")), 
          tran_category :  v.optional(v.enum(tran_category_vgph_tran_dtl_main,"Invalid tran_category_vgph_tran_dtl_main enum")), 
      ...
      let validate : any = v.safeParse(dataSchema,updatevgph_tran_dtl_mainDto);
      if (!validate.success) {
        let errorObj: errorObj = {
          tname: 'TG',
          errGrp: 'Data',
      ...
      const res = await this.prismaService.vgph_tran_dtl_main.update({
      where: {vgphtdm_id},
      data: await this.encryptData(updatevgph_tran_dtl_mainDto,'vgph_tran_dtl_main','update'),
      select: {vgphtdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,process_code:true,flow_code:true,step_code:true,product_basic:true,product_additional:true,process_data:true,vgphstm_uuid:true,vgphstm_id :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return await this.decryptData(res, 'vgph_tran_dtl_main');
    } catch (error) {
...
/**
  ...
  async updateMaster(
vgphtdm_id:number,
    updatevgph_tran_dtl_mainDto: Prisma.vgph_tran_dtl_mainUpdateInput,
    userInfo: { role: string; username: string; remarks?: string,approvalStatus?:string },
    token:string
  ) {
    try {
      const role = userInfo.role?.toUpperCase();
      const updateMaster_id =vgphtdm_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_tran_dtl_main update approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_tran_dtl_main update rejected',
              approvalId: approvalId,
              record_id: updateMaster_id,
              status: 'REJECTED'
            };
      ...
      const existingRecord = await this.prismaService.vgph_tran_dtl_main.findUnique({
        where: {vgphtdm_id}
      });
      ...
      // Encrypt data if needed
      const encryptedData = await this.encryptData(updatevgph_tran_dtl_mainDto, 'vgph_tran_dtl_main', 'update');
      ...
      return {
        success: true,
        message: 'vgph_tran_dtl_main update request submitted for approval',
        approval_id: approvalId,
        record_id: updateMaster_id,
        status: 'CREATED'
      };
  ...
  async remove(vgphtdm_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_tran_dtl_main.delete({
      where: {vgphtdm_id },
      select: {vgphtdm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,process_code:true,flow_code:true,step_code:true,product_basic:true,product_additional:true,process_data:true,vgphstm_uuid:true,vgphstm_id :true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return res;
...
vgphtdm_id:number,
    ...
    try {
      const role = userInfo.role?.toUpperCase();
      const deleteMaster_id =vgphtdm_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_tran_dtl_main deletion approved and applied successfully',
            approval_id: approvalId,
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_tran_dtl_main deletion rejected',
              approval_id: approvalId,
              record_id: deleteMaster_id,
              status: 'REJECTED'
            };
      ...
      return {
        success: true,
        message: 'vgph_tran_dtl_main deletion request submitted for approval',
        approval_id: approvalId,
        record_id: deleteMaster_id,
        status: 'CREATED'
      };
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.vgph_tran_dtl_main.findFirst({ 
