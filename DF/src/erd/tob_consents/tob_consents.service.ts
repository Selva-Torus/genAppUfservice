...
@Injectable()
export class tob_consentsService {
  ...
  async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      const { isauthorized }: {isauthorized : Date} = queryValue;
      ...
      if(isauthorized){ 
        query.isauthorized = { [queryCondition['isauthorized']]: isauthorized };
      }
      const skip = (page - 1) * limit;
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.tob_consents.findMany({
        ...
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'tob_consents');
      ...
      const totalItems = await this.prismaService.tob_consents.count({
        where:Object.keys(query).length >0 ?query: undefined,
      });
    ...
    try{
      const res = await this.prismaService.tob_consents.findUnique({ 
      where: {id,},
      select: {id:true,requesturl:true,requesttimestamp:true,method:true,baseconsentid:true,resourceconsentid:true,consentgroupid:true,consenttype:true,requestdata:true,responsedata:true,isauthorized:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    });
    return await this.decryptData(res, 'tob_consents');
  } catch (error) {
  ...
  async findAll(token : string) {
    try{
      const res = await this.prismaService.tob_consents.findMany({ 
      select: {id:true,requesturl:true,requesttimestamp:true,method:true,baseconsentid:true,resourceconsentid:true,consentgroupid:true,consenttype:true,requestdata:true,responsedata:true,isauthorized:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
      });
      let decryptedRes: any = [];
  ...
  async findAllwithquery(token : string,whereClause : Prisma.tob_consentsWhereInput) {
    try{
      whereClause = await this.encryptData(whereClause,'tob_consents','getAll')
      const res = await this.prismaService.tob_consents.findMany({ 
      where: whereClause,
      select: {id:true,requesturl:true,requesttimestamp:true,method:true,baseconsentid:true,resourceconsentid:true,consentgroupid:true,consenttype:true,requestdata:true,responsedata:true,isauthorized:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
      });
  ...
  async create(createtob_consentsDto: Prisma.tob_consentsCreateInput,token:string) {
    try{
      const res = await this.prismaService.tob_consents.create({ 
      data: await this.encryptData(createtob_consentsDto,'tob_consents','create'), 
      select:{id:true,requesturl:true,requesttimestamp:true,method:true,baseconsentid:true,resourceconsentid:true,consentgroupid:true,consenttype:true,requestdata:true,responsedata:true,isauthorized:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    })
    return await this.decryptData(res, 'tob_consents');
  } catch (error) {
    ...
    async update(id:string,updatetob_consentsDto: Prisma.tob_consentsUpdateInput,token:string) {    
      try{
      const res = await this.prismaService.tob_consents.update({
      where: {id,},
      data: await this.encryptData(updatetob_consentsDto,'tob_consents','update'),
      select: {id:true,requesturl:true,requesttimestamp:true,method:true,baseconsentid:true,resourceconsentid:true,consentgroupid:true,consenttype:true,requestdata:true,responsedata:true,isauthorized:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true},
    });
    return await this.decryptData(res, 'tob_consents');
    } catch (error) {
    ...
    try{
      const res = await this.prismaService.tob_consents.delete({
      where: {id, },
      select: {id:true,requesturl:true,requesttimestamp:true,method:true,baseconsentid:true,resourceconsentid:true,consentgroupid:true,consenttype:true,requestdata:true,responsedata:true,isauthorized:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    });
    return res;
