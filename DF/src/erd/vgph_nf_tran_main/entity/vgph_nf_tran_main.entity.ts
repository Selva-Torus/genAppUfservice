...
import { vgph_nf_tran_main } from '@prisma/client';
...
export class  vgph_nf_tran_mainEntity implements vgph_nf_tran_main{
    ...
    uuid:string;
    @ApiProperty({enum :direction_vgph_nf_tran_main,enumName:"direction",type:"string"}) 
    direction : direction_vgph_nf_tran_main;
    @ApiProperty({enum :process_type_vgph_nf_tran_main,enumName:"process_type",type:"string"}) 
...
export class  vgph_nf_tran_main_OnlyParentEntity {
    @ApiProperty({example:"bigint"})
    vgphntm_id:bigint;
    @ApiPropertyOptional({example:"string"})
    @IsOptional()
