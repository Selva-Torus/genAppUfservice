...
export class tof_tppService {
  ...
  async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.tof_tpp.findMany({
        ...
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'tof_tpp');
      ...
      const totalItems = await this.prismaService.tof_tpp.count({
        where:Object.keys(query).length >0 ?query: undefined,
      });
  ...
  async findAll(token : string) {
    try{
      const res = await this.prismaService.tof_tpp.findMany({ 
      select: {id:true,tpp:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
      });
      let decryptedRes: any = [];
  ...
  async findAllwithquery(token : string,whereClause : Prisma.tof_tppWhereInput) {
    try{
      whereClause = await this.encryptData(whereClause,'tof_tpp','getAll')
      const res = await this.prismaService.tof_tpp.findMany({ 
      where: whereClause,
      select: {id:true,tpp:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
      });
  ...
  async create(createtof_tppDto: Prisma.tof_tppCreateInput,token:string) {
    try{
      const res = await this.prismaService.tof_tpp.create({ 
      data: await this.encryptData(createtof_tppDto,'tof_tpp','create'), 
      select:{id:true,tpp:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    })
    return await this.decryptData(res, 'tof_tpp');
  } catch (error) {
    ...
    async update(id:string,updatetof_tppDto: Prisma.tof_tppUpdateInput,token:string) {    
      try{
      const res = await this.prismaService.tof_tpp.update({
      where: {id,},
      data: await this.encryptData(updatetof_tppDto,'tof_tpp','update'),
      select: {id:true,tpp:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true},
    });
    return await this.decryptData(res, 'tof_tpp');
    } catch (error) {
    ...
    try{
      const res = await this.prismaService.tof_tpp.delete({
      where: {id, },
      select: {id:true,tpp:true,trs_creator_email:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    });
    return res;
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.tof_tpp.findFirst({ 
