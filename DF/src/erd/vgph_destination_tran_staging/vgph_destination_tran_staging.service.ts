...
export class vgph_destination_tran_stagingService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphdts_id }: {vgphdts_id : bigint} = queryValue;
      ...
      const { destination_content }: {destination_content : string} = queryValue;
      ...
      if(destination_content){ 
        query.destination_content = { [queryCondition['destination_content']]: destination_content };
      }
      if(trs_created_date){ 
      ...
      if (Object.keys(query).length > 0) {
        ...
        this.prismaService.vgph_destination_tran_staging.findMany({
          select:columns,
          where: query,          
        }));
      ...
      this.prismaService.vgph_destination_tran_staging.count({
        where: query,
      }));
  ...
  async findOne(vgphdts_id:number,trs_tenant_id: string,trs_app_code: string,trs_product_code: string,token : string) {
    try{
      const res = await this.prismaService.withConnection(() =>
      this.prismaService.vgph_destination_tran_staging.findMany({ 
      where: {vgphdts_id,trs_tenant_id,trs_app_code,trs_product_code},
      select: {vgphdts_id:true,direction:true,process_type:true,tran_category:true,vgphds_uuid:true,vgphsts_uuid:true,vgphsts_id:true,vgphds_id:true,destination_content:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_grp_code:true,trs_sub_org_code:true,trs_locked_by:true,trs_locked_time:true,trs_tenant_id:true,trs_app_code:true,trs_product_code:true,trs_event_process_status:true,trs_event_status:true,trs_token_id:true,trs_version:true,        }
    }));
    //return await this.decryptData(await this.commonDecimalDatahandle(res), 'vgph_destination_tran_staging');
    let decryptedRes: any = [];
    for (const indiviual of res) {
      const plain = await this.commonDecimalDatahandle(indiviual)
      const decryptedData = await this.decryptData(plain, 'vgph_destination_tran_staging');
      decryptedRes.push(decryptedData);
    }
    return decryptedRes;
  } catch (error:any) {
  ...
  async create(createvgph_destination_tran_stagingDto: Prisma.vgph_destination_tran_stagingCreateInput,token:string) {
    try{
      ...
      const dataSchema:any =  v.object({
            ...
            vgphsts_id :  v.optional(v.number()), 
            vgphds_id :  v.optional(v.number()), 
            destination_content :  v.optional(v.string()), 
      ...
      const res = await this.prismaService.withConnection(() =>
        this.prismaService.vgph_destination_tran_staging.create({
          data: encryptedData,
          select:{vgphdts_id:true,direction:true,process_type:true,tran_category:true,vgphds_uuid:true,vgphsts_uuid:true,vgphsts_id:true,vgphds_id:true,destination_content:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_grp_code:true,trs_sub_org_code:true,trs_locked_by:true,trs_locked_time:true,trs_tenant_id:true,trs_app_code:true,trs_product_code:true,trs_event_process_status:true,trs_event_status:true,trs_token_id:true,trs_version:true,}          
        })
      );
  ...
  async update(vgphdts_id:number, updatevgph_destination_tran_stagingDto: Prisma.vgph_destination_tran_stagingUpdateInput,token:string) {   
    try{
      ...
      this.prismaService.vgph_destination_tran_staging.updateMany({
      where: {vgphdts_id},
      data: encryptedData
    }));
...
vgphdts_id:number,
  ...
  async remove(vgphdts_id:number,token : string) {
    ...
    await this.prismaService.withConnection(() =>
      this.prismaService.vgph_destination_tran_staging.deleteMany({
      where: {vgphdts_id}
    })); 
    // return await this.decryptData(await this.commonDecimalDatahandle(res), 'vgph_destination_tran_staging');
    let decryptedRes: any = [];
...
vgphdts_id:number,
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.withConnection(() =>
      this.prismaService.vgph_destination_tran_staging.findFirst({ 
