import { itax_source_tran } from '@prisma/client';
import { IsEnum,IsOptional } from 'class-validator';
import { ApiProperty,ApiPropertyOptional } from '@nestjs/swagger';
import { Transform } from 'class-transformer';
import { itax_tran_log_OnlyParentEntity } from '../../itax_tran_log/entity/itax_tran_log.entity';            
import { itax_tran_error_log_OnlyParentEntity } from '../../itax_tran_error_log/entity/itax_tran_error_log.entity';            
import { itax_source_tran_doc_OnlyParentEntity } from '../../itax_source_tran_doc/entity/itax_source_tran_doc.entity';            
import { itax_source_tran_dtl_OnlyParentEntity } from '../../itax_source_tran_dtl/entity/itax_source_tran_dtl.entity';            
...
export class  itax_source_tranEntity implements itax_source_tran{
    @ApiProperty({example:"number"})
    itaxst_id:number;
    @ApiPropertyOptional({enum :tran_category_itax_source_tran,enumName:"tran_category",type:"string"}) 
    @IsOptional()
...
export class  itax_source_tran_OnlyParentEntity {
    @ApiProperty({example:"number"})
    itaxst_id:number;
    @ApiPropertyOptional({enum :tran_category_itax_source_tran,enumName:"tran_category",type:"string"}) 
    @IsOptional()
