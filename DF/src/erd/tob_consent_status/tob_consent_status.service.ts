...
@Injectable()
export class tob_consent_statusService {
  ...
  async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.tob_consent_status.findMany({
        ...
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'tob_consent_status');
      ...
      const totalItems = await this.prismaService.tob_consent_status.count({
        where:Object.keys(query).length >0 ?query: undefined,
      });
    ...
    try{
      const res = await this.prismaService.tob_consent_status.findUnique({ 
      where: {id,},
    ...
    return await this.decryptData(res, 'tob_consent_status');
  } catch (error) {
  ...
  async findAll(token : string) {
    try{
      const res = await this.prismaService.tob_consent_status.findMany({ 
      select: {id:true,lfi:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
      });
      let decryptedRes: any = [];
  ...
  async findAllwithquery(token : string,whereClause : Prisma.tob_consent_statusWhereInput) {
    try{
      whereClause = await this.encryptData(whereClause,'tob_consent_status','getAll')
      const res = await this.prismaService.tob_consent_status.findMany({ 
      where: whereClause,
      select: {id:true,lfi:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
      });
  ...
  async create(createtob_consent_statusDto: Prisma.tob_consent_statusCreateInput,token:string) {
    try{
      const res = await this.prismaService.tob_consent_status.create({ 
      data: await this.encryptData(createtob_consent_statusDto,'tob_consent_status','create'), 
      select:{id:true,lfi:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    })
    return await this.decryptData(res, 'tob_consent_status');
  } catch (error) {
    ...
    async update(id:string,updatetob_consent_statusDto: Prisma.tob_consent_statusUpdateInput,token:string) {    
      try{
      const res = await this.prismaService.tob_consent_status.update({
      where: {id,},
      data: await this.encryptData(updatetob_consent_statusDto,'tob_consent_status','update'),
      select: {id:true,lfi:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true},
    });
    return await this.decryptData(res, 'tob_consent_status');
    } catch (error) {
    ...
    try{
      const res = await this.prismaService.tob_consent_status.delete({
      where: {id, },
      select: {id:true,lfi:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true}
    });
    return res;
