...
import { vgph_source_tran_doc_main } from '@prisma/client';
...
export class  vgph_source_tran_doc_mainEntity implements vgph_source_tran_doc_main{
    @ApiProperty({example:"bigint"})
    vgphstdm_id:bigint;
    @ApiProperty({example:"string"})
    vgphstm_uuid:string;
    @ApiProperty({enum :category_vgph_source_tran_doc_main,enumName:"category",type:"string"}) 
    category : category_vgph_source_tran_doc_main;
    @ApiPropertyOptional({enum :doc_type_vgph_source_tran_doc_main,enumName:"doc_type",type:"string"}) 
    @IsOptional()
    doc_type : doc_type_vgph_source_tran_doc_main;
    @ApiPropertyOptional({enum :doc_group_vgph_source_tran_doc_main,enumName:"doc_group",type:"string"}) 
    @IsOptional()
...
export class  vgph_source_tran_doc_main_OnlyParentEntity {
    @ApiProperty({example:"bigint"})
    vgphstdm_id:bigint;
    @ApiProperty({example:"string"})
    vgphstm_uuid:string;
...
export { vgph_source_tran_doc_main };