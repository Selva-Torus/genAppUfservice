...
export class vgph_tran_log_mainService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphtlm_id }: {vgphtlm_id : bigint} = queryValue;
      ...
      const { message_data }: {message_data : string} = queryValue;
      ...
      const { result }: {result : string} = queryValue;
      ...
      const { prctm_id }: {prctm_id : number} = queryValue;
      const { prcts_id }: {prcts_id : number} = queryValue;
      const { comments }: {comments : string} = queryValue;
      const { tran_tokenid }: {tran_tokenid : string} = queryValue;
      const { tran_dtl_tokenid }: {tran_dtl_tokenid : string} = queryValue;
      ...
      if(result){ 
        query.result = { [queryCondition['result']]: result };
      }
      if(action){ 
      ...
      if(prctm_id){ 
        query.prctm_id = { [queryCondition['prctm_id']]: prctm_id };
      }
      if(prcts_id){ 
        query.prcts_id = { [queryCondition['prcts_id']]: prcts_id };
      }
      if(comments){ 
        query.comments = { [queryCondition['comments']]: comments };
      }
      if(tran_tokenid){ 
        query.tran_tokenid = { [queryCondition['tran_tokenid']]: tran_tokenid };
      }
      if(tran_dtl_tokenid){ 
        query.tran_dtl_tokenid = { [queryCondition['tran_dtl_tokenid']]: tran_dtl_tokenid };
      }
      if(vgphstm_id){ 
      ...
      if (Object.keys(query).length > 0) {
        ...
        this.prismaService.vgph_tran_log_main.findMany({
          select:columns,
          where: query,          
        }));
      ...
      this.prismaService.vgph_tran_log_main.count({
        where: query,
      }));
  ...
  async findOne(vgphtlm_id:number,trs_tenant_id: string,trs_app_code: string,trs_product_code: string,token : string) {
    try{
      const res = await this.prismaService.withConnection(() =>
      this.prismaService.vgph_tran_log_main.findMany({ 
      where: {vgphtlm_id,trs_tenant_id,trs_app_code,trs_product_code},
      select: {vgphtlm_id:true,direction:true,process_type:true,tran_category:true,process_category:true,processing_system:true,message_code:true,flow_code:true,step_code:true,task_start_time:true,task_end_time:true,source_data:true,request_data:true,response_data:true,message_data:true,process_start_time:true,process_end_time:true,retry_flag:true,retry_count:true,manual_context:true,action_context:true,result:true,action:true,version:true,vgphstm_uuid:true,vgphsts_uuid:true,vgphntm_uuid:true,prctm_id:true,prcts_id:true,comments:true,tran_tokenid:true,tran_dtl_tokenid:true,vgphstm_id:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_grp_code:true,trs_sub_org_code:true,trs_locked_by:true,trs_locked_time:true,trs_tenant_id:true,trs_app_code:true,trs_product_code:true,trs_event_process_status:true,trs_event_status:true,trs_token_id:true,trs_version:true,trs_prev_process_code:true,trs_prev_status:true,trs_prev_process_status:true,trs_process_code:true,trs_status:true,trs_process_status:true,trs_next_process_code:true,trs_next_status:true,trs_next_process_status:true,        }
    }));
    //return await this.decryptData(await this.commonDecimalDatahandle(res), 'vgph_tran_log_main');
    let decryptedRes: any = [];
    for (const indiviual of res) {
      const plain = await this.commonDecimalDatahandle(indiviual)
      const decryptedData = await this.decryptData(plain, 'vgph_tran_log_main');
      decryptedRes.push(decryptedData);
    }
    return decryptedRes;
  } catch (error:any) {
...
,vgphtlm_id?:number) {
  ...
  async create(createvgph_tran_log_mainDto: Prisma.vgph_tran_log_mainCreateInput,token:string) {
    try{
      ...
      const dataSchema:any =  v.object({
            ...
            flow_code :  v.optional(v.pipe(v.string(),v.maxLength(128 ))), 
            step_code :  v.optional(v.pipe(v.string(),v.maxLength(128 ))), 
            ...
            message_data :  v.optional(v.string()), 
            ...
            result :  v.optional(v.pipe(v.string(),v.maxLength(32 ))), 
            ...
            prctm_id :  v.optional(v.number()), 
            prcts_id :  v.optional(v.number()), 
            comments :  v.optional(v.pipe(v.string(),v.maxLength(256 ))), 
            tran_tokenid :  v.optional(v.pipe(v.string(),v.maxLength(128 ))), 
            tran_dtl_tokenid :  v.optional(v.pipe(v.string(),v.maxLength(128 ))), 
      ...
      const res = await this.prismaService.withConnection(() =>
        this.prismaService.vgph_tran_log_main.create({
          data: encryptedData,
          select:{vgphtlm_id:true,direction:true,process_type:true,tran_category:true,process_category:true,processing_system:true,message_code:true,flow_code:true,step_code:true,task_start_time:true,task_end_time:true,source_data:true,request_data:true,response_data:true,message_data:true,process_start_time:true,process_end_time:true,retry_flag:true,retry_count:true,manual_context:true,action_context:true,result:true,action:true,version:true,vgphstm_uuid:true,vgphsts_uuid:true,vgphntm_uuid:true,prctm_id:true,prcts_id:true,comments:true,tran_tokenid:true,tran_dtl_tokenid:true,vgphstm_id:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_grp_code:true,trs_sub_org_code:true,trs_locked_by:true,trs_locked_time:true,trs_tenant_id:true,trs_app_code:true,trs_product_code:true,trs_event_process_status:true,trs_event_status:true,trs_token_id:true,trs_version:true,trs_prev_process_code:true,trs_prev_status:true,trs_prev_process_status:true,trs_process_code:true,trs_status:true,trs_process_status:true,trs_next_process_code:true,trs_next_status:true,trs_next_process_status:true,}          
        })
      );
  ...
  async update(vgphtlm_id:number, updatevgph_tran_log_mainDto: Prisma.vgph_tran_log_mainUpdateInput,token:string) {   
    try{
      ...
      this.prismaService.vgph_tran_log_main.updateMany({
      where: {vgphtlm_id},
      data: encryptedData
    }));
...
vgphtlm_id:number,
  ...
  async remove(vgphtlm_id:number,token : string) {
    ...
    await this.prismaService.withConnection(() =>
      this.prismaService.vgph_tran_log_main.deleteMany({
      where: {vgphtlm_id}
    })); 
    // return await this.decryptData(await this.commonDecimalDatahandle(res), 'vgph_tran_log_main');
    let decryptedRes: any = [];
...
vgphtlm_id:number,
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.withConnection(() =>
      this.prismaService.vgph_tran_log_main.findFirst({ 
