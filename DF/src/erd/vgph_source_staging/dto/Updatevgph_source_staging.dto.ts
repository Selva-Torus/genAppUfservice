...
export class  Updatevgph_source_stagingDto {
        @ApiPropertyOptional({
            type: `integer`,
            format: `int32`,
        })
        @IsOptional()
        vgphss_id?: number;
        @ApiPropertyOptional({enum:direction_vgph_source_staging})
        @IsEnum(direction_vgph_source_staging)
        @IsOptional()
        direction?: direction_vgph_source_staging;
        @ApiPropertyOptional({enum:process_type_vgph_source_staging})
