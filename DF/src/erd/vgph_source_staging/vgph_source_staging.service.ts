...
import { vgph_source_stagingEntity } from './entity/vgph_source_staging.entity';
import { CustomException } from 'src/customException';
@Injectable()
export class vgph_source_stagingService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphss_id }: {vgphss_id : number} = queryValue;
      ...
      const { total_count }: {total_count : number} = queryValue;
      const { total_amount }: {total_amount : any } = queryValue;
      const { currency }: {currency : string} = queryValue;
      const { uuid }: {uuid : string} = queryValue;

      if(vgphss_id){ 
        query.vgphss_id = { [queryCondition['vgphss_id']]: vgphss_id };
      }
      if(tenant_id){ 
      ...
      if(total_count){ 
        query.total_count = { [queryCondition['total_count']]: total_count };
      }
      if(total_amount){ 
      ...
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.vgph_source_staging.findMany({
          select:columns,
          where: query,          
        });
        let decryptedRes: any = [];
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'vgph_source_staging');
      ...
      const totalItems = await this.prismaService.vgph_source_staging.count({
        where: query,
      });
  ...
  async findOne(vgphss_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_source_staging.findUnique({ 
      where: {vgphss_id},
      select: {vgphss_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,            vgph_source_tran_staging:{
              select:{
              vgphsts_id:true,              tenant_id:true,              parent_vgphsts_uuid:true,              product_code:true,              direction:true,              process_type:true,              tran_category:true,              message_code:true,              channel_name:true,              channel_reference:true,              tran_date:true,              tran_reference:true,              tran_seq_no:true,              value_date:true,              settlement_date:true,              dr_account:true,              dr_bank_code_type:true,              dr_bank_code:true,              dr_name:true,              dr_amount:true,              dr_currency:true,              cr_account:true,              cr_bank_code_type:true,              cr_bank_code:true,              cr_name:true,              cr_amount:true,              cr_currency:true,              remittance_info:true,              product_basic:true,              product_additional:true,              charge_type:true,              uuid:true,              vgphss_uuid:true            ,
    ...
    return  await this.decryptData(res, 'vgph_source_staging');
  } catch (error) {
...
,vgphss_id?:number) {
    try{
      ...
      if (vgphss_id) {
        whereClause.vgphss_id = vgphss_id;
      }
      const res = await this.prismaService.vgph_source_staging.findMany({ 
      where: whereClause,
      select: {vgphss_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,          vgph_source_tran_staging:{
              select:{
              vgphsts_id:true,              tenant_id:true,              parent_vgphsts_uuid:true,              product_code:true,              direction:true,              process_type:true,              tran_category:true,              message_code:true,              channel_name:true,              channel_reference:true,              tran_date:true,              tran_reference:true,              tran_seq_no:true,              value_date:true,              settlement_date:true,              dr_account:true,              dr_bank_code_type:true,              dr_bank_code:true,              dr_name:true,              dr_amount:true,              dr_currency:true,              cr_account:true,              cr_bank_code_type:true,              cr_bank_code:true,              cr_name:true,              cr_amount:true,              cr_currency:true,              remittance_info:true,              product_basic:true,              product_additional:true,              charge_type:true,              uuid:true,              vgphss_uuid:true            ,
  ...
  async create(createvgph_source_stagingDto: Prisma.vgph_source_stagingCreateInput,token:string) {
    try{

      enum direction_vgph_source_staging{
        OUTBOUND="OUTBOUND",
        INBOUND="INBOUND",
      }
      enum process_type_vgph_source_staging{
        OP="OP",
        IR="IR",
        IP="IP",
        OR="OR",
      }
      enum tran_category_vgph_source_staging{
        Financial="Financial",
        Non_Financial="Non_Financial",
      }
      enum source_category_vgph_source_staging{
        API="API",
        FILE="FILE",
      }
      const dataSchema:any =  v.object({
            ...
            direction :v.enum(direction_vgph_source_staging,"Invalid direction_vgph_source_staging enum")  , 
            process_type :v.enum(process_type_vgph_source_staging,"Invalid process_type_vgph_source_staging enum")  , 
            tran_category :v.enum(tran_category_vgph_source_staging,"Invalid tran_category_vgph_source_staging enum")  , 
            source_category :  v.optional(v.enum(source_category_vgph_source_staging,"Invalid source_category_vgph_source_staging enum")), 
            ...
            total_count :  v.optional(v.pipe(v.number(),v.maxValue(999999999 ))), 
            total_amount :  v.optional(v.any()), 
            currency :  v.optional(v.pipe(v.string(),v.maxLength(3 ))), 
            uuid :v.pipe(v.string(),v.maxLength(64 )) , 
        });
        let validate : any = v.safeParse(dataSchema,createvgph_source_stagingDto);
        if (!validate.success) {
      ...
      const res = await this.prismaService.vgph_source_staging.create({ 
      data: await this.encryptData(createvgph_source_stagingDto,'vgph_source_staging','create'),
      select:{vgphss_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,vgph_source_tran_staging:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
   ...
   */
  async createMaster(
    createvgph_source_stagingDto: Prisma.vgph_source_stagingCreateInput,
    ...
    try {
      ...
      if (role === 'CHECKER') {
        ...
        if (approvalStatus === 'APPROVED') {
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_staging creation approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_staging creation rejected',
              approval_id: approvalId,
              status: 'REJECTED'
            };
          } else {
      ...
      const encryptedData = await this.encryptData(createvgph_source_stagingDto, 'vgph_source_staging', 'create');
      ...
      if(role === 'MAKER')
      {
        ...
        const result = await this.prismaService.$queryRaw<any[]>`
          SELECT ct006_torus202610.request_change(
            p_table_name     := 'vgph_source_staging',
            p_operation_type := 'INSERT',
            p_record_id      := NULL,
            p_record_id_column := 'vgphss_id',
        ...
        return {
          success: true,
          message: 'vgph_source_staging creation request submitted for approval',
          approval_id: approvalId,
          status: 'CREATED'
        };
      }
  ...
  async update(vgphss_id:number, updatevgph_source_stagingDto: Prisma.vgph_source_stagingUpdateInput,token:string) {   
    try{
      ...
      const dataSchema:any =  v.object({
          ...
          direction :  v.optional(v.enum(direction_vgph_source_staging,"Invalid direction_vgph_source_staging enum")), 
          process_type :  v.optional(v.enum(process_type_vgph_source_staging,"Invalid process_type_vgph_source_staging enum")), 
          tran_category :  v.optional(v.enum(tran_category_vgph_source_staging,"Invalid tran_category_vgph_source_staging enum")), 
          source_category :  v.optional(v.enum(source_category_vgph_source_staging,"Invalid source_category_vgph_source_staging enum")), 
          source_reference :  v.optional(v.pipe(v.string(),v.maxLength(32 ))), 
          source_name :  v.optional(v.pipe(v.string(),v.maxLength(64 ))), 
          channel_name :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
      ...
      let validate : any = v.safeParse(dataSchema,updatevgph_source_stagingDto);
      if (!validate.success) {
        let errorObj: errorObj = {
          tname: 'TG',
          errGrp: 'Data',
      ...
      const res = await this.prismaService.vgph_source_staging.update({
      where: {vgphss_id},
      data: await this.encryptData(updatevgph_source_stagingDto,'vgph_source_staging','update'),
      select: {vgphss_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,vgph_source_tran_staging:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return await this.decryptData(res, 'vgph_source_staging');
    } catch (error) {
...
/**
  ...
  async updateMaster(
vgphss_id:number,
    updatevgph_source_stagingDto: Prisma.vgph_source_stagingUpdateInput,
    userInfo: { role: string; username: string; remarks?: string,approvalStatus?:string },
    token:string
  ) {
    try {
      const role = userInfo.role?.toUpperCase();
      const updateMaster_id =vgphss_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_source_staging update approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_staging update rejected',
              approvalId: approvalId,
              record_id: updateMaster_id,
              status: 'REJECTED'
            };
      ...
      const existingRecord = await this.prismaService.vgph_source_staging.findUnique({
        where: {vgphss_id}
      });
      ...
      // Encrypt data if needed
      const encryptedData = await this.encryptData(updatevgph_source_stagingDto, 'vgph_source_staging', 'update');
      ...
      return {
        success: true,
        message: 'vgph_source_staging update request submitted for approval',
        approval_id: approvalId,
        record_id: updateMaster_id,
        status: 'CREATED'
      };
  ...
  async remove(vgphss_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_source_staging.delete({
      where: {vgphss_id },
      select: {vgphss_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,vgph_source_tran_staging:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return res;
...
vgphss_id:number,
    ...
    try {
      const role = userInfo.role?.toUpperCase();
      const deleteMaster_id =vgphss_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_source_staging deletion approved and applied successfully',
            approval_id: approvalId,
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_staging deletion rejected',
              approval_id: approvalId,
              record_id: deleteMaster_id,
              status: 'REJECTED'
            };
      ...
      return {
        success: true,
        message: 'vgph_source_staging deletion request submitted for approval',
        approval_id: approvalId,
        record_id: deleteMaster_id,
        status: 'CREATED'
      };
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.vgph_source_staging.findFirst({ 
