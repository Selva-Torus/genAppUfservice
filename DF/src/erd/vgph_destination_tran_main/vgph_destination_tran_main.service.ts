...
export class vgph_destination_tran_mainService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphdtm_id }: {vgphdtm_id : bigint} = queryValue;
      ...
      if (Object.keys(query).length > 0) {
        ...
        this.prismaService.vgph_destination_tran_main.findMany({
          select:columns,
          where: query,          
        }));
      ...
      this.prismaService.vgph_destination_tran_main.count({
        where: query,
      }));
  ...
  async findOne(vgphdtm_id:number,trs_tenant_id: string,trs_app_code: string,trs_product_code: string,token : string) {
    try{
      const res = await this.prismaService.withConnection(() =>
      this.prismaService.vgph_destination_tran_main.findMany({ 
      where: {vgphdtm_id,trs_tenant_id,trs_app_code,trs_product_code},
      select: {vgphdtm_id:true,direction:true,process_type:true,tran_category:true,vgphdm_uuid:true,vgphstm_uuid:true,vgphstm_id:true,vgphdm_id:true,destination_content:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_grp_code:true,trs_sub_org_code:true,trs_locked_by:true,trs_locked_time:true,trs_tenant_id:true,trs_app_code:true,trs_product_code:true,trs_event_process_status:true,trs_event_status:true,trs_token_id:true,trs_version:true,        }
    }));
    //return await this.decryptData(await this.commonDecimalDatahandle(res), 'vgph_destination_tran_main');
    let decryptedRes: any = [];
    for (const indiviual of res) {
      const plain = await this.commonDecimalDatahandle(indiviual)
      const decryptedData = await this.decryptData(plain, 'vgph_destination_tran_main');
      decryptedRes.push(decryptedData);
    }
    return decryptedRes;
  } catch (error:any) {
...
,vgphdtm_id?:number) {
  ...
  async create(createvgph_destination_tran_mainDto: Prisma.vgph_destination_tran_mainCreateInput,token:string) {
    try{
      ...
      const res = await this.prismaService.withConnection(() =>
        this.prismaService.vgph_destination_tran_main.create({
          data: encryptedData,
          select:{vgphdtm_id:true,direction:true,process_type:true,tran_category:true,vgphdm_uuid:true,vgphstm_uuid:true,vgphstm_id:true,vgphdm_id:true,destination_content:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_grp_code:true,trs_sub_org_code:true,trs_locked_by:true,trs_locked_time:true,trs_tenant_id:true,trs_app_code:true,trs_product_code:true,trs_event_process_status:true,trs_event_status:true,trs_token_id:true,trs_version:true,}          
        })
      );
  ...
  async update(vgphdtm_id:number, updatevgph_destination_tran_mainDto: Prisma.vgph_destination_tran_mainUpdateInput,token:string) {   
    try{
      ...
      this.prismaService.vgph_destination_tran_main.updateMany({
      where: {vgphdtm_id},
      data: encryptedData
    }));
...
vgphdtm_id:number,
  ...
  async remove(vgphdtm_id:number,token : string) {
    ...
    await this.prismaService.withConnection(() =>
      this.prismaService.vgph_destination_tran_main.deleteMany({
      where: {vgphdtm_id}
    })); 
    // return await this.decryptData(await this.commonDecimalDatahandle(res), 'vgph_destination_tran_main');
    let decryptedRes: any = [];
...
vgphdtm_id:number,
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.withConnection(() =>
      this.prismaService.vgph_destination_tran_main.findFirst({ 
