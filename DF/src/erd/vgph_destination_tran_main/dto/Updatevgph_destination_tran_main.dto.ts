...
export class  Updatevgph_destination_tran_mainDto {
        @ApiPropertyOptional({
            type: `integer`,
            format: `int32`,
        })
        @IsOptional()
        vgphdtm_id?: number;
        @ApiPropertyOptional({enum:direction_vgph_destination_tran_main})
        @IsEnum(direction_vgph_destination_tran_main)
        @IsOptional()
        direction?: direction_vgph_destination_tran_main;
        @ApiPropertyOptional({enum:process_type_vgph_destination_tran_main})
