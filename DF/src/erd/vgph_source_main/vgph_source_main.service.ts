...
@Injectable()
export class vgph_source_mainService {
 ...
 async findAllmethod(queryDto: any, limit:number,selectColumns:any,token:any) {
    try {
      ...
      let query: any = {}; 
      const { vgphsm_id }: {vgphsm_id : number} = queryValue;
      ...
      if (Object.keys(query).length > 0) {
        const banks = await this.prismaService.vgph_source_main.findMany({
          select:columns,
          where: query,          
        });
        let decryptedRes: any = [];
        for (const indiviual of banks) {
          const decryptedData = await this.decryptData(indiviual, 'vgph_source_main');
      ...
      const totalItems = await this.prismaService.vgph_source_main.count({
        where: query,
      });
  ...
  async findOne(vgphsm_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_source_main.findUnique({ 
      where: {vgphsm_id},
      select: {vgphsm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,            vgph_source_tran_main:{
              select:{
              vgphstm_id:true,              tenant_id:true,              parent_vgphstm_uuid:true,              product_code:true,              direction:true,              process_type:true,              tran_category:true,              message_code:true,              channel_name:true,              channel_reference:true,              tran_date:true,              tran_reference:true,              tran_seq_no:true,              value_date:true,              settlement_date:true,              dr_account:true,              dr_bank_code_type:true,              dr_bank_code:true,              dr_name:true,              dr_amount:true,              dr_currency:true,              cr_account:true,              cr_bank_code_type:true,              cr_bank_code:true,              cr_name:true,              cr_amount:true,              cr_currency:true,              remittance_info:true,              product_basic:true,              product_additional:true,              charge_type:true,              uuid:true,              vgphsm_uuid:true            ,
    ...
    return  await this.decryptData(res, 'vgph_source_main');
  } catch (error) {
...
,vgphsm_id?:number) {
    try{
      ...
      if (vgphsm_id) {
        whereClause.vgphsm_id = vgphsm_id;
      }
      const res = await this.prismaService.vgph_source_main.findMany({ 
      where: whereClause,
      select: {vgphsm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,          vgph_source_tran_main:{
              select:{
              vgphstm_id:true,              tenant_id:true,              parent_vgphstm_uuid:true,              product_code:true,              direction:true,              process_type:true,              tran_category:true,              message_code:true,              channel_name:true,              channel_reference:true,              tran_date:true,              tran_reference:true,              tran_seq_no:true,              value_date:true,              settlement_date:true,              dr_account:true,              dr_bank_code_type:true,              dr_bank_code:true,              dr_name:true,              dr_amount:true,              dr_currency:true,              cr_account:true,              cr_bank_code_type:true,              cr_bank_code:true,              cr_name:true,              cr_amount:true,              cr_currency:true,              remittance_info:true,              product_basic:true,              product_additional:true,              charge_type:true,              uuid:true,              vgphsm_uuid:true            ,
  ...
  async create(createvgph_source_mainDto: Prisma.vgph_source_mainCreateInput,token:string) {
    try{

      enum direction_vgph_source_main{
        OUTBOUND="OUTBOUND",
        INBOUND="INBOUND",
      }
      enum process_type_vgph_source_main{
        OP="OP",
        IR="IR",
        IP="IP",
        OR="OR",
      }
      enum tran_category_vgph_source_main{
        Financial="Financial",
        Non_Financial="Non_Financial",
      }
      enum source_category_vgph_source_main{
        API="API",
        FILE="FILE",
      }
      const dataSchema:any =  v.object({
            ...
            direction :v.enum(direction_vgph_source_main,"Invalid direction_vgph_source_main enum")  , 
            process_type :v.enum(process_type_vgph_source_main,"Invalid process_type_vgph_source_main enum")  , 
            tran_category :v.enum(tran_category_vgph_source_main,"Invalid tran_category_vgph_source_main enum")  , 
            source_category :  v.optional(v.enum(source_category_vgph_source_main,"Invalid source_category_vgph_source_main enum")), 
        ...
        let validate : any = v.safeParse(dataSchema,createvgph_source_mainDto);
        if (!validate.success) {
      ...
      const res = await this.prismaService.vgph_source_main.create({ 
      data: await this.encryptData(createvgph_source_mainDto,'vgph_source_main','create'),
      select:{vgphsm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,vgph_source_tran_main:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
   ...
   */
  async createMaster(
    createvgph_source_mainDto: Prisma.vgph_source_mainCreateInput,
    ...
    try {
      ...
      if (role === 'CHECKER') {
        ...
        if (approvalStatus === 'APPROVED') {
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_main creation approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_main creation rejected',
              approval_id: approvalId,
              status: 'REJECTED'
            };
          } else {
      ...
      const encryptedData = await this.encryptData(createvgph_source_mainDto, 'vgph_source_main', 'create');
      ...
      if(role === 'MAKER')
      {
        ...
        const result = await this.prismaService.$queryRaw<any[]>`
          SELECT ct006_torus202610.request_change(
            p_table_name     := 'vgph_source_main',
            p_operation_type := 'INSERT',
            p_record_id      := NULL,
            p_record_id_column := 'vgphsm_id',
        ...
        return {
          success: true,
          message: 'vgph_source_main creation request submitted for approval',
          approval_id: approvalId,
          status: 'CREATED'
        };
      }
  ...
  async update(vgphsm_id:number, updatevgph_source_mainDto: Prisma.vgph_source_mainUpdateInput,token:string) {   
    try{
      ...
      const dataSchema:any =  v.object({
          ...
          direction :  v.optional(v.enum(direction_vgph_source_main,"Invalid direction_vgph_source_main enum")), 
          process_type :  v.optional(v.enum(process_type_vgph_source_main,"Invalid process_type_vgph_source_main enum")), 
          tran_category :  v.optional(v.enum(tran_category_vgph_source_main,"Invalid tran_category_vgph_source_main enum")), 
          source_category :  v.optional(v.enum(source_category_vgph_source_main,"Invalid source_category_vgph_source_main enum")), 
          source_reference :  v.optional(v.pipe(v.string(),v.maxLength(32 ))), 
          source_name :  v.optional(v.pipe(v.string(),v.maxLength(64 ))), 
          channel_name :  v.optional(v.pipe(v.string(),v.maxLength(16 ))), 
      ...
      let validate : any = v.safeParse(dataSchema,updatevgph_source_mainDto);
      if (!validate.success) {
        let errorObj: errorObj = {
          tname: 'TG',
          errGrp: 'Data',
      ...
      const res = await this.prismaService.vgph_source_main.update({
      where: {vgphsm_id},
      data: await this.encryptData(updatevgph_source_mainDto,'vgph_source_main','update'),
      select: {vgphsm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,vgph_source_tran_main:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return await this.decryptData(res, 'vgph_source_main');
    } catch (error) {
...
/**
  ...
  async updateMaster(
vgphsm_id:number,
    updatevgph_source_mainDto: Prisma.vgph_source_mainUpdateInput,
    userInfo: { role: string; username: string; remarks?: string,approvalStatus?:string },
    token:string
  ) {
    try {
      const role = userInfo.role?.toUpperCase();
      const updateMaster_id =vgphsm_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_source_main update approved and applied successfully',
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_main update rejected',
              approvalId: approvalId,
              record_id: updateMaster_id,
              status: 'REJECTED'
            };
      ...
      const existingRecord = await this.prismaService.vgph_source_main.findUnique({
        where: {vgphsm_id}
      });
      ...
      // Encrypt data if needed
      const encryptedData = await this.encryptData(updatevgph_source_mainDto, 'vgph_source_main', 'update');
      ...
      return {
        success: true,
        message: 'vgph_source_main update request submitted for approval',
        approval_id: approvalId,
        record_id: updateMaster_id,
        status: 'CREATED'
      };
  ...
  async remove(vgphsm_id:number,token : string) {
    try{
      const res = await this.prismaService.vgph_source_main.delete({
      where: {vgphsm_id },
      select: {vgphsm_id:true,tenant_id:true,product_code:true,direction:true,process_type:true,tran_category:true,source_category:true,source_reference:true,source_name:true,channel_name:true,channel_reference:true,product_basic:true,product_additional:true,request_data:true,response_data:true,total_count:true,total_amount:true,currency:true,uuid:true,vgph_source_tran_main:true,trs_created_date:true,trs_created_by:true,trs_modified_date:true,trs_modified_by:true,trs_next_status:true,trs_status:true,trs_process_id:true,trs_access_profile:true,trs_org_grp_code:true,trs_org_code:true,trs_role_grp_code:true,trs_role_code:true,trs_ps_grp_code:true,trs_ps_code:true,trs_sub_org_code:true,trs_sub_org_grp_code:true}
    });
    return res;
...
vgphsm_id:number,
    ...
    try {
      const role = userInfo.role?.toUpperCase();
      const deleteMaster_id =vgphsm_id;
      ...
      if (role === 'CHECKER') {
        ...
        if (success) {
          return {
            success: true,
            message: 'vgph_source_main deletion approved and applied successfully',
            approval_id: approvalId,
          ...
          if (success) {
            return {
              success: true,
              message: 'vgph_source_main deletion rejected',
              approval_id: approvalId,
              record_id: deleteMaster_id,
              status: 'REJECTED'
            };
      ...
      return {
        success: true,
        message: 'vgph_source_main deletion request submitted for approval',
        approval_id: approvalId,
        record_id: deleteMaster_id,
        status: 'CREATED'
      };
  ...
  async findFirst(token : string) {
    try{
      const res = await this.prismaService.vgph_source_main.findFirst({ 
