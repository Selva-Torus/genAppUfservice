...
export class UfController {
  ...
  // async elementsFilter(@Body() body: elementsFilterDto) {
  ...
  // async fetchActionDetails(@Body() body: fetchActionDetailsDto): Promise<any> {
  //   const { key, groupId, controlId } = body;
  //   return await this.appService.fetchActionDetails(key, groupId, controlId);
  // }

  // @Post('fetchRuleDetails')
  // @ApiBody({ type: fetchRuleDetailsDto })
  // async fetchRuleDetails(@Body() body: fetchRuleDetailsDto): Promise<any> {
  //   const { key, groupId, controlId } = body;
